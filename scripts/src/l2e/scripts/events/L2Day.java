...
public class L2Day extends AbstractWorldEvent
{
	...
	public L2Day(String name, String descr)
	{
		...
		_template = WorldEventParser.getInstance().getEvent(11);
	...
	public boolean eventStart(long totalTime, boolean force)
	{
		...
		final ServerMessage msg = new ServerMessage("EventL2Day.START", true);
	...
	public boolean eventStop()
	{
		...
		final ServerMessage msg = new ServerMessage("EventL2Day.STOP", true);
		Announcements.getInstance().announceToAll(msg);
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		if (event.equalsIgnoreCase("LINEAGEII"))
		{
			...
			{
				calcRandomReward(player, _template, 1, getRandom(100));
				return null;
			}
		...
		else if (event.equalsIgnoreCase("NCSOFT"))
		{
			...
			{
				calcRandomReward(player, _template, 2, getRandom(100));
				return null;
			}
			htmltext = "4313-02.htm";
		}
