...
public class LoveYourGatekeeper extends AbstractWorldEvent
{
	...
	public boolean eventStart(long totalTime, boolean force)
	{
		...
		final ServerMessage msg = new ServerMessage("EventLoveYourGatekeeper.START", true);
	...
	public boolean eventStop()
	{
		...
		final ServerMessage msg = new ServerMessage("EventLoveYourGatekeeper.STOP", true);
		Announcements.getInstance().announceToAll(msg);
