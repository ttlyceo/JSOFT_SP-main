...
public class _364_JovialAccordion extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		if (event.equalsIgnoreCase("30959-02.htm") && npc.getId() == 30959)
		{
			if (st.isCreated())
			{
				st.set("cond", "1");
		...
		else if (event.equalsIgnoreCase("30957-02.htm") && npc.getId() == 30957)
		{
			if (st.isCond(1))
			{
				st.set("cond", "2");
		...
		else if (event.equalsIgnoreCase("30960-04.htm") && npc.getId() == 30960)
		{
		...
		else if (event.equalsIgnoreCase("30961-04.htm") && npc.getId() == 30961)
		{
