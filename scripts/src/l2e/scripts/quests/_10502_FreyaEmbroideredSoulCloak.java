...
public class _10502_FreyaEmbroideredSoulCloak extends Quest
{
	...
	private void rewardPlayer(Player player, int npcId)
	{
		...
		if (st != null)
		{
			if (st.isCond(1) && st.calcDropItems(getId(), 21723, npcId, 20))
			{
				st.setCond(2, true);
			}
		}
	...
	{
		new _10502_FreyaEmbroideredSoulCloak(10502, _10502_FreyaEmbroideredSoulCloak.class.getSimpleName(), "");
	}
}