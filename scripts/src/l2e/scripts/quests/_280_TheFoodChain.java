...
public class _280_TheFoodChain extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		final long KELTIR_TOOTH_COUNT = st.getQuestItemsCount(KELTIR_TOOTH);
		final long WOLF_TOOTH_COUNT = st.getQuestItemsCount(WOLF_TOOTH);
		...
		{
			if (KELTIR_TOOTH_COUNT > 0 || WOLF_TOOTH_COUNT > 0)
			{
