		...
		if (st != null)
		{
			switch (npc.getId())
    		{
				...
				case 20266 :
					if (st.hasQuestItems(ROLANTS_CREATUREBOOK))
					{
						st.dropItemsAlways(MONSTER_EYE_BODY, getRandom(2, 3), 30);
					}
					break;
				case 20226 :
				case 20228 :
				...
				case 20156 :
					if (st.hasQuestItems(SONIAS_BOTANYBOOK))
					{
						st.dropItemsAlways(((getRandom(1000) < 975) ? RED_MANDRAGORA_ROOT : WHITE_MANDRAGORA_ROOT), 1, 40);
					}
					break;
    		}
		}
