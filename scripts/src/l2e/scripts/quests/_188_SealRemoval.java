...
public final class _188_SealRemoval extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			case "30673-03.htm" :
			{
				if (qs.isCreated() && npc.getId() == 30673)
				{
					qs.startQuest();
					qs.setMemoState(1);
					giveItems(player, 10369, 1);
					htmltext = event;
				}
				break;
			}
			case "30621-02.htm" :
			{
				if (qs.isMemoState(1) && npc.getId() == 30621)
				{
					htmltext = event;
				}
				break;
			...
			case "30621-04.htm" :
			{
				if (qs.isMemoState(2) && npc.getId() == 30621)
				{
					htmltext = event;
				}
				break;
			...
			case "30970-02.htm" :
			{
				if (qs.isMemoState(2) && npc.getId() == 30970)
				{
					htmltext = event;
				}
				break;
