...
public class _212_TrialOfDuty extends Quest
{
	...
	{
	        HANGMAN_TREE, SKELETON_MARAUDER, SKELETON_RAIDER, STRAIN, GHOUL, BREKA_ORC_OVERLORD, SPIRIT_OF_SIR_HEROD, LETO_LIZARDMAN, LETO_LIZARDMAN_ARCHER, LETO_LIZARDMAN_SOLDIER, LETO_LIZARDMAN_WARRIOR, LETO_LIZARDMAN_SHAMAN, LETO_LIZARDMAN_OVERLORD
	};
	...
	{
	        LETTER_OF_DUSTIN, KNIGHTS_TEAR, MIRROR_OF_ORPIC, TEAR_OF_CONFESSION, REPORT_PIECE, TALIANUSS_REPORT, TEAR_OF_LOYALTY, MILITAS_ARTICLE, SAINTS_ASHES_URN, ATEBALTS_SKULL, ATEBALTS_RIBS, ATEBALTS_SHIN, LETTER_OF_WINDAWOOD, OLD_KNIGHT_SWORD
	};
