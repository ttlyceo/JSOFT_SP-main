...
import l2e.gameserver.network.serverpackets.ExTutorialShowId;
			...
			if ((playerLevel < 6) && (st.getInt("onlyone") == 0))
			{
				...
				switch (uc)
				{
					...
					case 2:
						if (Ex == 2)
						{
							st.showQuestionMark(3, 1);
							st.playSound("ItemSound.quest_tutorial");
						}
						
						if (st.getQuestItemsCount(6353) == 1)
						{
							st.showQuestionMark(5, 1);
							st.playSound("ItemSound.quest_tutorial");
						}
						break;
					case 3:
						st.showQuestionMark(12, 1);
						st.playSound("ItemSound.quest_tutorial");
		...
		else if (event.startsWith("TE"))
		{
			...
			switch (eventId)
			{
				...
				case 12:
					...
					break;
				case 23:
					for (final String[] element : TCL_B)
					{
						if (classId == Integer.valueOf(element[0]))
						{
							htmltext = element[1];
					...
					break;
				case 24:
					for (final String[] element : TCL_C)
					{
						if (classId == Integer.valueOf(element[0]))
						{
							htmltext = element[1];
				...
				case 25:
					...
					break;
				case 26:
					for (final String[] element : TCL_A)
					{
						if (classId == Integer.valueOf(element[0]))
						{
							htmltext = element[1];
			...
			switch (eventId)
			{
				...
				case 8:
					if (playerLevel < 6)
					{
						...
						int y = 0;
						int z = 0;
						for (final String[] element : CEE_A)
						{
							if (classId == Integer.valueOf(element[0]))
							{
								htmltext = element[1];
		...
		else if (event.startsWith("QM"))
		{
			...
			switch (eventId)
			{
				...
				case 8:
					...
					break;
				case 9:
					for (final String[] element : QMC_A)
					{
						if (classId == Integer.valueOf(element[0]))
						{
							htmltext = element[1];
				...
				case 23:
					...
					break;
				case 24:
					for (final String[] element : QMC_B)
					{
						if (classId == Integer.valueOf(element[0]))
						{
							htmltext = element[1];
				...
				case 34:
					...
					break;
				case 35:
					for (final String[] element : QMC_C)
					{
						if (classId == Integer.valueOf(element[0]))
						{
							htmltext = element[1];
