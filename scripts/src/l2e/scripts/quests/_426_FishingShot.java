...
public class _426_FishingShot extends Quest
{
	...
	private static Map<Integer, Integer> MOBS1 = new HashMap<>();
	private static Map<Integer, Integer> MOBS2 = new HashMap<>();
	private static Map<Integer, Integer> MOBS3 = new HashMap<>();
	private static Map<Integer, Integer> MOBS4 = new HashMap<>();
	private static Map<Integer, Integer> MOBS5 = new HashMap<>();
	private static Map<Integer, Integer> MOBSkamael = new HashMap<>();
	private static Map<Integer, int[]> MOBSspecial = new ConcurrentHashMap<>();
	...
	public _426_FishingShot(int questId, String name, String descr)
	{
		...
		for (final int mob : MOBS1.keySet())
		{
			addKillId(mob);
		}
		for (final int mob : MOBS2.keySet())
		{
			addKillId(mob);
		}
		for (final int mob : MOBS3.keySet())
		{
			addKillId(mob);
		}
		for (final int mob : MOBS4.keySet())
		{
			addKillId(mob);
		}
		for (final int mob : MOBS5.keySet())
		{
			addKillId(mob);
		}
		for (final int mob : MOBSspecial.keySet())
		{
			addKillId(mob);
		}
		for (final int mob : MOBSkamael.keySet())
		{
			addKillId(mob);
		}
