...
public class _621_EggDelivery extends Quest
{
	...
	public final String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		{
			if (st.getQuestItemsCount(FEE_OF_EGGS) == 5 && npc.getId() == 31584)
			{
