		...
		switch (st.getState())
		{
			...
			case State.STARTED:
				...
				else
				{
					...
					final long reward = (25 * carcasses) + (1000 * lenses) + (60 * gizzards) + (all >= 10 ? 618 : 0);
