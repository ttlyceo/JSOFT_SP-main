...
public class _386_StolenDignity extends Quest
{
	...
	private final static Map<Integer, Integer> dropchances = new ConcurrentHashMap<>();
	...
	public _386_StolenDignity(int id, String name, String descr)
	{
		...
		for (final int kill_id : dropchances.keySet())
		{
			addKillId(kill_id);
		}
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		else if (event.equalsIgnoreCase("game"))
		{
			...
			final Bingo bingo = new BingoClass(st);
	...
	public static class BingoClass extends Bingo
	{
		...
		{
			final int[] r = rew[getRandom(rew.length)];
