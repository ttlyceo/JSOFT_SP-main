...
public class _343_UndertheShadowoftheIvoryTower extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		final long orbs = st.getQuestItemsCount(ORB);
		if (event.equalsIgnoreCase("30834-03.htm") && npc.getId() == 30834)
		{
			if (st.isCreated())
			{
		...
		else if (event.equalsIgnoreCase("30834-08.htm") && npc.getId() == 30834)
		{
			if (orbs > 0)
			{
				st.rewardItems(57, orbs * 120);
				st.takeItems(ORB, -1);
			}
			else
			{
		...
		else if (event.equalsIgnoreCase("30834-09.htm") && npc.getId() == 30834)
		{
			st.exitQuest(true, true);
		}
		else if (event.equalsIgnoreCase("30934-02.htm") || event.equalsIgnoreCase("30934-03.htm") && npc.getId() == 30934)
		{
			if (orbs < 10)
			{
				htmltext = "noorbs.htm";
		...
		else if (event.equalsIgnoreCase("30934-04.htm") && npc.getId() == 30934)
		{
		...
		else if (event.equalsIgnoreCase("30934-05.htm") && npc.getId() == 30934)
		{
			if (st.getInt("playing") > 0)
			{
				if (random1 == 0)
		...
		else if (event.equalsIgnoreCase("30934-06.htm") && npc.getId() == 30934)
		{
			if (st.getInt("playing") > 0)
			{
				if (random1 == 0)
		...
		else if (event.equalsIgnoreCase("30935-02.htm") || event.equalsIgnoreCase("30935-03.htm") && npc.getId() == 30935)
		{
			st.unset("toss");
			if (orbs < 10)
			{
		...
		else if (event.equalsIgnoreCase("30935-05.htm") && npc.getId() == 30935)
		{
			if (orbs >= 10)
			{
				if (random2 == 0)
		...
		else if (event.equalsIgnoreCase("30935-06.htm") && npc.getId() == 30935)
		{
			if (orbs >= 10)
			{
				final int toss = st.getInt("toss");
		...
		else if (event.equalsIgnoreCase("30835-02.htm") && npc.getId() == 30835)
		{
