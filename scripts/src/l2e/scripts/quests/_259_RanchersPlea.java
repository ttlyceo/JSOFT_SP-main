...
public class _259_RanchersPlea extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		final int count = (int) st.getQuestItemsCount(GIANT_SPIDER_SKIN);
		
		if (event.equalsIgnoreCase("30497-03.htm") && npc.getId() == 30497)
		{
			if (st.isCreated())
			{
				st.set("cond", "1");
		...
		else if (event.equalsIgnoreCase("30497-06.htm") && npc.getId() == 30497)
		{
			st.exitQuest(true, true);
		}
		else if (event.equalsIgnoreCase("30405-04.htm") && npc.getId() == 30405)
		{
			if (count >= 10)
			{
		...
		else if (event.equalsIgnoreCase("30405-05.htm") && npc.getId() == 30405)
		{
			if (count >= 10)
			{
		...
		else if (event.equalsIgnoreCase("30405-07.htm") && npc.getId() == 30405)
		{
			if (count >= 10)
			{
