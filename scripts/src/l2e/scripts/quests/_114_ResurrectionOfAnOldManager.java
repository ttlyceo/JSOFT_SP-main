...
public final class _114_ResurrectionOfAnOldManager extends Quest
{
	...
	public _114_ResurrectionOfAnOldManager(int questId, String name, String descr)
	{
		...
		{
		                DETECTOR, DETECTOR2, STARSTONE, LETTER, STARSTONE2
		};
	}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		else if (event.equalsIgnoreCase("32047-15a.htm"))
		{
			...
			{
				final Npc GUARDIAN_SPAWN = st.addSpawn(GUARDIAN, 96977, -110625, -3280, 0, false, 900000);
				...
				GUARDIAN_SPAWN.broadcastPacketToOthers(2000, ns);
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		{
			case State.CREATED:
				final QuestState qs = player.getQuestState("_121_PavelTheGiant");
	...
	public String onKill(Npc npc, Player player, boolean isSummon)
	{
		...
		if (st.getInt("cond") == 10)
		{
			if (npcId == GUARDIAN)
			{
				npc.broadcastPacketToOthers(2000, new NpcSay(npc.getObjectId(), 0, npcId, NpcStringId.THIS_ENEMY_IS_FAR_TOO_POWERFUL_FOR_ME_TO_FIGHT_I_MUST_WITHDRAW));
				st.set("cond", "11");
				st.playSound("ItemSound.quest_middle");
			}
		}
