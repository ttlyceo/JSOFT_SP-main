...
public class _347_GoGetTheCalculator extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		if (event.equalsIgnoreCase("30526-05.htm") && npc.getId() == 30526)
		{
			if (st.isCreated())
			{
				st.set("cond", "1");
		...
		else if (event.equalsIgnoreCase("30533-03.htm") && npc.getId() == 30533)
		{
		...
		else if (event.equalsIgnoreCase("30532-02.htm") && npc.getId() == 30532)
		{
			if (st.getInt("cond") == 2)
			{
				st.set("cond", "4");
		...
		else if (event.equalsIgnoreCase("30526-08.htm") && npc.getId() == 30526)
		{
			if (st.isCond(6))
			{
		...
		else if (event.equalsIgnoreCase("30526-09.htm") && npc.getId() == 30526)
		{
			if (st.isCond(6))
			{
				st.takeItems(CALCULATOR_Q, -1);
	...
	{
		final var partyMember = getRandomPartyMember(player, 5);
		if (partyMember == null)
		{
