...
public class _257_TheGuardIsBusy extends Quest
{
	...
	public _257_TheGuardIsBusy(int questId, String name, String descr)
	{
		...
		{
		                GLUDIO_LORDS_MARK, ORC_AMULET, ORC_NECKLACE, WEREWOLF_FANG
		};
	}
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		{
			final long orc_a = st.getQuestItemsCount(ORC_AMULET);
			final long orc_n = st.getQuestItemsCount(ORC_NECKLACE);
			final long wer_f = st.getQuestItemsCount(WEREWOLF_FANG);
