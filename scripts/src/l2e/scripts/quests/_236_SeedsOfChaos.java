...
public class _236_SeedsOfChaos extends Quest
{
	...
	private final static int KATENAR = 32235;
	...
	public _236_SeedsOfChaos(int questId, String name, String descr)
	{
		...
		for (final int kill_id : NEEDLE_STAKATO_DRONES)
		{
			addKillId(kill_id);
		}

		for (final int kill_id : SPLENDOR_MOBS)
		{
			addKillId(kill_id);
		}
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		else if (event.equalsIgnoreCase("10"))
		{
			...
			{
				st.set("cond", "16");
				player.teleToLocation(-119534, 87176, -12593, true, player.getReflection());
	...
	{
		new _236_SeedsOfChaos(236, _236_SeedsOfChaos.class.getSimpleName(), "");
	}
}
