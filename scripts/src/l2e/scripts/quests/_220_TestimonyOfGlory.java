				...
				case RAGNA_ORC_SEER :
				{
					switch (npc.getScriptValue())
					{
						case 0 :
						{
							...
							{
								npc.broadcastPacketToOthers(2000, new NpcSay(npc, Say2.NPC_ALL, NpcStringId.IS_IT_A_LACKEY_OF_KAKAI));
				...
				case REVENANT_OF_TANTOS_CHIEF :
				{
					switch (npc.getScriptValue())
					{
						case 0 :
						{
							...
							if (!hasQuestItems(attacker, SCEPTER_OF_TANTOS))
							{
								npc.broadcastPacketToOthers(2000, new NpcSay(npc, Say2.NPC_ALL, NpcStringId.HOW_REGRETFUL_UNJUST_DISHONOR));
								npc.setScriptValue(1);
							}
							break;
						}
						case 1 :
						{
							...
							{
								npc.broadcastPacketToOthers(2000, new NpcSay(npc, Say2.NPC_ALL, NpcStringId.INDIGNANT_AND_UNFAIR_DEATH));
								npc.setScriptValue(2);
							}
							break;
						}
		...
		if ((qs != null) && qs.isStarted() && Util.checkIfInRange(1500, npc, killer, true))
		{
			switch (npc.getId())
			{
				...
				case RAGNA_ORC_SEER :
				{
					...
					{
						qs.addSpawn(REVENANT_OF_TANTOS_CHIEF, 200000);
						npc.broadcastPacketToOthers(2000, new NpcSay(npc, Say2.NPC_ALL, NpcStringId.TOO_LATE));
					}
					break;
				}
				...
				case REVENANT_OF_TANTOS_CHIEF :
				{
					if (hasQuestItems(killer, TANAPIS_ORDER) && !hasQuestItems(killer, SCEPTER_OF_TANTOS))
					{
						...
						npc.broadcastPacketToOthers(2000, new NpcSay(npc, Say2.NPC_ALL, NpcStringId.ILL_GET_REVENGE_SOMEDAY));
						qs.setCond(10, true);
					}
					break;
				}
