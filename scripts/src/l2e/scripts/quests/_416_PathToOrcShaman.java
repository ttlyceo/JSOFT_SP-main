	...
	public String onKill(Npc npc, Player killer, boolean isSummon)
	{
		...
		else if (npcId == LEOPARD)
		{
			if (cond == 14)
			{
				st.set("cond", "15");
				st.playSound("ItemSound.quest_middle");
				npc.broadcastNpcSay("My dear friend of " + killer.getName(null) + ", who has gone on ahead of me!");
			}
			...
			else if (cond == 16)
			{
				st.set("cond", "17");
				st.playSound("ItemSound.quest_middle");
				npc.broadcastNpcSay("Listen to Tejakar Gandi, young Oroka! The spirit of the slain leopard is calling you, " + killer.getName(null) + "!");
			}
			else if (cond == 18)
			{
				st.set("cond", "19");
