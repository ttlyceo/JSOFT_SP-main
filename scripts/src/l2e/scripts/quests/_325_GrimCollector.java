...
public class _325_GrimCollector extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		if (event.equalsIgnoreCase("30336-03.htm") && npc.getId() == 30336)
		{
			if (st.isCreated())
			{
				st.set("cond", "1");
		...
		else if (event.equalsIgnoreCase("30434-03.htm") && npc.getId() == 30434)
		{
			st.giveItems(ANATOMY_DIAGRAM, 1);
			st.playSound("ItemSound.quest_itemget");
		}
		else if (event.equalsIgnoreCase("30434-06.htm") && npc.getId() == 30434)
		{
		...
		else if (event.equalsIgnoreCase("30434-07.htm") && npc.getId() == 30434)
		{
			payback(st);
			st.playSound("ItemSound.quest_middle");
		}
		else if (event.equalsIgnoreCase("30434-09.htm") && npc.getId() == 30434)
		{
			final int skeletons = (int) st.getQuestItemsCount(COMPLETE_SKELETON);
			if (skeletons > 0)
			{
				st.takeItems(COMPLETE_SKELETON, -1);
				st.playSound("ItemSound.quest_middle");
		...
		else if (event.equalsIgnoreCase("30342-03.htm") && npc.getId() == 30342)
		{
