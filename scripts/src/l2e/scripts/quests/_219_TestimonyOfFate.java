	...
	public String onKill(Npc npc, Player player, boolean isSummon)
	{
		...
		if ((st != null) && st.isStarted() && Util.checkIfInRange(1500, npc, player, true))
		{
			switch (npc.getId())
			{
				case HangmanTree :
				{
					if (hasQuestItems(player, MetheussFuneralJar) && !hasQuestItems(player, KasandrasRemains))
					{
						takeItems(player, MetheussFuneralJar, 1);
						giveItems(player, KasandrasRemains, 1);
						st.setCond(3, true);
					}
				}
				case MarshStakato :
				...
				{
					if (hasQuestItems(player, IxiasList) && (getQuestItemsCount(player, NightshadeRoot) < 10))
					{
						if (getQuestItemsCount(player, NightshadeRoot) == 9)
						{
							giveItems(player, NightshadeRoot, 1);
							playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
							if ((getQuestItemsCount(player, MedusasIchor) >= 10) && (getQuestItemsCount(player, MarshSpiderFluids) >= 10) && (getQuestItemsCount(player, DeadSeekerDung) >= 10) && (getQuestItemsCount(player, TyrantsBlood) >= 10))
							{
								st.setCond(7);
							}
						}
				...
				case Medusa :
				{
					if (hasQuestItems(player, IxiasList) && (getQuestItemsCount(player, MedusasIchor) < 10))
					{
						if (getQuestItemsCount(player, MedusasIchor) == 9)
						{
							giveItems(player, MedusasIchor, 1);
							playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
							if ((getQuestItemsCount(player, MarshSpiderFluids) >= 10) && (getQuestItemsCount(player, DeadSeekerDung) >= 10) && (getQuestItemsCount(player, TyrantsBlood) >= 10) && (getQuestItemsCount(player, NightshadeRoot) >= 10))
							{
								st.setCond(7);
							}
						}
				...
				case TyrantKingpin :
				{
					if (hasQuestItems(player, IxiasList) && (getQuestItemsCount(player, TyrantsBlood) < 10))
					{
						if (getQuestItemsCount(player, TyrantsBlood) == 9)
						{
							giveItems(player, TyrantsBlood, 1);
							playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
							if ((getQuestItemsCount(player, MedusasIchor) >= 10) && (getQuestItemsCount(player, MarshSpiderFluids) >= 10) && (getQuestItemsCount(player, DeadSeekerDung) >= 10) && (getQuestItemsCount(player, NightshadeRoot) >= 10))
							{
								st.setCond(7);
							}
						}
				...
				case DeadSeeker :
				{
					if (hasQuestItems(player, IxiasList) && (getQuestItemsCount(player, DeadSeekerDung) < 10))
					{
						if (getQuestItemsCount(player, DeadSeekerDung) == 9)
						{
							giveItems(player, DeadSeekerDung, 1);
							playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
							if ((getQuestItemsCount(player, MedusasIchor) >= 10) && (getQuestItemsCount(player, MarshSpiderFluids) >= 10) && (getQuestItemsCount(player, TyrantsBlood) >= 10) && (getQuestItemsCount(player, NightshadeRoot) >= 10))
							{
								st.setCond(7);
							}
						}
				...
				case MarshSpider :
				{
					if (hasQuestItems(player, IxiasList) && (getQuestItemsCount(player, MarshSpiderFluids) < 10))
					{
						if (getQuestItemsCount(player, MarshSpiderFluids) == 9)
						{
							giveItems(player, MarshSpiderFluids, 1);
							playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
							if ((getQuestItemsCount(player, MedusasIchor) >= 10) && (getQuestItemsCount(player, DeadSeekerDung) >= 10) && (getQuestItemsCount(player, TyrantsBlood) >= 10) && (getQuestItemsCount(player, NightshadeRoot) >= 10))
							{
								st.setCond(7);
							}
						}
				...
				{
					if (hasQuestItems(player, PalusCharm, ArkeniasNote, PixyGarnet) && !hasQuestItems(player, RedFairyDust))
					{
						if (getQuestItemsCount(player, BrekaOverlordSkull) < 10)
						{
							if (getQuestItemsCount(player, BrekaOverlordSkull) == 9)
							{
								giveItems(player, BrekaOverlordSkull, 1);
								playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
							}
							else
							{
				...
				case Grandis :
				{
					if (hasQuestItems(player, PalusCharm, ArkeniasNote, PixyGarnet) && !hasQuestItems(player, RedFairyDust))
					{
						if (getQuestItemsCount(player, GrandissSkull) < 10)
						{
							if (getQuestItemsCount(player, GrandissSkull) == 9)
							{
								giveItems(player, GrandissSkull, 1);
								playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
							}
							else
							{
				...
				case LetoLizardmanOverlord :
				{
					if (hasQuestItems(player, PalusCharm, ArkeniasNote, PixyGarnet) && !hasQuestItems(player, RedFairyDust))
					{
						if (getQuestItemsCount(player, LetoOverlordSkull) < 10)
						{
							if (getQuestItemsCount(player, LetoOverlordSkull) == 9)
							{
								giveItems(player, LetoOverlordSkull, 1);
								playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
							}
							else
							{
				...
				case KarulBugbear :
				{
					if (hasQuestItems(player, PalusCharm, ArkeniasNote, PixyGarnet) && !hasQuestItems(player, RedFairyDust))
					{
						if (getQuestItemsCount(player, KarulBugbearSkull) < 10)
						{
							if (getQuestItemsCount(player, KarulBugbearSkull) == 9)
							{
								giveItems(player, KarulBugbearSkull, 1);
								playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
							}
							else
							{
				...
				case BlackWillowLurker :
				{
					if (hasQuestItems(player, PalusCharm, ArkeniasNote, BlightTreantSeed) && !hasQuestItems(player, BlightTreantSap, BlackWillowLeaf))
					{
						giveItems(player, BlackWillowLeaf, 1);
						playSound(player, QuestSound.ITEMSOUND_QUEST_MIDDLE);
					}
					break;
				}
