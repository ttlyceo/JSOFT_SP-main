	...
	public String onTalk(Npc npc, Player player)
	{
		...
		switch (st.getState())
		{
			case State.CREATED:
				...
				break;
			case State.STARTED:
				final long redBadges = st.getQuestItemsCount(RED_CROSS_BADGE);
				final long blueBadges = st.getQuestItemsCount(BLUE_CROSS_BADGE);
				final long blackBadges = st.getQuestItemsCount(BLACK_CROSS_BADGE);
				
				final long badgesSum = redBadges + blueBadges + blackBadges;
