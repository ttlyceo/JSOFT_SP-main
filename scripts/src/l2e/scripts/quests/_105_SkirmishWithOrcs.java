...
public class _105_SkirmishWithOrcs extends Quest
{
	...
	private final static int[] MOBS = new int[]
	{
	                KabooChiefUoph, KabooChiefKracha, KabooChiefBatoh, KabooChiefTanukia, KabooChiefTurel, KabooChiefRoko, KabooChiefKamut, KabooChiefMurtika
	};
	...
	public _105_SkirmishWithOrcs(int questId, String name, String descr)
	{
		...
		{
		                KENDNELLS_ORDER1, KENDNELLS_ORDER2, KENDNELLS_ORDER3, KENDNELLS_ORDER4, KENDNELLS_ORDER5, KENDNELLS_ORDER6, KENDNELLS_ORDER7, KENDNELLS_ORDER8, KABOO_CHIEF_TORC1, KABOO_CHIEF_TORC2
		};
	}
