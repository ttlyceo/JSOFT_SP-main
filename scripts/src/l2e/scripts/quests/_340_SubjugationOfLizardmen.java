...
public class _340_SubjugationOfLizardmen extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		if (event.equalsIgnoreCase("30385-03.htm") && npc.getId() == 30385)
		{
			if (st.isCreated())
			{
				st.set("cond", "1");
		...
		else if (event.equalsIgnoreCase("30385-07.htm") && npc.getId() == 30385)
		{
			if (st.isCond(1))
			{
				st.set("cond", "2");
		...
		else if (event.equalsIgnoreCase("30385-09.htm") && npc.getId() == 30385)
		{
		...
		else if (event.equalsIgnoreCase("30385-10.htm") && npc.getId() == 30385)
		{
			if (st.getQuestItemsCount(CARGO) >= 30)
			{
				st.takeItems(CARGO, -1);
		...
		else if (event.equalsIgnoreCase("30375-02.htm") && npc.getId() == 30375)
		{
			if (st.isCond(2))
			{
				st.set("cond", "3");
		...
		else if (event.equalsIgnoreCase("30037-02.htm") && npc.getId() == 30037)
		{
			if (st.isCond(4))
			{
				st.set("cond", "5");
		...
		else if (event.equalsIgnoreCase("30989-02.htm") && npc.getId() == 30989)
		{
			if (st.isCond(5))
			{
				st.set("cond", "6");
