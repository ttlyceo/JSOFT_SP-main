...
{
	public _047_IntoTheDarkForest(int questId, String name, String descr)
	{
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		else if(id == State.CREATED)
		{
			...
			{
				if (player.getRace().ordinal() == 2 && st.getQuestItemsCount(7570) > 0)
				{
	...
	{
		new _047_IntoTheDarkForest(47, _047_IntoTheDarkForest.class.getSimpleName(), "");
	}
}