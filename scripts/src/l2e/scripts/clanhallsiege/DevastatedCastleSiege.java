...
public final class DevastatedCastleSiege extends ClanHallSiegeEngine
{
	...
	private static final double GUSTAV_TRIGGER_HP = NpcsParser.getInstance().getTemplate(GUSTAV).getBaseHpMax() / 12;
	...
	public Clan getWinner()
	{
		int counter = 0;
		int damagest = 0;
		for (final Entry<Integer, Integer> e : _damageToGustav.entrySet())
		{
