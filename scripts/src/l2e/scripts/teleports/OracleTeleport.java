					...
					if (player.getParty().isLeader(player) && player.getVarB("autoTeleport@", false))
					{
						for (final Player member : player.getParty().getMembers())
						{
							if (member != null)
							{
								...
								member.teleToLocation(loc.getX(), loc.getY(), loc.getZ(), true, member.getReflection());
								final QuestState st1 = member.getQuestState(getName());
								if (st1 != null)
								{
									st1.exitQuest(true);
								}
								member.setIsIn7sDungeon(false);
							}
						}
					}
				}
					...
					if (player.getParty().isLeader(player) && player.getVarB("autoTeleport@", false))
					{
						for (final Player member : player.getParty().getMembers())
						{
							if (member != null)
							{
								...
								member.teleToLocation(-80157, 111344, -4901, true, member.getReflection());
								member.setIsIn7sDungeon(true);
							}
						}
					}
				}
				player.teleToLocation(-80157, 111344, -4901, true, player.getReflection());
					...
					if (player.getParty().isLeader(player) && player.getVarB("autoTeleport@", false))
					{
						for (final Player member : player.getParty().getMembers())
						{
							if (member != null)
							{
								...
								member.teleToLocation(-81261, 86531, -5157, true, member.getReflection());
								member.setIsIn7sDungeon(true);
							}
						}
					}
				}
				player.teleToLocation(-81261, 86531, -5157, true, player.getReflection());
				player.setIsIn7sDungeon(true);
			}
			else
			{
				...
				if (player.getParty().isLeader(player) && player.getVarB("autoTeleport@", false))
				{
					for (final Player member : player.getParty().getMembers())
					{
						if (member != null)
						{
							...
							member.teleToLocation(-114755, -179466, -6752, true, member.getReflection());
						}
					}
				}
			}
			player.teleToLocation(-114755, -179466, -6752, true, player.getReflection());
		}
				...
				if (player.getParty().isLeader(player) && player.getVarB("autoTeleport@", false))
				{
					for (final Player member : player.getParty().getMembers())
					{
						if (member != null)
						{
							...
							if (st1 == null)
							{
								st1 = newQuestState(member);
							}
							st1.setState(State.STARTED);
							st1.set("id", Integer.toString(i));
							member.teleToLocation(-114755, -179466, -6752, true, member.getReflection());
						}
					}
				}
