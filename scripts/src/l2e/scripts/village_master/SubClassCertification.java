...
public class SubClassCertification extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		{
			final String html = "<html><body>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_OF_SKILLS") + ":<br>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.TRY_TO_RECEIVE") + " %level% " + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_LEVEL") + " %class%, %skilltype%. " + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.REMEMBER") + "<br><a action=\"bypass -h Quest SubClassCertification %event%\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.RECEIVE_CERT") + "</a><br><a action=\"bypass -h Quest SubClassCertification 9002-05.htm\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.NOT_RECEIVE_CERT") + "</a></body></html>";
		...
		{
			final String html = "<html><body>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_OF_SKILLS") + ":<br>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.TRY_TO_RECEIVE") + " %level% " + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_LEVEL") + " %class%, %skilltype%. " + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.REMEMBER") + "<br><a action=\"bypass -h Quest SubClassCertification %event1%\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.RECEIVE_CERT_SPECIAL_SKILLS") + "</a><br><a action=\"bypass -h Quest SubClassCertification %event2%\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.RECEIVE_CERT_MASTER_SKILLS") + "</a><br><a action=\"bypass -h Quest SubClassCertification 9002-05.htm\">" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.NOT_RECEIVE_CERT") + "</a></body></html>";

			htmltext = html.replace("%level%", "75").replace("%class%", ClassListParser.getInstance().getClass(player.getActiveClass()).getEscapedClientCode()).replace("%skilltype%", "common skill or special skill").replace("%event1%", "lvl75Class").replace("%event2%", "lvl75Master");
		}
			...
			if (type.equals("Emergent"))
			{
				...
				if (event.equals("lvl65Emergent"))
				{
					if (isAvailable65.equals("") || isAvailable65.equals("0"))
					{
						...
						final String html = "<html><body>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_OF_SKILLS") + ":<br>" + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.NOT_READY_RECEIVE") + " %level% " + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.CERT_LEVEL") + ". " + ServerStorage.getInstance().getString(player.getLang(), "SubClassCertification.COME_BACK_LATER") + ".</body></html>";
