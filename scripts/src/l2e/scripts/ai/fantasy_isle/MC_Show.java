...
public class MC_Show extends AbstractNpcAI
{
	...
	{
	        NpcStringId.HOW_COME_PEOPLE_ARE_NOT_HERE_WE_ARE_ABOUT_TO_START_THE_SHOW_HMM, NpcStringId.UGH_I_HAVE_BUTTERFLIES_IN_MY_STOMACH_THE_SHOW_STARTS_SOON, NpcStringId.THANK_YOU_ALL_FOR_COMING_HERE_TONIGHT, NpcStringId.IT_IS_AN_HONOR_TO_HAVE_THE_SPECIAL_SHOW_TODAY, NpcStringId.FANTASY_ISLE_IS_FULLY_COMMITTED_TO_YOUR_HAPPINESS, NpcStringId.NOW_ID_LIKE_TO_INTRODUCE_THE_MOST_BEAUTIFUL_SINGER_IN_ADEN_PLEASE_WELCOMELEYLA_MIRA, NpcStringId.HERE_SHE_COMES, NpcStringId.THANK_YOU_VERY_MUCH_LEYLA, NpcStringId.JUST_BACK_FROM_THEIR_WORLD_TOUR_PUT_YOUR_HANDS_TOGETHER_FOR_THE_FANTASY_ISLE_CIRCUS, NpcStringId.COME_ON_EVERYONE, NpcStringId.DID_YOU_LIKE_IT_THAT_WAS_SO_AMAZING, NpcStringId.NOW_WE_ALSO_INVITED_INDIVIDUALS_WITH_SPECIAL_TALENTS, NpcStringId.LETS_WELCOME_THE_FIRST_PERSON_HERE, NpcStringId.OH, NpcStringId.OKAY_NOW_HERE_COMES_THE_NEXT_PERSON_COME_ON_UP_PLEASE, NpcStringId.OH_IT_LOOKS_LIKE_SOMETHING_GREAT_IS_GOING_TO_HAPPEN_RIGHT, NpcStringId.OH_MY, NpcStringId.THATS_G_GREAT_NOW_HERE_COMES_THE_LAST_PERSON, NpcStringId.NOW_THIS_IS_THE_END_OF_TODAYS_SHOW, NpcStringId.HOW_WAS_IT_I_HOPE_YOU_ALL_ENJOYED_IT, NpcStringId.PLEASE_REMEMBER_THAT_FANTASY_ISLE_IS_ALWAYS_PLANNING_A_LOT_OF_GREAT_SHOWS_FOR_YOU, NpcStringId.WELL_I_WISH_I_COULD_CONTINUE_ALL_NIGHT_LONG_BUT_THIS_IS_IT_FOR_TODAY_THANK_YOU, NpcStringId.WE_LOVE_YOU
	};
	...
	{
		npc.broadcastPacketToOthers(1000, new NpcSay(npc.getObjectId(), type, npc.getId(), npcString));
	}
		...
		if (IS_STARTED)
		{
			switch (npc.getId())
			{
				case 32433:
					...
					break;
				case 32431:
					npc.getAI().setIntention(CtrlIntention.MOVING, new Location(-56657, -56338, -2008, 33102), 0);
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		else if ((npc != null) && IS_STARTED)
		{
			if (event.equalsIgnoreCase("6"))
			{
				...
				npc.getAI().setIntention(CtrlIntention.MOVING, new Location(-56511, -56647, -2008, 36863), 0);
				npc.broadcastPacketToOthers(2000, new PlaySound(1, "NS22_F", 0, 0, 0, 0, 0));
			...
			else if (event.equalsIgnoreCase("7"))
			{
				switch (npc.getId())
				{
					case 32433:
						...
						npc.getAI().setIntention(CtrlIntention.MOVING, new Location(-56698, -56430, -2008, 32768), 0);
						startQuestTimer("8", 12000, npc, null);
						break;
					default:
						cancelQuestTimer("social1", npc, null);
						npc.getAI().setIntention(CtrlIntention.MOVING, new Location(-56594, -56064, -2008, 32768), 0);
						break;
				}
			}
			else if (event.equalsIgnoreCase("10"))
			{
				npc.getAI().setIntention(CtrlIntention.MOVING, new Location(-56483, -56665, -2034, 32768), 0);
				npc.broadcastPacketToOthers(2000, new PlaySound(1, "TP05_F", 0, 0, 0, 0, 0));
			...
			else if (event.equalsIgnoreCase("11"))
			{
				switch (npc.getId())
				{
					case 32433:
						...
						break;
					default:
						npc.getAI().setIntention(CtrlIntention.MOVING, new Location(-56343, -56330, -2008, 32768), 0);
						break;
				}
			}
			...
			{
				npc.getAI().setIntention(CtrlIntention.MOVING, new Location(-56702, -56340, -2008, 32768), 0);
			...
			{
				npc.getAI().setIntention(CtrlIntention.MOVING, new Location(-56730, -56340, -2008, 32768), 0);
			...
			else
			{
				...
				else if (walks.containsKey(event))
				{
					...
					if (wi != null)
					{
						npc.getAI().setIntention(CtrlIntention.MOVING, wi.getCharPos(), 0);
