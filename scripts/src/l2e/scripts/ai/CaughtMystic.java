...
public class CaughtMystic extends Mystic
{
	...
	public CaughtMystic(Attackable actor)
	{
		super(actor);
	}
	...
	protected void onEvtDead(Creature killer)
	{
		...
		if (Rnd.chance(75))
		{
			actor.broadcastPacketToOthers(1000, new NpcSay(actor, Say2.NPC_ALL, NPC_STRINGS_ON_KILL[Rnd.get(NPC_STRINGS_ON_KILL.length)]));
		}
