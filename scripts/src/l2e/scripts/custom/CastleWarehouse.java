	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			case "warehouse-04.htm" :
				...
				{
					html.setFile(player, player.getLang(), "data/html/scripts/custom/CastleWarehouse/warehouse-04.htm");
					html.replace("%blood%", player.getClan().getBloodAllianceCount());
				}
				else
				{
					html.setFile(player, player.getLang(), "data/html/scripts/custom/CastleWarehouse/warehouse-no.htm");
				}
