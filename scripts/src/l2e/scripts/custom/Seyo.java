		...
		switch (event)
		{
			...
			case "give1":
			{
				...
				else
				{
					...
					if (getRandom(100) == 0)
					{
						...
						broadcastNpcSay(npc, Say2.NPC_ALL, NpcStringId.AMAZING_S1_TOOK_100_OF_THESE_SOUL_STONE_FRAGMENTS_WHAT_A_COMPLETE_SWINDLER, player.getName(null));
					}
					else
					{
						broadcastNpcSay(npc, Say2.NPC_ALL, NpcStringId.HMM_HEY_DID_YOU_GIVE_S1_SOMETHING_BUT_IT_WAS_JUST_1_HAHA, player.getName(null));
					}
			...
			case "give5":
			{
				...
				else
				{
					...
					if (chance < 20)
					{
						broadcastNpcSay(npc, Say2.NPC_ALL, NpcStringId.AHEM_S1_HAS_NO_LUCK_AT_ALL_TRY_PRAYING, player.getName(null));
					}
					else if (chance < 80)
					{
					...
					else
					{
						...
						broadcastNpcSay(npc, Say2.NPC_ALL, NpcStringId.S1_PULLED_ONE_WITH_S2_DIGITS_LUCKY_NOT_BAD, player.getName(null), String.valueOf(itemCount));
					}
					startQuestTimer("TRICKERY_TIMER", 5000, npc, null);
				}
				break;
			...
			case "give20":
			{
				...
				else
				{
					...
					if (chance == 0)
					{
						...
						broadcastNpcSay(npc, Say2.NPC_ALL, NpcStringId.AH_ITS_OVER_WHAT_KIND_OF_GUY_IS_THAT_DAMN_FINE_YOU_S1_TAKE_IT_AND_GET_OUTTA_HERE, player.getName(null));
					}
					else if (chance < 10)
					{
						giveItems(player, STONE_FRAGMENT, 1);
