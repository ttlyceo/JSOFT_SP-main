...
{
	// Time: 868s
	private static final VehicleTemplate[] GIRAN_TO_TALKING =
	{
	...
	private static final VehicleTemplate[] TALKING_DOCK =
	{
	                new VehicleTemplate(-96622, 261660, -3610, 150, 800)
	};

	// Time: 1398s
	private static final VehicleTemplate[] TALKING_TO_GIRAN =
	{
	...
	public BoatGiranTalking(int questId, String name, String descr)
	{
		...
		_boat = BoatManager.getInstance().getNewBoat(2, 48950, 190613, -3610, 60800);
