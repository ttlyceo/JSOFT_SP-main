...
public class AuraFriendlySummon implements ITargetTypeHandler
{
	@Override
	...
	private boolean checkTarget(Creature activeChar, Creature target)
	{
		...
		if (!activeChar.isPlayable() || !target.isSummon() || target.isAlikeDead())
		{
			return false;
		}
	...
	{
		return TargetType.AURA_FRIENDLY_SUMMON;
	}
}