			...
			if (!command.contains("menu"))
			{
				...
				for (final CursedWeapon cw : cwm.getCursedWeapons())
				{
					...
					if (cw.isActivated())
					{
						...
						activeChar.sendMessage("  Player holding: " + (pl == null ? "null" : pl.getName(null)));
