...
public class ManaDamPercent extends Effect
{
	public ManaDamPercent(Env env, EffectTemplate template)
	{
		super(env, template);
	}
	...
	{
		return EffectType.MPDAMPERCENT;
	}
	...
	public boolean onStart()
	{
		...
		final int damage = (int) ((getEffected().getCurrentMp() * calc()) / 100);
		...
		if (damage > 0)
		{
			getEffected().setCurrentMp(getEffected().getCurrentMp() - damage);
