...
public class RecoBonus extends Effect
{
	...
	public boolean onStart()
	{
		...
		getEffected().getActingPlayer().getRecommendation().stopRecBonus();
		return true;
	}
	...
	public void onExit()
	{
		...
		getEffected().getActingPlayer().getRecommendation().startRecBonus();
		getEffected().getActingPlayer().sendUserInfo(true);
		getEffected().getActingPlayer().sendVoteSystemInfo();
	}
