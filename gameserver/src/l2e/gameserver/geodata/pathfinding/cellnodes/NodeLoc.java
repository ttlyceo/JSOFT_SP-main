...
public class NodeLoc extends AbstractNodeLoc
{
	...
	public boolean cantGoAll()
	{
		return (!canGoNorth() && !canGoEast() && !canGoSouth() && !canGoWest()) ? false : true;
	}
	...
	{
		return new Location(GeoEngine.getInstance().getWorldX(_x), GeoEngine.getInstance().getWorldY(_y), _geoHeight);
	}
