...
public class DocumentSkill extends DocumentBase
{
	...
	private SkillTemplate _currentSkill;
	...
	protected String getTableValue(String name)
	{
		...
		{
			_log.warn("Error in table: " + name + " of Skill Id " + _currentSkill.id, e);
			return "";
		}
	}
	...
	protected String getTableValue(String name, int idx)
	{
		...
		{
			_log.warn("wrong level count in skill Id " + _currentSkill.id + " name: " + name + " index : " + idx, e);
			return "";
		}
	}
	...
	protected void parseSkill(Node n)
	{
		...
		{
			enchantLevels1 = EnchantSkillGroupsParser.getInstance().addNewRouteForSkill(skillId, lastLvl, 1, Integer.parseInt(attrs.getNamedItem("enchantGroup1").getNodeValue()));
		}
		if (attrs.getNamedItem("enchantGroup2") != null)
		{
			enchantLevels2 = EnchantSkillGroupsParser.getInstance().addNewRouteForSkill(skillId, lastLvl, 2, Integer.parseInt(attrs.getNamedItem("enchantGroup2").getNodeValue()));
		}
		if (attrs.getNamedItem("enchantGroup3") != null)
		{
			enchantLevels3 = EnchantSkillGroupsParser.getInstance().addNewRouteForSkill(skillId, lastLvl, 3, Integer.parseInt(attrs.getNamedItem("enchantGroup3").getNodeValue()));
		}
		if (attrs.getNamedItem("enchantGroup4") != null)
		{
			enchantLevels4 = EnchantSkillGroupsParser.getInstance().addNewRouteForSkill(skillId, lastLvl, 4, Integer.parseInt(attrs.getNamedItem("enchantGroup4").getNodeValue()));
		}
		if (attrs.getNamedItem("enchantGroup5") != null)
		{
			enchantLevels5 = EnchantSkillGroupsParser.getInstance().addNewRouteForSkill(skillId, lastLvl, 5, Integer.parseInt(attrs.getNamedItem("enchantGroup5").getNodeValue()));
		}
		if (attrs.getNamedItem("enchantGroup6") != null)
		{
			enchantLevels6 = EnchantSkillGroupsParser.getInstance().addNewRouteForSkill(skillId, lastLvl, 6, Integer.parseInt(attrs.getNamedItem("enchantGroup6").getNodeValue()));
		}
		if (attrs.getNamedItem("enchantGroup7") != null)
		{
			enchantLevels7 = EnchantSkillGroupsParser.getInstance().addNewRouteForSkill(skillId, lastLvl, 7, Integer.parseInt(attrs.getNamedItem("enchantGroup7").getNodeValue()));
		}
		if (attrs.getNamedItem("enchantGroup8") != null)
		{
			enchantLevels8 = EnchantSkillGroupsParser.getInstance().addNewRouteForSkill(skillId, lastLvl, 8, Integer.parseInt(attrs.getNamedItem("enchantGroup8").getNodeValue()));
		}
		...
		for (int i = 0; i < lastLvl; i++)
		{
			...
			for (final String lang : Config.MULTILANG_ALLOWED)
			{
				...
				{
					final String name = "name" + lang.substring(0, 1).toUpperCase() + lang.substring(1);
					_currentSkill.sets[i].set(name, params.getString(name));
				}
			}
		}
		...
		for (int i = 1; i <= lastLvl; i++)
		{
			...
			for (n = first; n != null; n = n.getNextSibling())
			{
				...
				else if (descr.equalsIgnoreCase(n.getNodeName()))
				{
					for (final String lang : Config.MULTILANG_ALLOWED)
					{
						if (lang != null)
						{
							final String name = "descr" + lang.substring(0, 1).toUpperCase() + lang.substring(1) + i;
							_currentSkill.sets[i - 1].set(name, n.getAttributes().getNamedItem(lang) != null ? n.getAttributes().getNamedItem(lang).getNodeValue() : n.getAttributes().getNamedItem(Config.MULTILANG_DEFAULT) != null ? n.getAttributes().getNamedItem(Config.MULTILANG_DEFAULT).getNodeValue() : "");
						}
					}
				}
			}
		...
		for (int i = 0; i < enchantLevels1; i++)
		{
			...
			for (final String lang : Config.MULTILANG_ALLOWED)
			{
				...
				{
					final String name = "name" + lang.substring(0, 1).toUpperCase() + lang.substring(1);
					_currentSkill.enchsets1[i].set(name, params.getString(name));
				}
			}
		...
		for (int i = 0; i < enchantLevels2; i++)
		{
			...
			for (final String lang : Config.MULTILANG_ALLOWED)
			{
				...
				{
					final String name = "name" + lang.substring(0, 1).toUpperCase() + lang.substring(1);
					_currentSkill.enchsets2[i].set(name, params.getString(name));
				}
			}
		...
		for (int i = 0; i < enchantLevels3; i++)
		{
			...
			for (final String lang : Config.MULTILANG_ALLOWED)
			{
				...
				{
					final String name = "name" + lang.substring(0, 1).toUpperCase() + lang.substring(1);
					_currentSkill.enchsets3[i].set(name, params.getString(name));
				}
			}
		...
		for (int i = 0; i < enchantLevels4; i++)
		{
			...
			for (final String lang : Config.MULTILANG_ALLOWED)
			{
				...
				{
					final String name = "name" + lang.substring(0, 1).toUpperCase() + lang.substring(1);
					_currentSkill.enchsets4[i].set(name, params.getString(name));
				}
			}
		...
		for (int i = 0; i < enchantLevels5; i++)
		{
			...
			for (final String lang : Config.MULTILANG_ALLOWED)
			{
				...
				{
					final String name = "name" + lang.substring(0, 1).toUpperCase() + lang.substring(1);
					_currentSkill.enchsets5[i].set(name, params.getString(name));
				}
			}
		...
		for (int i = 0; i < enchantLevels6; i++)
		{
			...
			for (final String lang : Config.MULTILANG_ALLOWED)
			{
				...
				{
					final String name = "name" + lang.substring(0, 1).toUpperCase() + lang.substring(1);
					_currentSkill.enchsets6[i].set(name, params.getString(name));
				}
			}
		...
		for (int i = 0; i < enchantLevels7; i++)
		{
			...
			for (final String lang : Config.MULTILANG_ALLOWED)
			{
				...
				{
					final String name = "name" + lang.substring(0, 1).toUpperCase() + lang.substring(1);
					_currentSkill.enchsets7[i].set(name, params.getString(name));
				}
			}
		...
		for (int i = 0; i < enchantLevels8; i++)
		{
			...
			for (final String lang : Config.MULTILANG_ALLOWED)
			{
				...
				{
					final String name = "name" + lang.substring(0, 1).toUpperCase() + lang.substring(1);
					_currentSkill.enchsets8[i].set(name, params.getString(name));
				}
			}
	...
	private void makeSkills()
	{
		...
		for (int i = 0; i < _currentSkill.sets.length; i++)
		{
			try
			{
				_currentSkill.currentSkills.add(i, _currentSkill.sets[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.sets[i]));
				count++;
			}
			catch (final Exception e)
			{
				_log.warn("Skill id=" + _currentSkill.sets[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.sets[i]).getDisplayId() + "level" + _currentSkill.sets[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.sets[i]).getLevel(), e);
			}
		}
		int _count = count;
		for (int i = 0; i < _currentSkill.enchsets1.length; i++)
		{
			try
			{
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets1[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets1[i]));
				count++;
			}
			catch (final Exception e)
			{
				_log.warn("Skill id=" + _currentSkill.enchsets1[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets1[i]).getDisplayId() + " level=" + _currentSkill.enchsets1[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets1[i]).getLevel(), e);
			}
		}
		_count = count;
		for (int i = 0; i < _currentSkill.enchsets2.length; i++)
		{
			try
			{
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets2[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets2[i]));
				count++;
			}
			catch (final Exception e)
			{
				_log.warn("Skill id=" + _currentSkill.enchsets2[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets2[i]).getDisplayId() + " level=" + _currentSkill.enchsets2[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets2[i]).getLevel(), e);
			}
		}
		_count = count;
		for (int i = 0; i < _currentSkill.enchsets3.length; i++)
		{
			try
			{
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets3[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets3[i]));
				count++;
			}
			catch (final Exception e)
			{
				_log.warn("Skill id=" + _currentSkill.enchsets3[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets3[i]).getDisplayId() + " level=" + _currentSkill.enchsets3[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets3[i]).getLevel(), e);
			}
		}
		_count = count;
		for (int i = 0; i < _currentSkill.enchsets4.length; i++)
		{
			try
			{
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets4[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets4[i]));
				count++;
			}
			catch (final Exception e)
			{
				_log.warn("Skill id=" + _currentSkill.enchsets4[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets4[i]).getDisplayId() + " level=" + _currentSkill.enchsets4[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets4[i]).getLevel(), e);
			}
		}
		_count = count;
		for (int i = 0; i < _currentSkill.enchsets5.length; i++)
		{
			try
			{
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets5[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets5[i]));
				count++;
			}
			catch (final Exception e)
			{
				_log.warn("Skill id=" + _currentSkill.enchsets5[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets5[i]).getDisplayId() + " level=" + _currentSkill.enchsets5[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets5[i]).getLevel(), e);
			}
		}
		_count = count;
		for (int i = 0; i < _currentSkill.enchsets6.length; i++)
		{
			try
			{
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets6[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets6[i]));
				count++;
			}
			catch (final Exception e)
			{
				_log.warn("Skill id=" + _currentSkill.enchsets6[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets6[i]).getDisplayId() + " level=" + _currentSkill.enchsets6[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets6[i]).getLevel(), e);
			}
		}
		_count = count;
		for (int i = 0; i < _currentSkill.enchsets7.length; i++)
		{
			try
			{
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets7[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets7[i]));
				count++;
			}
			catch (final Exception e)
			{
				_log.warn("Skill id=" + _currentSkill.enchsets7[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets7[i]).getDisplayId() + " level=" + _currentSkill.enchsets7[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets7[i]).getLevel(), e);
			}
		}
		_count = count;
		for (int i = 0; i < _currentSkill.enchsets8.length; i++)
		{
			try
			{
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets8[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets8[i]));
				count++;
			}
			catch (final Exception e)
			{
				_log.warn("Skill id=" + _currentSkill.enchsets8[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets8[i]).getDisplayId() + " level=" + _currentSkill.enchsets8[i].getEnum("skillType", SkillType.class, SkillType.DUMMY).makeSkill(_currentSkill.enchsets8[i]).getLevel(), e);
			}
		}
	}
}