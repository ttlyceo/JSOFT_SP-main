...
{
	private static final int _maxLevel = Config.MAX_SUBCLASS_LEVEL < ExperienceParser.getInstance().getMaxLevel() ? Config.MAX_SUBCLASS_LEVEL : (byte) (ExperienceParser.getInstance().getMaxLevel() - 1);
