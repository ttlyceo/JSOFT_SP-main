...
public enum ClassId implements IIdentifiable
{
	...
	mage(0x0a, true, Race.Human, null), wizard(0x0b, true, Race.Human, mage), sorceror(0x0c, true, Race.Human, wizard), necromancer(0x0d, true, Race.Human, wizard), warlock(0x0e, true, true, Race.Human, wizard), cleric(0x0f, true, Race.Human, mage), bishop(0x10, true, Race.Human, cleric), prophet(0x11, true, Race.Human, cleric),
	...
	elvenMage(0x19, true, Race.Elf, null), elvenWizard(0x1a, true, Race.Elf, elvenMage), spellsinger(0x1b, true, Race.Elf, elvenWizard), elementalSummoner(0x1c, true, true, Race.Elf, elvenWizard), oracle(0x1d, true, Race.Elf, elvenMage), elder(0x1e, true, Race.Elf, oracle),
	...
	darkMage(0x26, true, Race.DarkElf, null), darkWizard(0x27, true, Race.DarkElf, darkMage), spellhowler(0x28, true, Race.DarkElf, darkWizard), phantomSummoner(0x29, true, true, Race.DarkElf, darkWizard), shillienOracle(0x2a, true, Race.DarkElf, darkMage), shillenElder(0x2b, true, Race.DarkElf, shillienOracle),
	...
	orcMage(0x31, true, Race.Orc, null), orcShaman(0x32, true, Race.Orc, orcMage), overlord(0x33, true, Race.Orc, orcShaman), warcryer(0x34, true, Race.Orc, orcShaman),
	...
	evaTemplar(0x63, false, Race.Elf, templeKnight), swordMuse(0x64, false, Race.Elf, swordSinger), windRider(0x65, false, Race.Elf, plainsWalker), moonlightSentinel(0x66, false, Race.Elf, silverRanger), mysticMuse(0x67, true, Race.Elf, spellsinger), elementalMaster(0x68, true, true, Race.Elf, elementalSummoner), evaSaint(0x69, true, Race.Elf, elder),

	shillienTemplar(0x6a, false, Race.DarkElf, shillienKnight), spectralDancer(0x6b, false, Race.DarkElf, bladedancer), ghostHunter(0x6c, false, Race.DarkElf, abyssWalker), ghostSentinel(0x6d, false, Race.DarkElf, phantomRanger), stormScreamer(0x6e, true, Race.DarkElf, spellhowler), spectralMaster(0x6f, true, true, Race.DarkElf, phantomSummoner), shillienSaint(0x70, true, Race.DarkElf, shillenElder),
	...
	dummyEntry31(0x77, false, null, null), dummyEntry32(0x78, false, null, null), dummyEntry33(0x79, false, null, null), dummyEntry34(0x7a, false, null, null),

	maleSoldier(0x7b, false, Race.Kamael, null), femaleSoldier(0x7C, false, Race.Kamael, null), trooper(0x7D, false, Race.Kamael, maleSoldier), warder(0x7E, false, Race.Kamael, femaleSoldier), berserker(0x7F, false, Race.Kamael, trooper), maleSoulbreaker(0x80, false, Race.Kamael, trooper), femaleSoulbreaker(0x81, false, Race.Kamael, warder), arbalester(0x82, false, Race.Kamael, warder), doombringer(0x83, false, Race.Kamael, berserker), maleSoulhound(0x84, false, Race.Kamael, maleSoulbreaker), femaleSoulhound(0x85, false, Race.Kamael, femaleSoulbreaker), trickster(0x86, false, Race.Kamael, arbalester), inspector(0x87, false, Race.Kamael, warder), judicator(0x88, false, Race.Kamael, inspector);
	...
	public final static ClassId getClassById(int classId)
	{
		try
		{
			for (final ClassId id : values())
			{
				if (id.getRace() != null)
				{
					if (id.ordinal() == classId)
					{
						return id;
					}
				}
