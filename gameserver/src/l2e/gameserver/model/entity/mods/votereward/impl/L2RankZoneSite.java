...
public class L2RankZoneSite extends VoteRewardSite
{
	private final String _apiKey;
	private final long _voteDelay;
	private final String _identifierType;

	public L2RankZoneSite(MultiValueSet<String> parameters)
	{
		super(parameters);
		_apiKey = parameters.getString("api_key");
		_identifierType = parameters.getString("identifier_type");
