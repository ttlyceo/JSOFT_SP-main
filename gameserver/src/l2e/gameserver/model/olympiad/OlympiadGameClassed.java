...
{
	private OlympiadGameClassed(int id, Participant[] opponents, boolean isTraining)
	{
	...
	{
		return Config.ALT_OLY_CLASSED_LOSE_REWARD;
	}
	...
	protected static final OlympiadGameClassed createGame(int id, List<Set<Integer>> classList)
	{
		...
		while (!classList.isEmpty())
		{
			...
			return new OlympiadGameClassed(id, opponents, Olympiad.getInstance().isTrainingPeriod());
		}
		return null;
	}
}