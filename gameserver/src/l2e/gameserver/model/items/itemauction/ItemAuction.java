...
public final class ItemAuction
{
	...
	public final void registerBid(final Player player, final long newBid)
	{
		...
		synchronized (_auctionBids)
		{
			...
			final SystemMessage sm = SystemMessage.getSystemMessage(SystemMessageId.SUBMITTED_A_BID_OF_S1);
	...
	private final void onPlayerBid(final Player player, final ItemAuctionBid bid)
	{
		if (_highestBid == null)
		{
			_highestBid = bid;
	...
	public final void broadcastToAllBiddersInternal(final GameServerPacket packet)
	{
	...
	private final boolean reduceItemCount(final Player player, final long count)
	{
	...
	private final void increaseItemCount(final Player player, final long count)
	{
