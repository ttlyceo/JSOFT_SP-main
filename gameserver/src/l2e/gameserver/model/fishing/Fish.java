...
public class Fish implements Cloneable
{
	...
	public Fish(int fishId, int itemId, String itemName, int fishGroup, int fishLevel, int fishBiteRate, int fishGuts, int fishHp, int fishMaxLength, int fishLengthRate, int hpRegen, int startCombatTime, int combatDuration, int gutsCheckTime, int gutsCheckProbability, int cheatingProb, int fishGrade)
	{
		_fishId = fishId;
		_itemId = itemId;
		_itemName = itemName;
