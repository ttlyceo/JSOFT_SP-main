...
public class SepulcherMonsterInstance extends MonsterInstance
{
	...
	public void onSpawn()
	{
		...
		switch (getId())
		{
			...
			case 18243 :
				...
				_changeImmortalTask = ThreadPoolManager.getInstance().schedule(new ChangeImmortal(this), 500);
				break;
			case 18256 :
				break;
			case 25339 :
	...
	private class VictimShout implements Runnable
	{
		...
		public void run()
		{
			...
			broadcastPacket(new NpcSay(getObjectId(), 0, getId(), NpcStringId.HELP_ME));
		}
	}
	...
	private class VictimSpawnKeyBox implements Runnable
	{
		...
		public void run()
		{
			...
			broadcastPacket(new NpcSay(getObjectId(), 0, getId(), NpcStringId.THANK_YOU_FOR_SAVING_ME));
			if (_victimShout != null)
			{
				_victimShout.cancel(true);
			}
	...
	private static class ChangeImmortal implements Runnable
	{
		...
		public void run()
		{
			final Skill fp = SkillsParser.FrequentSkill.FAKE_PETRIFICATION.getSkill();
			if (fp != null)
			{
				fp.getEffects(activeChar, activeChar, false);
			}
		}
	}
