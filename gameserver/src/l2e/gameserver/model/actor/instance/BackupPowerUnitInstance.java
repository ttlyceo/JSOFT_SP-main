...
public class BackupPowerUnitInstance extends NpcInstance
{
	...
	public void showChatWindow(Player player, int val)
	{
		...
		{
			case COND_ALL_OK:
				message.setFile(player, player.getLang(), "data/html/fortress/fortress_subpower002.htm");
				getFort().getSiege().killedControlUnit(this);
				onDecay();
				break;
			case COND_TIMEOUT:
				message.setFile(player, player.getLang(), "data/html/fortress/fortress_subpower003.htm");
				break;
			case COND_FAIL:
				message.setFile(player, player.getLang(), "data/html/fortress/fortress_subpower003.htm");
				...
				break;
			case COND_ENTERED:
				message.setFile(player, player.getLang(), "data/html/fortress/fortress_subpower004.htm");
			...
			case COND_NO_ENTERED:
				message.setFile(player, player.getLang(), "data/html/fortress/fortress_subpower001.htm");
				break;
		}
