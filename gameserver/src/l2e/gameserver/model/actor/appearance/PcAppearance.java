...
public class PcAppearance
{
	...
	public final void setVisibleName(String visibleName)
	{
		...
		_displayName = _visibleName != null;
	}
	...
	{
		if (PvpColorManager.getInstance().isActive() && _nameColor == 0xFFFFFF)
		{
			return PvpColorManager.getInstance().getPlayerNameColor(_owner);
		}
		return _nameColor;
	}
	...
	{
		if (PvpColorManager.getInstance().isActive() && (_titleColor == 0xFFFF77 || _titleColor == 0xFFFFFF))
		{
			return PvpColorManager.getInstance().getPlayerTitleColor(_owner);
		}
		return _titleColor;
	}
