...
public class OnKillByMobNotifyTask implements Runnable
{
	private final Npc _attackable;
	private final List<Quest> _quests;
	private final Npc _killer;
	
	public OnKillByMobNotifyTask(Npc attackable, List<Quest> quests, Npc killer)
	{
	...
	public void run()
	{
		if ((_quests != null && !_quests.isEmpty()) && (_attackable != null) && (_killer != null))
		{
			...
			{
				quest.notifyKillByMob(_attackable, _killer);
			}
		}
	}
}