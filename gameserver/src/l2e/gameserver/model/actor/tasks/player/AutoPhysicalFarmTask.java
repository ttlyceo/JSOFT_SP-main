 ...
 */
public class AutoPhysicalFarmTask extends LoggerObject implements Runnable
{
	...
	private boolean selectRandomTarget()
	{
		...
		if (_committedOwner != null)
		{
			...
			else
			{
				...
				{
					final Location loc = Location.findPointToStay(_committedOwner.getLocation(), 100, false);
					if (loc != null)
					{
