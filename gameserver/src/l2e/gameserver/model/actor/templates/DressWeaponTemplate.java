...
public class DressWeaponTemplate
{
	...
	public DressWeaponTemplate(StatsSet params, int priceId, long priceCount, List<Skill> skills, double removeModifier)
	{
		_params = params;
		_priceId = priceId;
	...
	{
		return _params.getBool("isAllowEnchant");
	}
	
	public boolean isAllowAugment()
	{
		return _params.getBool("isAllowAugment");
	}
