...
public final class RequestExAcceptJoinMPCC extends GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (player != null)
		{
			...
			{
				player.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.C1_IS_BUSY_TRY_LATER).addString(requestor.getName(null)));
				return;
			}
			...
			{
				requestor.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.C1_DECLINED_CHANNEL_INVITATION).addString(player.getName(null)));
			}
