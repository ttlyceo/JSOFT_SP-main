...
public final class RequestDeleteReceivedPost extends GameClientPacket
{
	...
	public void runImpl()
	{
		...
		for (final int msgId : _msgIds)
		{
			...
			{
				Util.handleIllegalPlayerAction(activeChar, "" + activeChar.getName(null) + " tried to delete not own post!");
				return;
			}
