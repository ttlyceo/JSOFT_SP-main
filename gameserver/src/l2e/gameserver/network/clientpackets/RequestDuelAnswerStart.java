	...
	protected void runImpl()
	{
		...
		if (_response == 1)
		{
			...
			if (requestor.isInDuel())
			{
				...
				msg1.addString(requestor.getName(null));
			...
			if (_partyDuel == 1)
			{
				...
				msg2.addString(player.getName(null));
			}
			else
			{
		...
		{
			final SystemMessage sm = SystemMessage.getSystemMessage(SystemMessageId.C1_IS_SET_TO_REFUSE_DUEL_REQUEST);
			sm.addPcName(player);
