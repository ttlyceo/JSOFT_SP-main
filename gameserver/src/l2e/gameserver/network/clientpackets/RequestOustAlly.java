...
public final class RequestOustAlly extends GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		final Clan clan = ClanHolder.getInstance().getClanByName(_clanName);
		if (clan == null)
		{
		...
		leaderClan.setAllyPenaltyExpiryTime(currentTime + (Config.ALT_ACCEPT_CLAN_DAYS_WHEN_DISMISSED * 3600000L), Clan.PENALTY_TYPE_DISMISS_CLAN); // 24*60*60*1000
		                                                                                                                                             // =
		                                                                                                                                             // 86400000
		...
		clan.setAllyPenaltyExpiryTime(currentTime + (Config.ALT_ALLY_JOIN_DAYS_WHEN_DISMISSED * 3600000L), Clan.PENALTY_TYPE_CLAN_DISMISSED); // 24*60*60*1000
		                                                                                                                                       // =
		                                                                                                                                       // 86400000
		clan.updateClanInDB();
