...
public final class NpcStringId
{
	...
	/**
	 * ID: 2025<br>
	 * Message: $s1, whenever I see spice, I think I will miss your hand that
	 * used to feed it to me.
	 */
	public static final NpcStringId S1_WHENEVER_I_SEE_SPICE_I_THINK_I_WILL_MISS_YOUR_HAND_THAT_USED_TO_FEED_IT_TO_ME;

	/**
	 * ID: 2026<br>
	 * Message: $s1, don't go to the village. I don't have the strength to
	 * follow you.
	 */
	...
	/**
	 * ID: 2033<br>
	 * Message: I just know before this is over, I'm gonna need a lot of serious
	 * therapy.
	 */
	...
	/**
	 * ID: 2034<br>
	 * Message: I sense great wisdom in you... I'm an animal, and I got
	 * instincts.
	 */
	...
	/**
	 * ID: 2551<br>
	 * Message: You've ended my immortal life! You're protected by the feudal
	 * lord, aren't you?
	 */
	...
	/**
	 * ID: 6553<br>
	 * Message: $s1! I will be back soon. Stay there and don't you dare wander
	 * off!
	 */
	...
	/**
	 * ID: 6750<br>
	 * Message: $s1! You seek the forbidden knowledge and I cannot let you have
	 * it!
	 */
	...
	/**
	 * ID: 6765<br>
	 * Message: My time in your world has come to an end. Consider yourselves
	 * lucky...
	 */
	...
	/**
	 * ID: 6852<br>
	 * Message: Consider yourself lucky. The next time we meet, you will die -
	 * PERMANENTLY!
	 */
	...
	/**
	 * ID: 6854<br>
	 * Message: $s1! Who are you? And better yet, why are you bothering my
	 * minions?
	 */
	...
	/**
	 * ID: 6866<br>
	 * Message: Einhasad is calling me! You are lucky and I shall continue my
	 * punishment later!
	 */
	...
	/**
	 * ID: 6956<br>
	 * Message: I shall take my leave, but your head will be mine some day.. Oh
	 * yes..yes it will!
	 */
	...
	/**
	 * ID: 7054<br>
	 * Message: My spirit is released from this shell. I'm getting close to
	 * Halisha...
	 */
	...
	/**
	 * ID: 7066<br>
	 * Message: $s1! Your justice is just hypocrisy if you give up on what
	 * you've promised to protect.
	 */
	public static final NpcStringId S1_YOUR_JUSTICE_IS_JUST_HYPOCRISY_IF_YOU_GIVE_UP_ON_WHAT_YOUVE_PROMISED_TO_PROTECT;

	/**
	 * ID: 7067<br>
	 * Message: $s1...Don't think you've won! Your dark shadow will always
	 * follow you...hypocrite!
	 */
	public static final NpcStringId S1DONT_THINK_YOUVE_WON_YOUR_DARK_SHADOW_WILL_ALWAYS_FOLLOW_YOUHYPOCRITE;

	/**
	 * ID: 7150<br>
	 * Message: A temple knight guards the Mother Tree! $s1! Has Human contact
	...
	/**
	 * ID: 7151<br>
	 * Message: I must stop. Remember, the ones you're protecting will someday
	 * defeat the Elves.
	 */
	...
	/**
	 * ID: 7154<br>
	 * Message: My spirit is releasing from this shell. I'm getting close to
	 * Halisha...
	 */
	...
	/**
	 * ID: 7259<br>
	 * Message: You must be aware of your audience when singing, %s! => Join us
	 * $s1! A song that nobody listens to is empty.
	 */
	...
	/**
	 * ID: 7351<br>
	 * Message: Ha! I'm immortal. This scar will soon heal. You'll die next
	 * time.
	 */
	...
	/**
	 * ID: 7352<br>
	 * Message: Metellus! You promised me an immortal life! How could I,
	 * Swordmaster Iron, lose?
	 */
	...
	/**
	 * ID: 7359<br>
	 * Message: Are you interested in immortal life, $s1? It's too boring for
	 * me.
	 */
	...
	/**
	 * ID: 7360<br>
	 * Message: Excellent, $s1! Show me what you learned when your life was on
	 * the line!
	 */
	...
	/**
	 * ID: 7363<br>
	 * Message: Fighting without risk, training without danger and growing
	 * without hardship will only lead to an inflated ego. Don't forget.
	 */
	...
	/**
	 * ID: 7366<br>
	 * Message: That's good, $s1! Do you want my blessing to improve your
	 * skills?
	 */
	...
	/**
	 * ID: 7450<br>
	 * Message: In the name of gods, I punish you, $s1! You can't rival us all,
	...
	/**
	 * ID: 7451<br>
	 * Message: I have to stop for now, but I'll defeat the power of the dragon
	 * yet!
	 */
	...
	/**
	 * ID: 7459<br>
	 * Message: $s1! He's keeping an eye on all those in succession to the blood
	 * of dragons, including you!
	 */
	...
	/**
	 * ID: 7461<br>
	 * Message: I can't stay any longer. There are too many eyes on us.
	 * Farewell!
	 */
	...
	/**
	 * ID: 7463<br>
	 * Message: If we can't avoid this fight, we'll need great strength. It's
	...
	/**
	 * ID: 7466<br>
	 * Message: $s1! Are you against your mother's wishes? You're not worthy of
	 * the secrets of Shilen's children!
	 */
	...
	/**
	 * ID: 7467<br>
	 * Message: Excellent technique, $s1. Unfortunately, you're the one destined
	 * for tragedy!
	 */
	...
	/**
	 * ID: 7550<br>
	 * Message: $s1! You may follow me, but an Orc is no match for my giant's
	 * strength!
	 */
	...
	/**
	 * ID: 7559<br>
	 * Message: $s1. Nothing risked, nothing gained. Only those who fight enjoy
	...
	/**
	 * ID: 7652<br>
	 * Message: This can't be happening! I have the power of Azira! How could I
	 * fall so easily?
	 */
	...
	/**
	 * ID: 7657<br>
	 * Message: Azira, born from the Evil Flame, I'll kill you with my bare
	 * hands!
	 */
	...
	/**
	 * ID: 7658<br>
	 * Message: $s1! In the name of Khavatari Hubai, strike this evil with your
	 * fists!
	 */
	...
	/**
	 * ID: 7664<br>
	 * Message: Foolish Khavatari...Do you think your power will work on me? I'm
	 * the source of your martial art!
	 */
	...
	/**
	 * ID: 7750<br>
	 * Message: $s1, Akkan, you can't be my rival! I'll kill everything! I'll be
	 * the king!
	 */
	...
	/**
	 * ID: 7751<br>
	 * Message: Ha! I'll show mercy on you this time. I know well of your
	 * technique!
	 */
	...
	/**
	 * ID: 7758<br>
	 * Message: You're not a king! You're just a tyrant! $s1, we must fight
	 * together!
	 */
	...
	/**
	 * ID: 7759<br>
	 * Message: Such rule is ruining the country! $s1, I can't bear this tyranny
	 * any longer!
	 */
	...
	/**
	 * ID: 7763<br>
	 * Message: What is a king? What must one do to be a good king? Think it
	 * over.
	 */
	...
	/**
	 * ID: 7850<br>
	 * Message: Tejakar Sharuhi! $s1, I'll show you the power of Sharuhi Mouth
	 * Mudaha!
	 */
	...
	/**
	 * ID: 7858<br>
	 * Message: $s1, we must fight this soul together to prevent an everlasting
	 * winter!
	 */
	...
	/**
	 * ID: 8156<br>
	 * Message: Who are you? How can a creature from the netherworld be so
	 * powerful?
	 */
	...
	/**
	 * ID: 8258<br>
	 * Message: I'll never forget the taste of his steel, $s1! Let's fight him
	 * together!
	 */
	...
	/**
	 * ID: 8551<br>
	 * Message: Your faith is stronger than I thought. I'll pay you back next
	 * time.
	 */
	...
	/**
	 * ID: 8558<br>
	 * Message: He's got a tough shell. $s1! Let's fight together and crack his
	 * skull!
	 */
	...
	/**
	 * ID: 8651<br>
	 * Message: Your faith is stronger than I thought. I'll deal with you next
	 * time.
	 */
	...
	/**
	 * ID: 8657<br>
	 * Message: I'll destroy the darkness surrounding the world with the power
	 * of light!
	 */
	...
	/**
	 * ID: 8658<br>
	 * Message: $s1! Fight the Fallen Angel with me. Show the true power of
	 * light!
	 */
	...
	/**
	 * ID: 8750<br>
	 * Message: $s1! Elder, it's foolish of you to go against the will of the
	 * gods.
	 */
	...
	/**
	 * ID: 9150<br>
	 * Message: You carouse with evil spirits, $s1! You're not worthy of the
	 * holy wisdom!
	 */
	...
	/**
	 * ID: 9251<br>
	 * Message: You're stubborn as a mule! Guess I can't boss you around any
	 * more!
	 */
	...
	/**
	 * ID: 9267<br>
	 * Message: I won't forget the name of one who doesn't obey holy judgment,
	 * $s1!
	 */
	...
	/**
	 * ID: 9351<br>
	 * Message: You're stubborn as a mule! I guess I can't boss you around any
	 * more!
	 */
	...
	/**
	 * ID: 9457<br>
	 * Message: I can't let you commune with Tablet of Vision! Give me the
	 * Resonance Amulet!
	 */
	...
	/**
	 * ID: 9464<br>
	 * Message: Are you betraying me? I thought something was wrong...I'll stop
	 * here.
	 */
	...
	/**
	 * ID: 9467<br>
	 * Message: Dammit! My Resonance Amulet...$s1, I'll never forget to pay you
	 * back.
	 */
	...
	/**
	 * ID: 9557<br>
	 * Message: You can't commune with the Tablet of Vision! Give me the
	 * Resonance Amulet!
	 */
	...
	/**
	 * ID: 9759<br>
	 * Message: $s1! You have to fight better than that if you expect to
	 * survive!
	 */
	...
	/**
	 * ID: 9950<br>
	 * Message: $s1, You have an affinity for dangerous ideas. Are you ready to
	 * die?
	 */
	...
	/**
	 * ID: 10072<br>
	 * Message: This potion is prepared from the ground gall of a bear. Be
	 * careful - it packs quite a punch!
	 */
	...
	/**
	 * ID: 10074<br>
	 * Message: Listen to me, $s1! Unless you have prior authorization, you
	...
	/**
	 * ID: 11451<br>
	 * Message: $s1, your enemy was driven out. I will now withdraw and await
	 * your next command.
	 */
	...
	/**
	 * ID: 11453<br>
	 * Message: The radio signal detector is responding. # A suspicious pile of
	...
	/**
	 * ID: 11553<br>
	 * Message: Don't bother trying to find out more about me. Follow your own
	 * destiny.
	 */
	...
	/**
	 * ID: 18452<br>
	 * Message: The alarm will self-destruct in 60 seconds. Enter passcode to
	 * override.
	 */
	...
	/**
	 * ID: 18453<br>
	 * Message: The alarm will self-destruct in 30 seconds. Enter passcode to
	 * override.
	 */
	...
	/**
	 * ID: 18454<br>
	 * Message: The alarm will self-destruct in 10 seconds. Enter passcode to
	 * override.
	 */
	...
	/**
	 * ID: 18552<br>
	 * Message: The alarm will self-destruct in 60 seconds. Please evacuate
	 * immediately!
	 */
	...
	/**
	 * ID: 18553<br>
	 * Message: The alarm will self-destruct in 30 seconds. Please evacuate
	 * immediately!
	 */
	...
	/**
	 * ID: 18554<br>
	 * Message: The alarm will self-destruct in 10 seconds. Please evacuate
	 * immediately!
	 */
	...
	/**
	 * ID: 19306<br>
	 * Message: $s1! You may have won this time... But next time, I will surely
	 * capture you!
	 */
	...
	/**
	 * ID: 19607<br>
	 * Message: Dear Shillien's offsprings! You are not capable of confronting
	 * us!
	 */
	...
	/**
	 * ID: 19609<br>
	 * Message: Dear Military Force of Light! Go destroy the offsprings of
	 * Shillien!!!
	 */
	...
	/**
	 * ID: 19615<br>
	 * Message: You, such a fool! The victory over this war belongs to
	 * Shilien!!!
	 */
	...
	/**
	 * ID: 22819<br>
	 * Message: I am a tree of nothing... a tree... that knows where to
	 * return...
	 */
	...
	/**
	 * ID: 22820<br>
	 * Message: I am a creature that shows the truth of the place deep in my
	 * heart...
	 */
	...
	/**
	 * ID: 22936<br>
	 * Message: No! I haven't completely finished the command for destruction
	 * and slaughter yet!!!
	 */
	...
	/**
	 * ID: 34830<br>
	 * Message: Ha, that was fun! If you wish to find the key, search the
	 * corpse.
	 */
	...
	/**
	 * ID: 34839<br>
	 * Message: We don't have any further business to discuss... Have you
	 * searched the corpse for the key?
	 */
	...
	/**
	 * ID: 40312<br>
	 * Message: You ruthless fool, I will show you what real fighting is all
	 * about!
	 */
	...
	/**
	 * ID: 41652<br>
	 * Message: Listen to Tejakar Gandi, young Oroka! The spirit of the slain
	 * leopard is calling you, $s1!
	 */
	...
	/**
	 * ID: 42237<br>
	 * Message: You inconsiderate moron! Can't you even take care of little old
	 * me?!
	 */
	...
	/**
	 * ID: 42238<br>
	 * Message: Oh no! The man who eats one's sins has died! Penitence is
	 * further away~!
	 */
	...
	/**
	 * ID: 42244<br>
	 * Message: Hey, if you continue to waste time you will never finish your
	 * penance!
	 */
	...
	/**
	 * ID: 42247<br>
	 * Message: Oh, this is dragging on too long... At this rate I won't make it
	 * home before the seven seals are broken.
	 */
	...
	/**
	 * ID: 50339<br>
	 * Message: Curse of the gods on the one that defiles the property of the
	 * empire!
	 */
	...
	/**
	 * ID: 50503<br>
	 * Message: $s1 has won the main event for players under level $s2, and
	 * earned $s3 points!
	 */
	...
	/**
	 * ID: 50504<br>
	 * Message: $s1 has earned $s2 points in the main event for unlimited
	 * levels.
	 */
	...
	/**
	 * ID: 60024<br>
	 * Message: I guess you're the silent type. Then are you looking for
	 * treasure like me?
	 */
	...
	/**
	 * ID: 61050<br>
	 * Message: The magical power of water comes from the power of storm and
	 * hail! If you dare to confront it, only death will await you!
	 */
	...
	/**
	 * ID: 61051<br>
	 * Message: The power of constraint is getting weaker. Your ritual has
	 * failed!
	 */
	...
	/**
	 * ID: 61650<br>
	 * Message: The magical power of fire is also the power of flames and lava!
	 * If you dare to confront it, only death will await you!
	 */
	...
	/**
	 * ID: 70854<br>
	 * Message: Listen, you villagers. Our liege, who will soon become a lord,
	 * has defeated the Headless Knight. You can now rest easy!
	 */
	...
	/**
	 * ID: 71059<br>
	 * Message: $s1 has become the lord of the Town of Giran. May there be glory
	 * in the territory of Giran!
	 */
	...
	/**
	 * ID: 71159<br>
	 * Message: $s1 has become the lord of the Town of Innadril. May there be
	 * glory in the territory of Innadril!
	 */
	...
	/**
	 * ID: 71259<br>
	 * Message: $s1 has become the lord of the Town of Oren. May there be glory
	 * in the territory of Oren!
	 */
	public static final NpcStringId S1_HAS_BECOME_THE_LORD_OF_THE_TOWN_OF_OREN_MAY_THERE_BE_GLORY_IN_THE_TERRITORY_OF_OREN;

	/**
	 * ID: 71351<br>
	 * Message: $s1 has become the lord of the Town of Aden. May there be glory
	 * in the territory of Aden!
	 */
	public static final NpcStringId S1_HAS_BECOME_THE_LORD_OF_THE_TOWN_OF_ADEN_MAY_THERE_BE_GLORY_IN_THE_TERRITORY_OF_ADEN;

	/**
	 * ID: 71459<br>
	 * Message: $s1 has become the lord of the Town of Schuttgart. May there be
	...
	/**
	 * ID: 71559<br>
	 * Message: $s1 has become the lord of the Town of Goddard. May there be
	 * glory in the territory of Goddard!
	 */
	...
	/**
	 * ID: 71656<br>
	 * Message: You are in the midst of dealing with the heretic of Heretic
	 * Temple.
	 */
	...
	/**
	 * ID: 71659<br>
	 * Message: $s1 has become the lord of the Town of Rune. May there be glory
	 * in the territory of Rune!
	 */
	...
	/**
	 * ID: 71752<br>
	 * Message: $s1! The war is over. Lower your sword for the sake of the
	 * future.
	 */
	...
	/**
	 * ID: 71755<br>
	 * Message: 90 Territory Badges, 450 scores in Individual Fame and $s2
	 * Adenas
	 */
	...
	/**
	 * ID: 72903<br>
	 * Message: The mercenary quest number is $s1; memostate1 is $s2; and
	 * memostate2 is $s3.
	 */
	...
	/**
	 * ID: 72904<br>
	 * Message: user_connected event occurrence success. Siege Id is $s1, Number
	 * 728 memo2 is $s2. 729/memo2 is $s3, and 255/memo1 is $s4.
	 */
	...
	/**
	 * ID: 72905<br>
	 * Message: Territory Catapult dying event catapult's territory ID $s1,
	 * party status $s2.
	 */
	...
	/**
	 * ID: 99601<br>
	 * Message: Tra la la... Today, I'm going to make another fun-filled trip. I
	 * wonder what I should look for this time...
	 */
	...
	/**
	 * ID: 99709<br>
	 * Message: Raise me well and you'll be rewarded. Neglect me and suffer the
	 * consequences!
	 */
	...
	/**
	 * ID: 99733<br>
	 * Message: I'm not fully grown yet! Oh well, do what you will. I'll fade
	 * away without nectar anyway!
	 */
	...
	/**
	 * ID: 99740<br>
	 * Message: I'm feeling better! Another thirty seconds and I'll be out of
	 * here!
	 */
	...
	/**
	 * ID: 99796<br>
	 * Message: Don't you want a bigger squash? Give me some nectar and I'll
	 * grow much larger!
	 */
	...
	/**
	 * ID: 1000033<br>
	 * Message: Show me the wrath of the knight whose honor has been
	 * downtrodden!
	 */
	...
	/**
	 * ID: 1000047<br>
	 * Message: Step forward, you worthless creatures who challenge my
	 * authority!
	 */
	...
	/**
	 * ID: 1000053<br>
	 * Message: According to the command of Beleth... I'm going to observe you
	 * guys!
	 */
	...
	/**
	 * ID: 1000055<br>
	 * Message: A challenge against me is the same as a challenge against
	 * Beleth...
	 */
	...
	/**
	 * ID: 1000060<br>
	 * Message: I crossed back over the marshlands of death to reclaim the
	 * treasure!
	 */
	...
	/**
	 * ID: 1000065<br>
	 * Message: I am the guardian that honors the command of Antharas to watch
	 * over this place!
	 */
	...
	/**
	 * ID: 1000066<br>
	 * Message: You've set foot in Dragon Valley without permission! The penalty
	 * is death!
	 */
	...
	/**
	 * ID: 1000068<br>
	 * Message: The joy of killing! The ecstasy of looting! Hey guys, let's have
	 * a go at it again!
	 */
	...
	/**
	 * ID: 1000069<br>
	 * Message: There really are still lots of folks in the world without fear!
	...
	/**
	 * ID: 1000070<br>
	 * Message: If you hand over everything you've got, I'll at least spare your
	 * life!
	 */
	...
	/**
	 * ID: 1000077<br>
	 * Message: This is unbelievable! How could I have lost to one so inferior
	 * to myself?
	 */
	...
	/**
	 * ID: 1000082<br>
	 * Message: In the name of Orfen, I can never forgive you who are invading
	 * this place!
	 */
	...
	/**
	 * ID: 1000083<br>
	 * Message: I'll make you pay the price for fearlessly entering Orfen's
	 * land!
	 */
	...
	/**
	 * ID: 1000084<br>
	 * Message: Even if you disappear into nothingness, you will still face the
	 * life-long suffering of the curse that I have given you.
	 */
	...
	/**
	 * ID: 1000085<br>
	 * Message: I'll stand against anyone that makes light of the sacred place
	 * of the Elves!
	 */
	...
	/**
	 * ID: 1000087<br>
	 * Message: My brothers will never rest until we push you and your gang out
	 * of this valley!
	 */
	...
	/**
	 * ID: 1000092<br>
	 * Message: The sparkling mithril of the dwarves and their pretty treasures!
	 * I'll get them all!
	 */
	...
	/**
	 * ID: 1000096<br>
	 * Message: DESTRUCTION - EXTINCTION - SLAUGHTER - COLLAPSE! DESTRUCTION -
	 * EXTINCTION - SLAUGHTER - COLLAPSE!
	 */
	...
	/**
	 * ID: 1000102<br>
	 * Message: How exasperating and unfair to have things happen in such a
	 * meaningless way like this...
	 */
	...
	/**
	 * ID: 1000106<br>
	 * Message: I'll give you a curse that you'll never be able to remove
	 * forever!
	 */
	...
	/**
	 * ID: 1000108<br>
	 * Message: Those who are afraid should get away and those who are brave
	 * should fight!
	 */
	...
	/**
	 * ID: 1000109<br>
	 * Message: I've got power from Beleth so do you think I'll be easily
	 * defeated?!
	 */
	...
	/**
	 * ID: 1000110<br>
	 * Message: I am leaving now, but soon someone will come who will teach you
	 * all a lesson!
	 */
	...
	/**
	 * ID: 1000112<br>
	 * Message: The rumor is that there are wild, uncivilized ruffians who have
	 * recently arrived in my territory.
	 */
	...
	/**
	 * ID: 1000114<br>
	 * Message: What's just happened?! The invincible Sirocco was defeated by
	 * someone like you?!
	 */
	...
	/**
	 * ID: 1000125<br>
	 * Message: He just closed his eyes without disposing of the traitor... How
	 * unfair!
	 */
	...
	/**
	 * ID: 1000127<br>
	 * Message: The person that does not believe in kuroboros, his life will
	 * soon become hell!
	 */
	...
	/**
	 * ID: 1000128<br>
	 * Message: The lackey of that demented devil, the servant of a false god!
	 * I'll send that fool straight to hell!
	 */
	...
	/**
	 * ID: 1000129<br>
	 * Message: Uh... I'm not dying; I'm just disappearing for a moment... I'll
	 * resurrect again!
	 */
	...
	/**
	 * ID: 1000131<br>
	 * Message: Only those who believe in Patriarch Kuroboros shall receive
	 * salvation!
	 */
	...
	/**
	 * ID: 1000132<br>
	 * Message: Are you the ones that Sharuk has incited?! You also should trust
	 * in Kuroboros and be saved!
	 */
	...
	/**
	 * ID: 1000134<br>
	 * Message: You who have beautiful spirits that shine brightly! I have
	 * returned!
	 */
	...
	/**
	 * ID: 1000137<br>
	 * Message: Those of you who live! Do you know how beautiful your souls
	 * are?!
	 */
	...
	/**
	 * ID: 1000142<br>
	 * Message: I will never forgive the Pixy Murika... that is trying to...
	 * kill us!
	 */
	...
	/**
	 * ID: 1000146<br>
	 * Message: Hey... Shall we have some fun for the first time in a long
	 * while?...
	 */
	...
	/**
	 * ID: 1000147<br>
	 * Message: There've been some things going around like crazy here
	 * recently...
	 */
	...
	/**
	 * ID: 1000148<br>
	 * Message: Hey! Do you know who I am? I am Malex, Herald of Dagoniel!
	 * Attack!
	 */
	...
	/**
	 * ID: 1000149<br>
	 * Message: What's just happened?! The invincible Malex just lost to the
	 * likes of you?!
	 */
	...
	/**
	 * ID: 1000152<br>
	 * Message: I'll make you feel suffering like a flame that is never
	 * extinguished!
	 */
	...
	/**
	 * ID: 1000160<br>
	 * Message: You jerk. You're a devil! You're a devil to have made me like
	 * this!
	 */
	...
	/**
	 * ID: 1000183<br>
	 * Message: Your powers are impressive but you must not annoy our high level
	 * sorcerer.
	 */
	...
	/**
	 * ID: 1000191<br>
	 * Message: That is why I don't bother with anyone below the level of
	 * sorcerer.
	 */
	...
	/**
	 * ID: 1000196<br>
	 * Message: Is everybody listening? Sirion has come back. Everyone chant and
	 * bow...
	 */
	...
	/**
	 * ID: 1000199<br>
	 * Message: Don't think that you are invincible just because you defeated
	 * me!
	 */
	...
	/**
	 * ID: 1000205<br>
	 * Message: I must find the secret of eternal life, here among these rotten
	 * angels!
	 */
	...
	/**
	 * ID: 1000213<br>
	 * Message: The humans must not be allowed to destroy the marshland for
	...
	/**
	 * ID: 1000221<br>
	 * Message: Unless you leave this forest immediately you are bound to run
	...
	/**
	 * ID: 1000228<br>
	 * Message: Even the giants are gone! There's nothing left to be afraid of
	 * now!
	 */
	...
	/**
	 * ID: 1000239<br>
	 * Message: You filthy pig! Eat and be merry now that you have shirked your
	 * responsibilities!
	 */
	...
	/**
	 * ID: 1000240<br>
	 * Message: Those thugs! It would be too merciful to rip them apart and chew
	...
	/**
	 * ID: 1000245<br>
	 * Message: I must break the seal and release Lord Shilen as soon as
	 * possible...
	 */
	...
	/**
	 * ID: 1000247<br>
	 * Message: Lord Shilen... some day... you will accomplish... this
	 * mission...
	 */
	...
	/**
	 * ID: 1000251<br>
	 * Message: Eternal life in front of my eyes... I have collapsed in such a
	 * worthless way like this...
	 */
	...
	/**
	 * ID: 1000267<br>
	 * Message: How rude! Eva's love is available to all, even to an
	 * ill-mannered lout like yourself!
	 */
	...
	/**
	 * ID: 1000275<br>
	 * Message: Prepare to die, foreign invaders! I am Gustav, the eternal ruler
	 * of this fortress and I have taken up my sword to repel thee!
	 */
	...
	/**
	 * ID: 1000276<br>
	 * Message: Glory to Aden, the Kingdom of the Lion! Glory to Sir Gustav, our
	 * immortal lord!
	 */
	...
	/**
	 * ID: 1000278<br>
	 * Message: This is unbelievable! Have I really been defeated? I shall
	 * return and take your head!
	 */
	public static final NpcStringId THIS_IS_UNBELIEVABLE_HAVE_I_REALLY_BEEN_DEFEATED_I_SHALL_RETURN_AND_TAKE_YOUR_HEAD;

	/**
	 * ID: 1000279<br>
	 * Message: Could it be that I have reached my end? I cannot die without
	 * honor, without the permission of Sir Gustav!
	 */
	...
	/**
	 * ID: 1000280<br>
	 * Message: Ah, the bitter taste of defeat... I fear my torments are not
	 * over...
	 */
	...
	/**
	 * ID: 1000284<br>
	 * Message: The winning numbers for Lucky Lottery $s1 are $s2.
	...
	/**
	 * ID: 1000320<br>
	 * Message: The main event will finish in 2 minutes. Please prepare for the
	 * next game.
	 */
	...
	/**
	 * ID: 1000391<br>
	 * Message: How dare you interrupt a sacred duel! You must be taught a
	 * lesson!
	 */
	...
	/**
	 * ID: 1000417<br>
	 * Message: The end of time has come! The prophecy of destruction has been
	 * fulfilled!
	 */
	...
	/**
	 * ID: 1000422<br>
	 * Message: As foretold in the prophecy of darkness, the era of chaos has
	 * begun!
	 */
	...
	/**
	 * ID: 1000443<br>
	 * Message: The defenders of $s1 castle will be teleported to the inner
	 * castle.
	 */
	...
	/**
	 * ID: 1000458<br>
	 * Message: You, who are like the slugs crawling on the ground. The
	 * generosity and greatness of me, Daimon the White-Eyed is endless! Ha Ha
	 * Ha!
	 */
	...
	/**
	 * ID: 1000459<br>
	 * Message: If you want to be the opponent of me, Daimon the White-Eyed, you
	 * should at least have the basic skills~!
	 */
	...
	/**
	 * ID: 1000460<br>
	 * Message: You stupid creatures that are bound to the earth. You are
	 * suffering too much while dragging your fat, heavy bodies. I, Daimon, will
	 * lighten your burden.
	 */
	...
	/**
	 * ID: 1000461<br>
	 * Message: A weak and stupid tribe like yours doesn't deserve to be my
	 * enemy! Bwa ha ha ha!
	 */
	...
	/**
	 * ID: 1000462<br>
	 * Message: You dare to invade the territory of Daimon, the White-Eyed! Now,
	 * you will pay the price for your action!
	 */
	...
	/**
	 * ID: 1000463<br>
	 * Message: This is the grace of Daimon the White-Eyed, the great Monster
	 * Eye Lord! Ha Ha Ha!
	 */
	...
	/**
	 * ID: 1000478<br>
	 * Message: $s1! You have become a Hero of Moonlight Sentinels.
	 * Congratulations!
	 */
	...
	/**
	 * ID: 1000480<br>
	 * Message: $s1! You have become a Hero of Elemental Masters.
	 * Congratulations!
	 */
	...
	/**
	 * ID: 1000482<br>
	 * Message: $s1! You have become a Hero of the Shillien Templars.
	 * Congratulations!
	 */
	...
	/**
	 * ID: 1000483<br>
	 * Message: $s1! You have become a Hero of Spectral Dancers.
	 * Congratulations!
	 */
	...
	/**
	 * ID: 1000487<br>
	 * Message: $s1! You have become a Hero of Spectral Masters.
	 * Congratulations!
	 */
	...
	/**
	 * ID: 1000488<br>
	 * Message: $s1! You have become a Hero of the Shillien Saints.
	 * Congratulations!
	 */
	...
	/**
	 * ID: 1000490<br>
	 * Message: $s1! You have become a Hero of Grand Khavataris.
	 * Congratulations!
	 */
	...
	/**
	 * ID: 1000501<br>
	 * Message: If you place your hand on the stone statue in front of each
	 * sepulcher, you will be able to enter.
	 */
	...
	/**
	 * ID: 1000519<br>
	 * Message: Arrogant fool! You dare to challenge me, the Ruler of Flames?
	 * Here is your reward!
	 */
	...
	/**
	 * ID: 1000521<br>
	 * Message: Not even the gods themselves could touch me. But you, $s1, you
	 * dare challenge me?! Ignorant mortal!
	 */
	...
	/**
	 * ID: 1010214<br>
	 * Message: The mass of darkness will start in a couple of days. Pay more
	...
	/**
	 * ID: 1010221<br>
	 * Message: A black moon... Now do you understand that he has opened his
	 * eyes?
	 */
	...
	/**
	 * ID: 1010222<br>
	 * Message: Clouds of blood are gathering. Soon, it will start to rain. The
	...
	/**
	 * ID: 1010223<br>
	 * Message: While the foolish light was asleep, the darkness will awaken
	 * first. Uh huh huh...
	 */
	...
	/**
	 * ID: 1010224<br>
	 * Message: It is the deepest darkness. With its arrival, the world will
	 * soon die.
	 */
	...
	/**
	 * ID: 1010226<br>
	 * Message: Ahh! Beautiful goddess of death! Cover over the filth of this
	 * world with your darkness!
	 */
	public static final NpcStringId AHH_BEAUTIFUL_GODDESS_OF_DEATH_COVER_OVER_THE_FILTH_OF_THIS_WORLD_WITH_YOUR_DARKNESS;

	/**
	 * ID: 1010227<br>
	 * Message: The goddess's resurrection has already begun. Huhu...
	 * Insignificant creatures like you can do nothing!
	 */
	...
	/**
	 * ID: 1010410<br>
	 * Message: Huh, $s1 You pierced into the body of the Spirit with a needle.
	 * Are you ready?
	 */
	...
	/**
	 * ID: 1010411<br>
	 * Message: Ooh $s1 That's you. But, no lady is pleased with this savage
	 * invitation!
	 */
	...
	/**
	 * ID: 1010475<br>
	 * Message: The HP regeneration reduction device will be activated in 3
	 * minutes.
	 */
	...
	/**
	 * ID: 1010580<br>
	 * Message: Bwah-ha-ha! Your doom is at hand! Behold the Ultra Secret Super
	 * Weapon!
	 */
	...
	/**
	 * ID: 1010623<br>
	 * Message: Who dares to covet the throne of our castle! Leave immediately
	 * or you will pay the price of your audacity with your very own blood!
	 */
	...
	/**
	 * ID: 1010624<br>
	 * Message: Hmm, those who are not of the bloodline are coming this way to
	 * take over the castle?! Humph! The bitter grudges of the dead. You must
	 * not make light of their power!
	 */
	...
	/**
	 * ID: 1010626<br>
	 * Message: It's not over yet... It won't be... over... like this...
	 * Never...
	 */
	...
	/**
	 * ID: 1010632<br>
	 * Message: Oh no! The defenses have failed. It is too dangerous to remain
	 * inside the castle. Flee! Every man for himself!
	 */
	...
	/**
	 * ID: 1010633<br>
	 * Message: The game has begun. Participants, prepare to learn an important
	 * word.
	 */
	...
	/**
	 * ID: 1010636<br>
	 * Message: Heh Heh... I see that the feast has begun! Be wary! The curse of
	...
	/**
	 * ID: 1010637<br>
	 * Message: Arise, my faithful servants! You, my people who have inherited
	 * the blood. It is the calling of my daughter. The feast of blood will now
	 * begin!
	 */
	...
	/**
	 * ID: 1010639<br>
	 * Message: Grarr! For the next 2 minutes or so, the game arena are will be
	...
	/**
	 * ID: 1010640<br>
	 * Message: Grarr! $s1 team is using the hot springs sulfur on the
	 * opponent's camp.
	 */
	...
	/**
	 * ID: 1010644<br>
	 * Message: How dare you ruin the performance of the Dark Choir...
	 * Unforgivable!
	 */
	...
	/**
	 * ID: 1010645<br>
	 * Message: Get rid of the invaders who interrupt the performance of the
	 * Dark Choir!
	 */
	...
	/**
	 * ID: 1010646<br>
	 * Message: Don't you hear the music of death? Reveal the horror of the Dark
	 * Choir!
	 */
	...
	/**
	 * ID: 1029352<br>
	 * Message: This library... It's huge but there aren't many useful books,
	 * right?
	 */
	...
	/**
	 * ID: 1029450<br>
	 * Message: We must search high and low in every room for the reading desk
	 * that contains the book we seek.
	 */
	...
	/**
	 * ID: 1029451<br>
	 * Message: Remember the content of the books that you found. You can't take
	 * them out with you.
	 */
	...
	/**
	 * ID: 1029452<br>
	 * Message: It seems that you cannot remember to the room of the watcher who
	 * found the book.
	 */
	...
	/**
	 * ID: 1029460<br>
	 * Message: You foolish invaders who disturb the rest of Solina, be gone
	 * from this place.
	 */
	...
	/**
	 * ID: 1029461<br>
	 * Message: I know not what you seek, but this truth cannot be handled by
	 * mere humans.
	 */
	...
	/**
	 * ID: 1029462<br>
	 * Message: I will not stand by and watch your foolish actions. I warn you,
	...
	/**
	 * ID: 1029550<br>
	 * Message: The guardian of the seal doesn't seem to get injured at all
	...
	/**
	 * ID: 1029551<br>
	 * Message: The device located in the room in front of the guardian of the
	 * seal is definitely the barrier that controls the guardian's power.
	 */
	...
	/**
	 * ID: 1029552<br>
	 * Message: To remove the barrier, you must find the relics that fit the
	...
	/**
	 * ID: 1029553<br>
	 * Message: All the guardians were defeated, and the seal was removed.
	...
	/**
	 * ID: 1121005<br>
	 * Message: Attention please! The gates will be closing shortly. All
	 * visitors to the Queen's Castle should leave immediately.
	 */
	...
	/**
	 * ID: 1300001<br>
	 * Message: We have broken through the gate! Destroy the encampment and move
	 * to the Command Post!
	 */
	...
	/**
	 * ID: 1300002<br>
	 * Message: The command gate has opened! Capture the flag quickly and raise
	 * it high to proclaim our victory!
	 */
	...
	/**
	 * ID: 1300004<br>
	 * Message: You may have broken our arrows, but you will never break our
	 * will! Archers, retreat!
	 */
	public static final NpcStringId YOU_MAY_HAVE_BROKEN_OUR_ARROWS_BUT_YOU_WILL_NEVER_BREAK_OUR_WILL_ARCHERS_RETREAT;

	/**
	 * ID: 1300005<br>
	 * Message: At last! The Magic Field that protects the fortress has
	 * weakened! Volunteers, stand back!
	 */
	public static final NpcStringId AT_LAST_THE_MAGIC_FIELD_THAT_PROTECTS_THE_FORTRESS_HAS_WEAKENED_VOLUNTEERS_STAND_BACK;

	/**
	 * ID: 1300006<br>
	 * Message: Aiieeee! Command Center! This is guard unit! We need backup
	 * right away!
	 */
	...
	/**
	 * ID: 1300008<br>
	 * Message: Oh my, what has become of me??? My fame.. my friends.. lost..
	 * all lost...
	 */
	...
	/**
	 * ID: 1300012<br>
	 * Message: Everyone, concentrate your attacks on $s1! Show the enemy your
	 * resolve!
	 */
	...
	/**
	 * ID: 1300015<br>
	 * Message: Hey, these foes are tougher than they look. I'm going to need
	 * some help here.
	 */
	...
	/**
	 * ID: 1300018<br>
	 * Message: Don't think that it's gonna end like this. Your ambition will
	 * soon be destroyed as well.
	 */
	...
	/**
	 * ID: 1300020<br>
	 * Message: I feel so much grief that I can't even take care of myself.
	 * There isn't any reason for me to stay here any longer.
	 */
	...
	/**
	 * ID: 1300128<br>
	 * Message: Attempt $s1 / 3 is in progress. => This is the third attempt on
	 * $s1.
	 */
	...
	/**
	 * ID: 1300132<br>
	 * Message: Olympiad class-free team match is going to begin in Arena $s1 in
	 * a moment.
	 */
	...
	/**
	 * ID: 1300153<br>
	 * Message: You've done it! We believed in you, warrior. We want to show our
	 * sincerity, though it is small. Please give me some of your time.
	 */
	...
	/**
	 * ID: 1300163<br>
	 * Message: Courage! Ambition! Passion! Mercenaries who want to realize
	 * their dream of fighting in the territory war, come to me! Fortune and
	 * glory are waiting for you!
	 */
	...
	/**
	 * ID: 1300164<br>
	 * Message: Do you wish to fight? Are you afraid? No matter how hard you
	 * try, you have nowhere to run. But if you face it head on, our mercenary
	...
	/**
	 * ID: 1300166<br>
	 * Message: Olympiad class-free individual match is going to begin in Arena
	 * $s1 in a moment.
	 */
	...
	/**
	 * ID: 1300167<br>
	 * Message: Olympiad class individual match is going to begin in Arena $s1
	 * in a moment.
	 */
	...
	/**
	 * ID: 1600001<br>
	 * Message: Another player is currently being buffed. Please try again in a
	 * moment.
	 */
	...
	/**
	 * ID: 1600003<br>
	 * Message: You cannot mount a Wyvern while in battle mode or while mounted
	 * on a Strider.
	 */
	...
	/**
	 * ID: 1600013<br>
	 * Message: If you collect 50 individual Treasure Sack Pieces, you can
	 * exchange them for a Treasure Sack.
	 */
	...
	/**
	 * ID: 1600015<br>
	 * Message: You'd better use the Transformation spell at the right moment
	...
	/**
	 * ID: 1600018<br>
	 * Message: You can only purchase a Treasure Hunter Transformation Scroll
	 * once every 12 hours.
	 */
	...
	/**
	 * ID: 1600019<br>
	 * Message: If your means of arrival was a bit unconventional, then I'll be
	 * sending you back to Rune Township, which is the nearest town.
	 */
	...
	/**
	 * ID: 1800011<br>
	 * Message: Our master now comes to claim our vengeance. Soon you will all
	 * be nothing more than dirt...
	 */
	...
	/**
	 * ID: 1800014<br>
	 * Message: Oink oink! Pigs can do it too! Antharas-Surpassing Super Powered
	 * Pig Stun! How do like them apples?
	 */
	...
	/**
	 * ID: 1800017<br>
	 * Message: Oink oink! Pigs of the world unite! Let's show them our
	 * strength!
	 */
	...
	/**
	 * ID: 1800019<br>
	 * Message: Oink oink! This treatment hurts too much! Are you sure that
	...
	/**
	 * ID: 1800023<br>
	 * Message: It's a weapon surrounded by an ominous aura. I'll discard it
	 * because it may be dangerous. Miss...!
	 */
	...
	/**
	 * ID: 1800031<br>
	 * Message: An alarm has been set off! Everybody will be in danger if they
	...
	/**
	 * ID: 1800035<br>
	 * Message: Is no one there? How long have I been hiding? I have been
	 * starving for days and cannot hold out anymore!
	 */
	...
	/**
	 * ID: 1800036<br>
	 * Message: If someone would give me some of those tasty Crystal Fragments,
	 * I would gladly tell them where Tears is hiding! Yummy, yummy!
	 */
	...
	/**
	 * ID: 1800037<br>
	 * Message: Hey! You from above the ground! Let's share some Crystal
	 * Fragments, if you have any.
	 */
	...
	/**
	 * ID: 1800041<br>
	 * Message: How insensitive! It's not nice to give me just a piece! Can't
	 * you give me more?
	 */
	...
	/**
	 * ID: 1800070<br>
	 * Message: I can't help you much, but I can weaken the power of Baylor
	 * since I'm locked up here.
	 */
	public static final NpcStringId I_CANT_HELP_YOU_MUCH_BUT_I_CAN_WEAKEN_THE_POWER_OF_BAYLOR_SINCE_IM_LOCKED_UP_HERE;

	/**
	 * ID: 1800071<br>
	 * Message: Your skill is impressive. I'll admit that you are good enough to
	 * pass. Take the key and leave this place.
	 */
	...
	/**
	 * ID: 1800077<br>
	 * Message: You have finally come here. But you will not be able to find the
	 * secret room!
	 */
	...
	/**
	 * ID: 1800078<br>
	 * Message: You have done well in finding me, but I cannot just hand you the
	 * key!
	 */
	...
	/**
	 * ID: 1800080<br>
	 * Message: Match begins in $s1 minute(s). Please gather around the
	 * administrator.
	 */
	public static final NpcStringId MATCH_BEGINS_IN_S1_MINUTES;

	/**
	 * ID: 1800081<br>
	 * Message: The match is automatically canceled because you are too far from
	...
	/**
	 * ID: 1800086<br>
	 * Message: Now I'd like to introduce the most beautiful singer in Aden.
	 * Please welcome...Leyla Mira!
	 */
	...
	/**
	 * ID: 1800090<br>
	 * Message: Just back from their world tour put your hands together for the
	 * Fantasy Isle Circus!
	 */
	...
	/**
	 * ID: 1800102<br>
	 * Message: Please remember that Fantasy Isle is always planning a lot of
	 * great shows for you.
	 */
	...
	/**
	 * ID: 1800103<br>
	 * Message: Well, I wish I could continue all night long, but this is it for
	 * today. Thank you.
	 */
	...
	/**
	 * ID: 1800105<br>
	 * Message: How come people are not here... We are about to start the show..
	 * Hmm
	 */
	...
	/**
	 * ID: 1800123<br>
	 * Message: Match cancelled. Opponent did not meet the stadium admission
	 * requirements.
	 */
	...
	/**
	 * ID: 1800135<br>
	 * Message: HA-HA! You were so afraid of death... let me see... If you find
	 * me in time... maybe you can... find a way ...
	 */
	...
	/**
	 * ID: 1800138<br>
	 * Message: Squeak! This will be stronger than the stun the pig used last
	 * time!
	 */
	...
	/**
	 * ID: 1800147<br>
	 * Message: Oink-oink! Rage is boiling up inside of me! Power! Infinite
	 * power!!
	 */
	...
	/**
	 * ID: 1800163<br>
	 * Message: Huh... No one would have guessed that a doomed creature would be
	 * so powerful...
	 */
	...
	/**
	 * ID: 1800170<br>
	 * Message: This is... This is a great achievement that is worthy of the
	 * true heroes of legend!
	 */
	public static final NpcStringId THIS_IS_THIS_IS_A_GREAT_ACHIEVEMENT_THAT_IS_WORTHY_OF_THE_TRUE_HEROES_OF_LEGEND;

	/**
	 * ID: 1800171<br>
	 * Message: Admirable. You greatly decreased the speed of invasion through
	 * Kamaloka.
	 */
	...
	/**
	 * ID: 1800172<br>
	 * Message: Very good. Your skill makes you a model for other adventurers to
	 * follow.
	 */
	...
	/**
	 * ID: 1800173<br>
	 * Message: Good work. If all adventurers produce results like you, we will
	 * slowly start to see the glimmer of hope.
	 */
	...
	/**
	 * ID: 1800174<br>
	 * Message: Unfortunately, it seems that Rim Kamaloka cannot be easily
	...
	/**
	 * ID: 1800175<br>
	 * Message: How disappointing. It looks like I made a mistake in sending you
	 * inside Rim Kamaloka.
	 */
	...
	/**
	 * ID: 1800180<br>
	 * Message: If you thought that my subordinates would be so few, you are
	 * mistaken!
	 */
	...
	/**
	 * ID: 1800187<br>
	 * Message: We were able to successfully collect the Essence of Kamaloka
	 * from the Kanabions that you defeated. Here they are.
	 */
	...
	/**
	 * ID: 1800188<br>
	 * Message: But we were able to collect somehow the Essence of Kamaloka from
	 * the Kanabions that you defeated. Here they are.
	 */
	...
	/**
	 * ID: 1800189<br>
	 * Message: I'm sorry, but we were unable to collect the Essence of Kamaloka
	 * from the Kanabions that you defeated because their dark energy was too
	 * weak.
	 */
	...
	/**
	 * ID: 1800190<br>
	 * Message: Rather than simply defeating the enemies, you seem to understand
	 * our goal and purpose as well.
	 */
	...
	/**
	 * ID: 1800191<br>
	 * Message: Dopplers and Voids possess an enhanced amount of the Kanabions'
	 * dark energy, so it is important to concentrate on defeating them when
	 * blocking the Kamalokians attack.
	 */
	...
	/**
	 * ID: 1800192<br>
	 * Message: Have you seen Kanabions being remade as new Kanabions sometimes?
	 * You can see it occur more often by inflicting great damage during an
	 * attack or at the moment you defeat them.
	 */
	...
	/**
	 * ID: 1800193<br>
	 * Message: As in any other battle, it is critical to protect yourself while
	 * you are inside Rim Kamaloka. We do not want to attack recklessly.
	 */
	...
	/**
	 * ID: 1800194<br>
	 * Message: We value developing an individual's overall power rather than a
	 * one-time victory. If you relied on another person's support this time,
	 * why don't you try to rely on your own strength next time?
	 */
	...
	/**
	 * ID: 1800195<br>
	 * Message: Are you sure that the battle just now was at the appropriate
	 * level? Bothering lower Kanabions, as if for mere entertainment, is
	 * considered to be a wasted battle for us.
	 */
	...
	/**
	 * ID: 1800196<br>
	 * Message: The greatest victory involves using all available resources,
	 * eliminating all of the enemy's opportunities, and bringing it to the
	 * fastest possible end. Don't you think so?
	 */
	...
	/**
	 * ID: 1800201<br>
	 * Message: Some Kanabions who haven't fully adjusted yet to their new
	 * physical form are known to exhibit symptoms of an extremely weakened body
	 * structure sometimes. If you attack them at that moment, you will have
	 * great results.
	 */
	...
	/**
	 * ID: 1800203<br>
	 * Message: There are 5 minutes remaining to register for Kratei's cube
	 * match.
	 */
	...
	/**
	 * ID: 1800204<br>
	 * Message: There are 3 minutes remaining to register for Kratei's cube
	 * match.
	 */
	...
	/**
	 * ID: 1800205<br>
	 * Message: There are 1 minutes remaining to register for Kratei's cube
	 * match.
	 */
	...
	/**
	 * ID: 1800219<br>
	 * Message: The airship has been summoned. It will automatically depart in 5
	 * minutes.
	 */
	...
	/**
	 * ID: 1800220<br>
	 * Message: The regularly scheduled airship has arrived. It will depart for
	 * the Aden continent in 1 minute.
	 */
	...
	/**
	 * ID: 1800221<br>
	 * Message: The regularly scheduled airship that flies to the Aden continent
	 * has departed.
	 */
	 ...
	 * ID: 1800222<br>
	 * Message: The regularly scheduled airship has arrived. It will depart for
	 * the Gracia continent in 1 minute.
	 */
	...
	/**
	 * ID: 1800223<br>
	 * Message: The regularly scheduled airship that flies to the Gracia
	 * continent has departed.
	 */
	public static final NpcStringId THE_REGULARLY_SCHEDULED_AIRSHIP_THAT_FLIES_TO_THE_GRACIA_CONTINENT_HAS_DEPARTED;

	/**
	 * ID: 1800224<br>
	 * Message: Another airship has been summoned to the wharf. Please try again
	 * later.
	 */
	...
	/**
	 * ID: 1800226<br>
	 * Message: A powerful subordinate is being held by the Barrier Orb! This
	 * reaction means...!
	 */
	...
	/**
	 * ID: 1800233<br>
	 * Message: C'mon, c'mon! Show your face, you little rats! Let me see what
	...
	/**
	 * ID: 1800234<br>
	 * Message: Impressive.... Hahaha it's so much fun, but I need to chill a
	...
	/**
	 * ID: 1800235<br>
	 * Message: Kyahaha! Since the tumor has been resurrected, I no longer need
	...
	/**
	 * ID: 1800236<br>
	 * Message: Keu... I will leave for now... But don't think this is over...
	 * The Seed of Infinity can never die...
	 */
	public static final NpcStringId KEU_I_WILL_LEAVE_FOR_NOW_BUT_DONT_THINK_THIS_IS_OVER_THE_SEED_OF_INFINITY_CAN_NEVER_DIE;

	/**
	 * ID: 1800237<br>
	 * Message: Kahahaha! That guy's nothing! He can't even kill without my
	 * permission! See here! Ultimate forgotten magic! Deathless Guardian!
	 */
	...
	/**
	 * ID: 1800238<br>
	 * Message: I curse the day that I became your slave in order to escape
	 * death, Cohemenes! I swear that I shall see you die with my own eyes!
	 */
	...
	/**
	 * ID: 1800239<br>
	 * Message: My enemy is dying, and my blood is boiling! What cruel curse is
	 * this!
	 */
	...
	/**
	 * ID: 1800245<br>
	 * Message: Congratulations! You have succeeded at $s1 $s2! The instance
	 * will shortly expire.
	 */
	...
	/**
	 * ID: 1800247<br>
	 * Message: $s1's party has moved to a different location through the crack
	 * in the tumor!
	 */
	...
	/**
	 * ID: 1800248<br>
	 * Message: $s1's party has entered the Chamber of Ekimus through the crack
	 * in the tumor!
	 */
	...
	/**
	 * ID: 1800250<br>
	 * Message: There aren't enough items. In order to summon the airship, you
	 * need 5 Energy Star Stones.
	 */
	public static final NpcStringId THERE_ARENT_ENOUGH_ITEMS_IN_ORDER_TO_SUMMON_THE_AIRSHIP_YOU_NEED_5_ENERGY_STAR_STONES;

	/**
	 * ID: 1800251<br>
	 * Message: The Soul Devourers who are greedy to eat the Seeds of Life that
	 * remain alive until the end have awakened...!
	 */
	...
	/**
	 * ID: 1800254<br>
	 * Message: Clinging on won't help you! Ultimate forgotten magic, Blade
	 * Turn!
	 */
	...
	/**
	 * ID: 1800255<br>
	 * Message: Even special sauce can't help you! Ultimate forgotten magic,
	 * Force Shield!
	 */
	...
	/**
	 * ID: 1800256<br>
	 * Message: You little doomed maggots! Even if you keep swarming, the power
	 * of Immortality will only grow stronger!
	 */
	...
	/**
	 * ID: 1800257<br>
	 * Message: The Airship Summon License has been awarded. Your clan can now
	 * summon an airship.
	 */
	...
	/**
	 * ID: 1800261<br>
	 * Message: I shall accept your challenge, $s1! Come and die in the arms of
	 * immortality!
	 */
	...
	/**
	 * ID: 1800263<br>
	 * Message: You can hear the undead of Ekimus rushing toward you. $s1 $s2,
	 * it has now begun!
	 */
	...
	/**
	 * ID: 1800267<br>
	 * Message: We are blood brethren. I can't fall so easily here and leave my
	 * brother behind.
	 */
	...
	/**
	 * ID: 1800268<br>
	 * Message: You were always what I aspired to be. Do you think I would fall
	 * so easily here when I have a brother like that?
	 */
	...
	/**
	 * ID: 1800269<br>
	 * Message: With all connections to the tumor severed, Ekimus has lost its
	...
	/**
	 * ID: 1800270<br>
	 * Message: With the connection to the tumor restored, Ekimus has regained
	...
	/**
	 * ID: 1800273<br>
	 * Message: The enemies have attacked. Everyone come out and fight!!!! ...
	 * Urgh~!
	 */
	 ...
	 * the cowardly Cohemenes, you must destroy all the tumors!
	 */
	 ...
	 * restrengthened Cohemenes has fled deeper inside the seed...
	 */
	...
	/**
	 * ID: 1800277<br>
	 * Message: You do not currently have an Airship Summon License. You can
	 * earn your Airship Summon License through Engineer Lekon.
	 */
	 ...
	 * Message: I'm still hungry.
	 */
	public static final NpcStringId IM_STILL_HUNGRY_;
	...
	/**
	 * ID: 1800292<br>
	 * Message: You've sustained $s1 damage as Tumor's shell started melting
	 * after touching the sacred seal on the shield!
	 */
	...
	/**
	 * ID: 1800293<br>
	 * Message: You've sustained $s1 damage as Soul Coffin's shell started
	 * melting after touching the sacred seal on the shield!
	 */
	...
	/**
	 * ID: 1800295<br>
	 * Message: Obelisk has collapsed. Don't let the enemies jump around wildly
	 * anymore!!!!
	 */
	...
	/**
	 * ID: 1800296<br>
	 * Message: Enemies are trying to destroy the fortress. Everyone defend the
	 * fortress!!!!
	 */
	...
	/**
	 * ID: 1800298<br>
	 * Message: The undead of Ekimus is attacking Seed of Life. Defending Hall
	 * of Erosion will fail even if one Seed of Life is destroyed...
	 */
	...
	/**
	 * ID: 1800299<br>
	 * Message: All the tumors inside $s1 have been destroyed! Driven into a
	 ...
	 * ID: 1800300<br>
	 * Message: The tumor inside $s1 has been destroyed! \\nThe nearby Undead
	 * that were attacking Seed of Life start losing their energy and run away!
	 */
	 ...
	 * started to energize Ekimus again...
	 */
	 ...
	 * ID: 1800304<br>
	 * Message: The tumor inside $s1 has been destroyed! \\nThe speed that
	 * Ekimus calls out his prey has slowed down!
	 */
	 ...
	 * ID: 1800305<br>
	 * Message: The tumor inside $s1 has completely revived. \\nEkimus started
	 * to regain his energy and is desperately looking for his prey...
	 */
	...
	/**
	 * ID: 1800307<br>
	 * Message: The Hall of Erosion attack will fail unless you make a quick
	...
	/**
	 * ID: 1800308<br>
	 * Message: As the tumor was not threatened, Cohemenes completely ran away
	...
	/**
	 * ID: 1800310<br>
	 * Message: You may face an unforeseen problem on your course toward the
	 * goal.
	 */
	...
	/**
	 * ID: 1800311<br>
	 * Message: You may feel nervous and anxious because of unfavorable
	 * situations.
	 */
	...
	/**
	 * ID: 1800312<br>
	 * Message: Be warned when the situation is difficult because you may lose
	 * your judgment and make an irrational mistake.
	 */
	...
	/**
	 * ID: 1800316<br>
	 * Message: Your star of fortune says there'll be fish snapping at your
	 * bait.
	 */
	...
	/**
	 * ID: 1800318<br>
	 * Message: Your wisdom and creativity may lead you to success with your
	 * goal.
	 */
	...
	/**
	 * ID: 1800319<br>
	 * Message: You may accomplish your goals if you diligently pursue them
	 * without giving up.
	 */
	...
	/**
	 * ID: 1800320<br>
	 * Message: You may get help if you go through the front door without
	 * seeking tricks or maneuvers.
	 */
	public static final NpcStringId YOU_MAY_GET_HELP_IF_YOU_GO_THROUGH_THE_FRONT_DOOR_WITHOUT_SEEKING_TRICKS_OR_MANEUVERS;

	/**
	 * ID: 1800321<br>
	 * Message: A good result is on the way if you set a goal and bravely
	 * proceed toward it.
	 */
	...
	/**
	 * ID: 1800323<br>
	 * Message: Be firm and carefully scrutinize circumstances even when things
	 * are difficult.
	 */
	...
	/**
	 * ID: 1800324<br>
	 * Message: Always think over to find neglected problems you haven't taken
	 * care of yet.
	 */
	...
	/**
	 * ID: 1800329<br>
	 * Message: You may encounter a precious person who will lift your
	 * loneliness and discord.
	 */
	...
	/**
	 * ID: 1800332<br>
	 * Message: You will meet a person who can cherish your values if you
	 * maintain good ties with people.
	 */
	public static final NpcStringId YOU_WILL_MEET_A_PERSON_WHO_CAN_CHERISH_YOUR_VALUES_IF_YOU_MAINTAIN_GOOD_TIES_WITH_PEOPLE;

	/**
	 * ID: 1800333<br>
	 * Message: Maintain cooperative attitude since you will meet someone to be
	 * of help.
	 */
	...
	/**
	 * ID: 1800334<br>
	 * Message: Keep your moderation and ego in check even in successful phases
	 * of your life.
	 */
	...
	/**
	 * ID: 1800335<br>
	 * Message: When it comes to work, lifestyle and relationships you'll be
	 * better off to go by the text rather than tricks.
	 */
	...
	/**
	 * ID: 1800336<br>
	 * Message: Your task will receive substantial support since the
	 * surroundings will fully develop.
	 */
	public static final NpcStringId YOUR_TASK_WILL_RECEIVE_SUBSTANTIAL_SUPPORT_SINCE_THE_SURROUNDINGS_WILL_FULLY_DEVELOP;

	/**
	 * ID: 1800337<br>
	 * Message: Your star of fortune indicate a success with mental and material
	 * assistance.
	 */
	...
	/**
	 * ID: 1800338<br>
	 * Message: You will enjoy popularity with your creative talents and clever
	 * acts.
	 */
	...
	/**
	 * ID: 1800342<br>
	 * Message: An attitude that continually studies and explores is needed, and
	 * always be sincere.
	 */
	...
	/**
	 * ID: 1800344<br>
	 * Message: Your goals will move smoothly with peace and happiness in your
	 * life.
	 */
	...
	/**
	 * ID: 1800345<br>
	 * Message: Love may sprout its leaves when you treat those around you with
	 * care.
	 */
	...
	/**
	 * ID: 1800346<br>
	 * Message: You may climb into a higher position with others' trust if you
	...
	/**
	 * ID: 1800352<br>
	 * Message: No matter where it lies, your faithful drive leads you to
	 * success.
	 */
	...
	/**
	 * ID: 1800356<br>
	 * Message: Patience without being impetuous of the results will only bear a
	 * positive outcome.
	 */
	...
	/**
	 * ID: 1800359<br>
	 * Message: You will enjoy a huge success after unforeseen luck comes before
	 * you.
	 */
	...
	/**
	 * ID: 1800360<br>
	 * Message: Do not give up since there may be a miraculous rescue from the
	 * course of despair.
	 */
	...
	/**
	 * ID: 1800362<br>
	 * Message: You may get a shot in the arm in your life after meeting a good
	 * person.
	 */
	...
	/**
	 * ID: 1800367<br>
	 * Message: A hard situation will come to its end with materialistic and
	 * mental help from others.
	 */
	public static final NpcStringId A_HARD_SITUATION_WILL_COME_TO_ITS_END_WITH_MATERIALISTIC_AND_MENTAL_HELP_FROM_OTHERS;

	/**
	 * ID: 1800368<br>
	 * Message: If you set a firm goal without surrender, there will be a person
	 * who can offer help and care.
	 */
	...
	/**
	 * ID: 1800369<br>
	 * Message: You'll gain others' trust when you maintain a sincere and honest
	 * attitude.
	 */
	...
	/**
	 * ID: 1800373<br>
	 * Message: You're running toward the goal but there won't be as many
	 * outcomes as you thought.
	 */
	...
	/**
	 * ID: 1800377<br>
	 * Message: You may need to reflect on yourself with deliberation and wait
	 * for an opportunity.
	 */
	...
	/**
	 * ID: 1800381<br>
	 * Message: Complicated problems around you may start being solved one after
	 * another.
	 */
	...
	/**
	 * ID: 1800382<br>
	 * Message: You will have a good result if you diligently pursue one goal
	 * without being dragged from your past.
	 */
	...
	/**
	 * ID: 1800384<br>
	 * Message: Be responsible with your tasks but do not hesitate to ask for
	 * colleagues' help.
	 */
	...
	/**
	 * ID: 1800388<br>
	 * Message: You may acquire money or a new opportunity from a place you
	...
	/**
	 * ID: 1800389<br>
	 * Message: There will be many offers to you, you may think them over
	 * carefully.
	 */
	...
	/**
	 * ID: 1800390<br>
	 * Message: It may be a good idea not to become involved in others'
	 * business.
	 */
	...
	/**
	 * ID: 1800391<br>
	 * Message: Everything will go smoothly but be aware of danger from being
	 * careless and remiss.
	 */
	...
	/**
	 * ID: 1800392<br>
	 * Message: If you sincerely care for someone you love, a big reward will
	 * return to you.
	 */
	...
	/**
	 * ID: 1800394<br>
	 * Message: You may acquire a precious medicine to recover after suffering a
	...
	/**
	 * ID: 1800395<br>
	 * Message: You may realize your dream by meeting a man of distinction at a
	 * difficult time.
	 */
	...
	/**
	 * ID: 1800397<br>
	 * Message: If you keep smiling without despair, people will come to trust
	 * you and offer help.
	 */
	...
	/**
	 * ID: 1800402<br>
	 * Message: You may be unable to concentrate with so many problems
	 * occurring.
	 */
	...
	/**
	 * ID: 1800406<br>
	 * Message: Someone will acknowledge you if you relentlessly keep trying and
	 * do not give up when facing hardships.
	 */
	...
	/**
	 * ID: 1800407<br>
	 * Message: You may perfect yourself like a dragon's horn decorates the
	 * dragon.
	 */
	...
	/**
	 * ID: 1800409<br>
	 * Message: Your steady pursuit of new information and staying ahead of
	 * others will raise your value.
	 */
	public static final NpcStringId YOUR_STEADY_PURSUIT_OF_NEW_INFORMATION_AND_STAYING_AHEAD_OF_OTHERS_WILL_RAISE_YOUR_VALUE;

	/**
	 * ID: 1800410<br>
	 * Message: Maintaining confidence with work or relationships may bring good
	 * results.
	 */
	...
	/**
	 * ID: 1800413<br>
	 * Message: As the dragon flies high in the sky, your goals and dreams may
	 * come true.
	 */
	...
	/**
	 * ID: 1800416<br>
	 * Message: It's as good as it gets with unforeseen fortune rolling your
	 * way.
	 */
	...
	/**
	 * ID: 1800424<br>
	 * Message: Be cautioned as unharnessed behavior at difficult times can ruin
	 * relationships.
	 */
	...
	/**
	 * ID: 1800425<br>
	 * Message: Curtail greed and be grateful for small returns as modesty is
	 * needed.
	 */
	...
	/**
	 * ID: 1800427<br>
	 * Message: Your work and relationship with colleagues will be well managed
	 * if you maintain your devotion.
	 */
	...
	/**
	 * ID: 1800428<br>
	 * Message: Calculating your profit in relationships without displaying any
	 * courteous manners will bring malicious gossip and ruin your value.
	 */
	...
	/**
	 * ID: 1800429<br>
	 * Message: Consider other's situations and treat them sincerely at all
	 * times.
	 */
	...
	/**
	 * ID: 1800431<br>
	 * Message: Reflect other's opinions as a mistake always lies ahead of an
	 * arbitrary decision.
	 */
	...
	/**
	 * ID: 1800435<br>
	 * Message: Difficulties lie ahead of an unforeseen problem even with your
	 * hard work.
	 */
	...
	/**
	 * ID: 1800436<br>
	 * Message: There may be more occasions you will want to ask favors from
	 * others as you lose confidence in you.
	 */
	...
	/**
	 * ID: 1800437<br>
	 * Message: Be brave and ambitious as no bird can fly into the sky by
	...
	/**
	 * ID: 1800438<br>
	 * Message: It's a good idea not to start an unclear task and always look
	 * for someone you can trust and rely upon.
	 */
	...
	/**
	 * ID: 1800441<br>
	 * Message: An easy task may fail if one is consumed by greed and
	 * overconfidence.
	 */
	...
	/**
	 * ID: 1800443<br>
	 * Message: Thoughtful foresight is needed before a disaster may fall upon
	 * you.
	 */
	...
	/**
	 * ID: 1800444<br>
	 * Message: Refrain from dictatorial acts as caring for others around you
	 * with dignity is much needed.
	 */
	...
	/**
	 * ID: 1800446<br>
	 * Message: You may fall into a vexing situation as bad circumstances will
	 * arise.
	 */
	...
	/**
	 * ID: 1800448<br>
	 * Message: Do not seek a quick fix as the problem needs a fundamental
	 * resolution.
	 */
	...
	/**
	 * ID: 1800449<br>
	 * Message: Seek peace in your heart as vulgar display of your emotions may
	 * harm you.
	 */
	...
	/**
	 * ID: 1800450<br>
	 * Message: Information for success may come from the conversations with
	 * people around you.
	 */
	...
	/**
	 * ID: 1800453<br>
	 * Message: Good fortune and opportunity may lie ahead as if one's born in a
	 * golden spoon.
	 */
	...
	/**
	 * ID: 1800454<br>
	 * Message: Your life flows as if it's on a silk surface and unexpected
	 * fortune and success may come to you.
	 */
	...
	/**
	 * ID: 1800457<br>
	 * Message: The abilities to amend, foresee and analyze may raise your
	 * value.
	 */
	...
	/**
	 * ID: 1800458<br>
	 * Message: Bigger mistakes will be on the road if you fail to correct a
	 * small mistake.
	 */
	...
	/**
	 * ID: 1800461<br>
	 * Message: Be warned as you may be overwhelmed by surroundings if you lack
	 * a clear opinion.
	 */
	...
	/**
	 * ID: 1800463<br>
	 * Message: You will gain popularity as you help people with money you
	 * earnestly earned.
	 */
	...
	/**
	 * ID: 1800465<br>
	 * Message: Be warned as you may be dragged to an unwanted direction if not
	 * cautious.
	 */
	...
	/**
	 * ID: 1800466<br>
	 * Message: You may meet many new people but it will be difficult to find a
	 * perfect person who wins your heart.
	 */
	...
	/**
	 * ID: 1800468<br>
	 * Message: It may not be a good time for a change even if there's tedium in
	 * daily life.
	 */
	...
	/**
	 * ID: 1800469<br>
	 * Message: The money you spend for yourself may act as an investment and
	 * bring you a return.
	 */
	...
	/**
	 * ID: 1800472<br>
	 * Message: Your star indicated such good luck, participate in bonus
	 * giveaways or events.
	 */
	...
	/**
	 * ID: 1800475<br>
	 * Message: There will be a good result if you keep your own pace regardless
	 * of others' judgment.
	 */
	...
	/**
	 * ID: 1800476<br>
	 * Message: Be warned as unexpected luck may be wasted with your reckless
	 * comments.
	 */
	...
	/**
	 * ID: 1800477<br>
	 * Message: Overconfidence will convince you to carry a task above your
	 * reach and there will be consequences.
	 */
	...
	/**
	 * ID: 1800479<br>
	 * Message: Trouble spots lie ahead when talking to superiors or people
	 * close to you.
	 */
	...
	/**
	 * ID: 1800480<br>
	 * Message: Be warned as your words can hurt others or others' words can
	 * hurt you.
	 */
	...
	/**
	 * ID: 1800481<br>
	 * Message: Make a loud boast and you may have to pay to cover unnecessary
	 * expenses.
	 */
	...
	/**
	 * ID: 1800482<br>
	 * Message: Skillful evasion is needed when dealing with people who pick
	 * fights as a disaster may arise from it.
	 */
	...
	/**
	 * ID: 1800483<br>
	 * Message: Keep a low profile as too strong an opinion will attract adverse
	 * reactions.
	 */
	...
	/**
	 * ID: 1800484<br>
	 * Message: Do not unnecessarily provoke misunderstanding as you may be
	...
	/**
	 * ID: 1800487<br>
	 * Message: Pay special attention when meeting or talking to people as
	 * relationships may go amiss.
	 */
	public static final NpcStringId PAY_SPECIAL_ATTENTION_WHEN_MEETING_OR_TALKING_TO_PEOPLE_AS_RELATIONSHIPS_MAY_GO_AMISS;

	/**
	 * ID: 1800488<br>
	 * Message: When the important moment arrives, decide upon what you truly
	 * want without measuring others' judgment.
	 */
	...
	/**
	 * ID: 1800490<br>
	 * Message: Head to a place that needs your advice as good ideas and wisdom
	 * will flourish.
	 */
	...
	/**
	 * ID: 1800492<br>
	 * Message: It's a proper time to plan for the future rather than a short
	 * term plan.
	 */
	...
	/**
	 * ID: 1800493<br>
	 * Message: Many thoughtful plans at present time will be of great help in
	 * the future.
	 */
	...
	/**
	 * ID: 1800494<br>
	 * Message: Patience may be needed as a big quarrel arises between you and a
	 * person close to you.
	 */
	...
	/**
	 * ID: 1800495<br>
	 * Message: Do not ask for financial help when the time is difficult. Your
	 * pride will be hurt without gaining any money.
	 */
	...
	/**
	 * ID: 1800498<br>
	 * Message: Keep good manners and value taciturnity as light-heartedness may
	 * bring misfortune.
	 */
	...
	/**
	 * ID: 1800501<br>
	 * Message: Loss is ahead, refrain from investing. Try to save the money in
	 * your pockets.
	 */
	...
	/**
	 * ID: 1800504<br>
	 * Message: There will be difficulty, but a good result may be ahead when
	 * facing it responsibly.
	 */
	public static final NpcStringId THERE_WILL_BE_DIFFICULTY_BUT_A_GOOD_RESULT_MAY_BE_AHEAD_WHEN_FACING_IT_RESPONSIBLY;

	/**
	 * ID: 1800505<br>
	 * Message: Even with some difficulties, expand the range of your scope
	 * where you are in charge. It will return to you as help.
	 */
	...
	/**
	 * ID: 1800506<br>
	 * Message: Focus on maintaining organized surroundings to help reduce your
	 * losses.
	 */
	...
	/**
	 * ID: 1800507<br>
	 * Message: Luck lies ahead when waiting for people rather than following
	 * them.
	 */
	...
	/**
	 * ID: 1800508<br>
	 * Message: Do not offer your hand first even when things are hasty. The
	...
	/**
	 * ID: 1800512<br>
	 * Message: Things will move effortlessly but luck will vanish with your
	 * audacity.
	 */
	...
	/**
	 * ID: 1800513<br>
	 * Message: Luck may be continued only when humility is maintained after
	 * success.
	 */
	...
	/**
	 * ID: 1800515<br>
	 * Message: Look for someone with a similar style. It will open up for the
	 * good.
	 */
	...
	/**
	 * ID: 1800516<br>
	 * Message: An offer may soon be made to collaborate a task but delaying it
	 * will be a good idea.
	 */
	...
	/**
	 * ID: 1800517<br>
	 * Message: Partnership is out of luck, avoid someone who rushes you to
	...
	/**
	 * ID: 1800518<br>
	 * Message: Focus on networking with like-minded people. They may join you
	 * for a big mission in the future.
	 */
	...
	/**
	 * ID: 1800519<br>
	 * Message: Be warned when someone says you are innocent as that's not a
	 * compliment.
	 */
	...
	/**
	 * ID: 1800520<br>
	 * Message: You may be scammed. Be cautious as there may be a big loss by
	...
	/**
	 * ID: 1800521<br>
	 * Message: Luck at decision-making is dim, avoid subjective conclusions and
	 * rely on universal common-sense.
	 */
	...
	/**
	 * ID: 1800522<br>
	 * Message: Your weakness may invite hardships, cautiously take a strong
	 * position as needed.
	 */
	...
	/**
	 * ID: 1800523<br>
	 * Message: Be wary of someone who talks and entertains too much. The person
	 * may bring you misfortune.
	 */
	...
	/**
	 * ID: 1800527<br>
	 * Message: Even if you can complete it by yourself, it's a good idea to
	...
	/**
	 * ID: 1800528<br>
	 * Message: Make harmony with people the priority. Stubbornness may bring
	 * hardships.
	 */
	...
	/**
	 * ID: 1800529<br>
	 * Message: There may be a chance when you can see a new aspect of a close
	 * friend.
	 */
	...
	/**
	 * ID: 1800530<br>
	 * Message: Try to be close to someone different from you without any
	...
	/**
	 * ID: 1800531<br>
	 * Message: Good luck in becoming a leader with many followers. However,
	 * it'll only be after hard work.
	 */
	public static final NpcStringId GOOD_LUCK_IN_BECOMING_A_LEADER_WITH_MANY_FOLLOWERS_HOWEVER_ITLL_ONLY_BE_AFTER_HARD_WORK;

	/**
	 * ID: 1800532<br>
	 * Message: Your wealth luck is rising, expenditures will be followed by
	 * substantial income as you are able to sustain.
	 */
	...
	/**
	 * ID: 1800533<br>
	 * Message: Be cautious as your wealth luck can be either very good or very
	 * bad.
	 */
	...
	/**
	 * ID: 1800534<br>
	 * Message: Be warned as a small argument can distance you from a close
	 * friend.
	 */
	...
	/**
	 * ID: 1800537<br>
	 * Message: There may be a relationship breaking, try to eliminate
	 * misunderstandings.
	 */
	...
	/**
	 * ID: 1800541<br>
	 * Message: Conveying your own truth may be difficult and easy
	 * misunderstandings will follow.
	 */
	...
	/**
	 * ID: 1800544<br>
	 * Message: Value substance opposed to the sake honor and look beyond what's
	 * in front of you.
	 */
	...
	/**
	 * ID: 1800547<br>
	 * Message: Being level-headed not focusing on emotions may help with
	 * relationships.
	 */
	...
	/**
	 * ID: 1800548<br>
	 * Message: It's a good idea to take care of matters in sequential order
	 * without measuring their importance.
	 */
	...
	/**
	 * ID: 1800551<br>
	 * Message: It may not be a good time for an important decision, be wary of
	 * temptations and avoid monetary dealings.
	 */
	...
	/**
	 * ID: 1800553<br>
	 * Message: There may be moderate solutions to every problem when they're
	 * viewed from a 3rd party's point of view.
	 */
	...
	/**
	 * ID: 1800554<br>
	 * Message: Dealings with close friends only bring frustration and headache,
	 * politely decline and mention another chance.
	 */
	...
	/**
	 * ID: 1800555<br>
	 * Message: There may be a problem at completion if the basic matters are
	...
	/**
	 * ID: 1800556<br>
	 * Message: Distinguishing business from a private matter is needed to
	 * succeed.
	 */
	...
	/**
	 * ID: 1800558<br>
	 * Message: Preparing for an unforeseen situation will be difficult when
	 * small matters are ignored.
	 */
	public static final NpcStringId PREPARING_FOR_AN_UNFORESEEN_SITUATION_WILL_BE_DIFFICULT_WHEN_SMALL_MATTERS_ARE_IGNORED;

	/**
	 * ID: 1800559<br>
	 * Message: Refrain from getting involved in others' business, try to be
	 * loose as a goose.
	 */
	...
	/**
	 * ID: 1800560<br>
	 * Message: Being neutral is a good way to go, but clarity may be helpful
	 * contrary to your hesitance.
	 */
	public static final NpcStringId BEING_NEUTRAL_IS_A_GOOD_WAY_TO_GO_BUT_CLARITY_MAY_BE_HELPFUL_CONTRARY_TO_YOUR_HESITANCE;

	/**
	 * ID: 1800561<br>
	 * Message: Be cautious of your own actions, the past may bring
	 * misunderstandings.
	 */
	...
	/**
	 * ID: 1800563<br>
	 * Message: Heroism will be rewarded, but be careful not to display
	 * arrogance or lack of sincerity.
	 */
	public static final NpcStringId HEROISM_WILL_BE_REWARDED_BUT_BE_CAREFUL_NOT_TO_DISPLAY_ARROGANCE_OR_LACK_OF_SINCERITY;

	/**
	 * ID: 1800564<br>
	 * Message: If you want to maintain relationship connections, offer
	 * reconciliation to those who had misunderstandings with you.
	 */
	...
	/**
	 * ID: 1800566<br>
	 * Message: There may be a little loss, but think of it as an investment for
	 * yourself.
	 */
	...
	/**
	 * ID: 1800567<br>
	 * Message: Avarice bears a bigger greed, being satisfied with moderation is
	 * needed.
	 */
	...
	/**
	 * ID: 1800568<br>
	 * Message: A rational analysis is needed as unplanned actions may bring
	 * criticism.
	 */
	...
	/**
	 * ID: 1800572<br>
	 * Message: When one puts aside their ego any misunderstanding will be
	 * solved.
	 */
	...
	/**
	 * ID: 1800574<br>
	 * Message: Equilibrium is achieved when one understands a downshift is
	 * evident after the rise.
	 */
	...
	/**
	 * ID: 1800576<br>
	 * Message: Meticulous preparation is needed as spontaneous actions only
	 * bear mental and monetary losses.
	 */
	...
	/**
	 * ID: 1800577<br>
	 * Message: The right time to bear fruit is delayed while the farmer ponders
	 * opinions.
	 */
	...
	/**
	 * ID: 1800581<br>
	 * Message: Small troubles and arguments are ahead, face them with a mature
	 * attitude.
	 */
	...
	/**
	 * ID: 1800583<br>
	 * Message: Delay any dealings as you may easily omit addressing what's
	 * important to you.
	 */
	...
	/**
	 * ID: 1800586<br>
	 * Message: Try to be courteous to the opposite sex and follow a virtuous
	 * path.
	 */
	...
	/**
	 * ID: 1800589<br>
	 * Message: Be confident without hesitation when your honesty is above
	 * reproach in dealings.
	 */
	public static final NpcStringId BE_CONFIDENT_WITHOUT_HESITATION_WHEN_YOUR_HONESTY_IS_ABOVE_REPROACH_IN_DEALINGS;

	/**
	 * ID: 1800590<br>
	 * Message: A matter related to a close friend can isolate you, keep staying
	 * on the right path.
	 */
	...
	/**
	 * ID: 1800592<br>
	 * Message: Be tenacious until the finish as halfway abandonment causes a
	 * troubled ending.
	 */
	...
	/**
	 * ID: 1800594<br>
	 * Message: Refrain from stepping-up but take a moment to ponder to be
	 * flexible with situations.
	 */
	public static final NpcStringId REFRAIN_FROM_STEPPING_UP_BUT_TAKE_A_MOMENT_TO_PONDER_TO_BE_FLEXIBLE_WITH_SITUATIONS;

	/**
	 * ID: 1800595<br>
	 * Message: There will be a small opportunity when information is best
	 * utilized.
	 */
	...
	/**
	 * ID: 1800596<br>
	 * Message: Belongings are at loose ends, keep track of the things you
	 * value.
	 */
	...
	/**
	 * ID: 1800603<br>
	 * Message: Be tenacious to the end because a strong luck with winning is
	 * ahead.
	 */
	...
	/**
	 * ID: 1800604<br>
	 * Message: Be kind to and care for those close to you, they may help in the
	 * future.
	 */
	...
	/**
	 * ID: 1800608<br>
	 * Message: Be considerate to others and avoid focusing only on winning or a
	 * wound will be left untreated.
	 */
	...
	/**
	 * ID: 1800612<br>
	 * Message: Avoid advancing beyond your ability and focus on the flowing
	 * stream.
	 */
	...
	/**
	 * ID: 1800613<br>
	 * Message: Considering others with a good heart before self-interest will
	 * bring a triumph.
	 */
	...
	/**
	 * ID: 1800616<br>
	 * Message: Being high-strung can cause loss of trust from others because it
	 * can be viewed as light-hearted, act sincerely but yet do not lack humor.
	 */
	...
	/**
	 * ID: 1800618<br>
	 * Message: Abstain from laziness, much work brings many gains and
	...
	/**
	 * ID: 1800623<br>
	 * Message: Action toward the result rather than waiting for the right
	 * circumstances may lead you to a fast success.
	 */
	...
	/**
	 * ID: 1800624<br>
	 * Message: Don't try to save small expenditures, it will lead to future
	 * returns.
	 */
	...
	/**
	 * ID: 1800626<br>
	 * Message: Be warned as neglecting a matter because it's small can cause
	 * you trouble.
	 */
	...
	/**
	 * ID: 1800632<br>
	 * Message: Be observant to close friends' small behaviors while refraining
	...
	/**
	 * ID: 1800635<br>
	 * Message: The intended result may be on your way if the time is perfectly
	 * managed.
	 */
	...
	/**
	 * ID: 1800637<br>
	 * Message: Keep cool headed because carelessness or inattentiveness may
	 * cause misfortune.
	 */
	...
	/**
	 * ID: 1800638<br>
	 * Message: Be cautious as you may get hurt after last night's sinister
	 * dream.
	 */
	...
	/**
	 * ID: 1800639<br>
	 * Message: A strong wealth luck is ahead but be careful with emotions that
	 * may bring losses.
	 */
	...
	/**
	 * ID: 1800641<br>
	 * Message: You may deepen the relationship with the opposite sex through
	 * conversation.
	 */
	...
	/**
	 * ID: 1800646<br>
	 * Message: Remember to decline any financial dealings because a good deed
	 * may return as resentment.
	 */
	...
	/**
	 * ID: 1800648<br>
	 * Message: Do not be obsessive over a dragged out project since it won't
	 * get any better with more time.
	 */
	...
	/**
	 * ID: 1800650<br>
	 * Message: There's luck in relationships so become interested in the
	 * opposite sex.
	 */
	...
	/**
	 * ID: 1800651<br>
	 * Message: Seeking others' help rather than trying by yourself may result
	...
	/**
	 * ID: 1800653<br>
	 * Message: A good opportunity may come when keeping patience without
	 * excessiveness.
	 */
	...
	/**
	 * ID: 1800657<br>
	 * Message: You may reveal your true self like iron is molten into an strong
	 * sword.
	 */
	...
	/**
	 * ID: 1800659<br>
	 * Message: Tenacious efforts in solving a difficult mission or hardship may
	 * bring good results as well as realizing your hidden potential.
	 */
	...
	/**
	 * ID: 1800665<br>
	 * Message: Your goal may be realized when emotional details are well
	 * defined.
	 */
	...
	/**
	 * ID: 1800670<br>
	 * Message: Whatever happened to you and the other person will replay, but
	 * this time, the opposite will be the result.
	 */
	...
	/**
	 * ID: 1800674<br>
	 * Message: Be sophisticated without showing your true emotions as tricks
	 * and materialistic temptations lie ahead.
	 */
	...
	/**
	 * ID: 1800677<br>
	 * Message: Be confident and act tenaciously at all times. You may be able
	 * to accomplish to perfection during somewhat unstable situations.
	 */
	...
	/**
	 * ID: 1800681<br>
	 * Message: Positive thinking and energetic actions will take you to the
	 * center of the glorious stage.
	 */
	...
	/**
	 * ID: 1800683<br>
	 * Message: Everything is brilliant and joyful, share it with others. A
	 * bigger fortune will follow.
	 */
	...
	/**
	 * ID: 1800685<br>
	 * Message: Pay accurately the old liability or debt, if applicable. A new
	 * joy lies ahead.
	 */
	...
	/**
	 * ID: 1800688<br>
	 * Message: Your past fruitless effort will finally be rewarded with
	...
	/**
	 * ID: 1800689<br>
	 * Message: There's strong luck in a revival, abandon the old and create the
	 * new.
	 */
	...
	/**
	 * ID: 1800694<br>
	 * Message: Closely observe people who pass by since you may meet a precious
	...
	/**
	 * ID: 1800695<br>
	 * Message: Messenger, inform the patrons of the Keucereus Alliance Base!
	 * We're gathering brave adventurers to attack Tiat's Mounted Troop that's
	 * rooted in the Seed of Destruction.
	 */
	 ...
	 * ID: 1800696<br>
	 * Message: Messenger, inform the patrons of the Keucereus Alliance Base!
	 * The Seed of Destruction is currently secured under the flag of the
	 * Keucereus Alliance!
	 */
	 ...
	 * ID: 1800697<br>
	 * Message: Messenger, inform the patrons of the Keucereus Alliance Base!
	 * Tiat's Mounted Troop is currently trying to retake Seed of Destruction!
	 * Commit all the available reinforcements into Seed of Destruction!
	 */
	...
	/**
	 * ID: 1800698<br>
	 * Message: Messenger, inform the brothers in Kucereus' clan outpost! Brave
	 ...
	 * ID: 1800700<br>
	 * Message: Messenger, inform the patrons of the Keucereus Alliance Base!
	 * The Seed of Infinity is currently secured under the flag of the Keucereus
	 * Alliance!
	 */
	 ...
	 * ID: 1800702<br>
	 * Message: Messenger, inform the patrons of the Keucereus Alliance Base!
	 * The resurrected Undead in the Seed of Infinity are pouring into the Hall
	 * of Suffering and the Hall of Erosion!
	 */
	...
	/**
	 * ID: 1800703<br>
	 * Message: Messenger, inform the brothers in Kucereus' clan outpost! Ekimus
	 * is about to be revived by the resurrected Undead in Seed of Infinity.
	 * Send all reinforcements to the Heart and the Hall of Suffering!
	 */
	...
	/**
	 * ID: 1800708<br>
	 * Message: It's currently occupied by the enemy and our troops are
	 * attacking.
	 */
	...
	/**
	 * ID: 1800709<br>
	 * Message: It's under occupation by our forces, and I heard that Kucereus'
	 * clan is organizing the remnants.
	 */
	...
	/**
	 * ID: 1800710<br>
	 * Message: Although we currently have control of it, the enemy is pushing
	...
	/**
	 * ID: 1800711<br>
	 * Message: It's under the enemy's occupation, and the military forces of
	 * adventurers and clan members are unleashing an onslaught upon the Hall of
	...
	/**
	 * ID: 1800713<br>
	 * Message: Our forces have occupied it and are currently investigating the
	 * depths.
	 */
	...
	/**
	 * ID: 1800714<br>
	 * Message: It's under occupation by our forces, but the enemy has
	 * resurrected and is attacking toward the Hall of Suffering and the Hall of
	 * Erosion.
	 */
	...
	/**
	 * ID: 1800715<br>
	 * Message: It's under occupation by our forces, but the enemy has already
	 * overtaken the Hall of Erosion and is driving out our forces from the Hall
	 * of Suffering toward the Heart. It seems that Ekimus will revive shortly.
	 */
	...
	/**
	 * ID: 1800717<br>
	 * Message: Tiat's followers are coming to retake the Seed of Destruction!
	 * Get ready to stop the enemies!
	 */
	...
	/**
	 * ID: 1800720<br>
	 * Message: Hahahah!!! I captured Santa Claus!! There will be no gifts this
	 * year!!!
	 */
	...
	/**
	 * ID: 1800726<br>
	 * Message: I guess you came to rescue Santa. But you picked the wrong
	 * person.
	 */
	...
	/**
	 * ID: 1800737<br>
	 * Message: Santa could give nice presents only if he's released from the
	 * Turkey...
	 */
	...
	/**
	 * ID: 1800738<br>
	 * Message: Oh ho ho... Oh ho ho... Thank you. Ladies and gentlemen! I will
	 * repay you for sure.
	 */
	...
	/**
	 * ID: 1800740<br>
	 * Message: Merry Christmas~ Thank you for rescuing me from that wretched
	 * Turkey.
	 */
	...
	/**
	 * ID: 1800744<br>
	 * Message: Take a look at the inventory. Perhaps there might be a big
	 * present~
	 */
	...
	/**
	 * ID: 1800755<br>
	 * Message: You lowlifes with not even an ounce of pride! You're not worthy
	 * of opposing me!
	 */
	...
	/**
	 * ID: 1800768<br>
	 * Message: My energy is overflowing!!! I don't need any Fatigue Recovery
	 * Potion~
	 */
	...
	/**
	 * ID: 1800770<br>
	 * Message: Fortune Timer: Reward increases 2 times if completed within 10
	 * seconds!
	 */
	...
	/**
	 * ID: 1800771<br>
	 * Message: Fortune Timer: Reward increases 2 times if completed within 40
	 * seconds!
	 */
	...
	/**
	 * ID: 1800816<br>
	 * Message: Hey~. Are you planning on eating me?! Use a Cupid's Fatigue
	 * Recovery Potion already!
	 */
	public static final NpcStringId HEY_ARE_YOU_PLANNING_ON_EATING_ME_USE_A_CUPIDS_FATIGUE_RECOVERY_POTION_ALREADY;

	/**
	 * ID: 1800817<br>
	 * Message: I'll pass on an amateur's meridian massage. Use a Cupid's
	 * Fatigue Recovery Potion already!
	 */
	...
	/**
	 * ID: 1800819<br>
	 * Message: How refreshing! You wouldn't happen to be a master masseuse,
	 * $s1, would you?
	 */
	...
	/**
	 * ID: 1800820<br>
	 * Message: Incredible. From now on, I'll compare all massages to this one
	 * with $s1!
	 */
	...
	/**
	 * ID: 1800821<br>
	 * Message: Isn't it tough doing it all on your own! Next time, try making a
	...
	/**
	 * ID: 1800826<br>
	 * Message: What? You don't like it? What's the matter with you~ Like an
	 * amateur!
	 */
	...
	/**
	 * ID: 1800827<br>
	 * Message: Hey~ Did you tell a lie on April Fool's Day? Don't talk to me if
	 * you didn't~!
	 */
	...
	/**
	 * ID: 1800830<br>
	 * Message: The grave robber warrior has been filled with dark energy and is
	 * attacking you!
	 */
	 ...
	 * challenge using the power of evil shall be punished with death.
	 */
	...
	/**
	 * ID: 1800832<br>
	 * Message: Wait... Wait! Stop! Save me, and I'll give you 10,000,000
	 * adena!!
	 */
	...
	/**
	 * ID: 1800836<br>
	 * Message: I'll give you 10,000,000 adena, like I promised! I might be an
	 * orc who keeps my promises!
	 */
	public static final NpcStringId ILL_GIVE_YOU_10000000_ADENA_LIKE_I_PROMISED_I_MIGHT_BE_AN_ORC_WHO_KEEPS_MY_PROMISES;

	/**
	 * ID: 1800837<br>
	 * Message: Thanks, but that thing about 10,000,000 adena was a lie! See
	 * ya!!
	 */
	...
	/**
	 * ID: 1800843<br>
	 * Message: The evil aura of the Kasha's Eye seems to be increasing
	 * quickly!!
	 */
	...
	/**
	 * ID: 1800879<br>
	 * Message: When inventory weight/number are more than 80%, the Life Stone
	 * from the Beginning cannot be acquired.
	 */
	...
	/**
	 * ID: 1800883<br>
	 * Message: I am not that type of person who stays in one place for a long
	 * time
	 */
	...
	/**
	 * ID: 1800887<br>
	 * Message: Is that it? Is that the extent of your abilities? Put in a
	 * little more effort!!
	 */
	...
	/**
	 * ID: 1800888<br>
	 * Message: Your abilities are pitiful... You are far from a worthy
	 * opponent.
	 */
	...
	/**
	 * ID: 1800889<br>
	 * Message: Even after death you order me to wander around looking for the
	 * scapegoats!
	 */
	...
	/**
	 * ID: 1800890<br>
	 * Message: Here goes the Heatstroke! If you can withstand the hot
	 * heatstroke up to the 3rd stage, the Sultriness will come to you.
	 */
	...
	/**
	 * ID: 1800891<br>
	 * Message: Just you wait! Humidity is a blistering fireball which can
	 * easily withstand plenty of Cool Air Cannon attacks!
	 */
	...
	/**
	 * ID: 1800892<br>
	 * Message: In order to defeat Humidity, you must obtain the Headstroke
	 * Prevention Effect from Doctor Ice and fire more than 10 rounds of the
	 * Cool Air Cannon on it!
	 */
	...
	/**
	 * ID: 1800894<br>
	 * Message: That's cold! Isn't it one of those Cool Packs? I hate anything
	 * that's cold!
	 */
	...
	/**
	 * ID: 1800896<br>
	 * Message: I will give you precious things that I have stolen. So stop
	 * bothering me!
	 */
	...
	/**
	 * ID: 1800897<br>
	 * Message: I was going to give you a jackpot item. You don't have enough
	 * inventory room. See you next time.
	 */
	...
	/**
	 * ID: 1800900<br>
	 * Message: I am not here for you! Your Cool Pack attack does not work
	 * against me!
	 */
	...
	/**
	 * ID: 1800901<br>
	 * Message: Uh oh? Where are you hiding? There is nobody who matches my
	 * skills? Well, I guess I'd better get going....
	 */
	...
	/**
	 * ID: 1800902<br>
	 * Message: Why are you not responding? You don't even have any Cool Packs!
	 * You can't fight me!
	 */
	...
	/**
	 * ID: 1800912<br>
	 * Message: It's a giant watermelon if you raise it right~ And a watermelon
	 * slice if you mess up~!
	 */
	...
	/**
	 * ID: 1800929<br>
	 * Message: Hoho! It's not there! Over here~! Am I so small that you can
	 * even spray me right?
	 */
	...
	/**
	 * ID: 1800931<br>
	 * Message: Do your best~! I become a big watermelon after just five
	 * bottles~!
	 */
	...
	/**
	 * ID: 1800936<br>
	 * Message: Now! Are you trying to eat without doing the work? Fine~ Do what
	 * you want~ I'll hate you if you don't give me any nectar!
	 */
	...
	/**
	 * ID: 1800939<br>
	 * Message: Hey you~ If I die like this, there'll be no item either~ Are you
	 * really so stingy with the nectar?
	 */
	...
	/**
	 * ID: 1800943<br>
	 * Message: I'm getting stronger~? I think I'll be able to run away in 30
	 * seconds~ Hoho~
	 */
	...
	/**
	 * ID: 1800951<br>
	 * Message: Ding ding~ That's the bell. Put away your weapons and try for
	 * next time~!
	 */
	...
	/**
	 * ID: 1800954<br>
	 * Message: The instrument is nice, but there's no song. Shall I sing for
	 * you?
	 */
	...
	/**
	 * ID: 1800962<br>
	 * Message: It's this~ This! I wanted this sound! Why don't you try becoming
	 * a singer?
	 */
	...
	/**
	 * ID: 1800963<br>
	 * Message: You can try a hundred times on this~ You won't get anything
	 * good~!
	 */
	...
	/**
	 * ID: 1800966<br>
	 * Message: Not this, but you know, that~ What you got as a Chronicle
	 * souvenir. Play with that!
	 */
	...
	/**
	 * ID: 1800969<br>
	 * Message: Large watermelons only open with music~ Just striking with a
	 * weapon won't work~!
	 */
	...
	/**
	 * ID: 1800970<br>
	 * Message: Strike with music~! Not with something like this. You need
	 * music~!
	 */
	...
	/**
	 * ID: 1800995<br>
	 * Message: Grow me quick! If you're good, it's a large watermelon. If
	 * you're bad, it a watermelon slice~!
	 */
	...
	/**
	 * ID: 1800999<br>
	 * Message: You wanna eat a tiny watermelon like me? Try giving me some
	 * nectar. I'll get huge~!
	 */
	public static final NpcStringId YOU_WANNA_EAT_A_TINY_WATERMELON_LIKE_ME_TRY_GIVING_ME_SOME_NECTAR_ILL_GET_HUGE;

	/**
	 * ID: 1801000<br>
	 * Message: Hehehe... Grow me well and you'll get a reward. Grow me bad and
	...
	/**
	 * ID: 1801002<br>
	 * Message: Trust me and bring me some nectar!! I'll become a large
	 * watermelon for you~!
	 */
	...
	/**
	 * ID: 1801003<br>
	 * Message: I see. Beleth has recovered all of its magic power. What remains
	 * here is just its trace.
	 */
	...
	/**
	 * ID: 1801005<br>
	 * Message: You summoned me, so you must be confident, huh? Here I come!
	 * Jack game!
	 */
	...
	/**
	 * ID: 1801013<br>
	 * Message: That's my precious Fantastic Chocolate Banana Ultra Favor
	 * Candy!!! I'm definitely winning the next round!!
	 */
	...
	/**
	 * ID: 1801017<br>
	 * Message: You're not peeking at my card, are you? This time, I'll wager a
	 * special scroll.
	 */
	...
	/**
	 * ID: 1801018<br>
	 * Message: We're getting serious now. If you win again, I'll give you a
	 * special scroll.
	 */
	...
	/**
	 * ID: 1801021<br>
	 * Message: Who's the monster here?! This time, I'll bet my precious
	...
	/**
	 * ID: 1801022<br>
	 * Message: I lost again. I won't lose this time. I'm betting my
	 * Transformation Stick.
	 */
	...
	/**
	 * ID: 1801023<br>
	 * Message: Lost again! Hmph. Next time, I'll bet an incredible gift! Wait
	 * for it if you want!
	 */
	...
	/**
	 * ID: 1801024<br>
	 * Message: You're too good. Next time, I'll give you an incredible gift!
	 * Please wait for you.
	 */
	...
	/**
	 * ID: 1801033<br>
	 * Message: This is the highest record in my life! Next time, I'll give you
	 * my treasure -- the Golden Jack O'Lantern!
	 */
	...
	/**
	 * ID: 1801034<br>
	 * Message: Even pros can't do 14 wins...! Next time, I will give you my
	 * treasure, the Golden Jack O'Lantern.
	 */
	public static final NpcStringId EVEN_PROS_CANT_DO_14_WINS_NEXT_TIME_I_WILL_GIVE_YOU_MY_TREASURE_THE_GOLDEN_JACK_OLANTERN;

	/**
	 * ID: 1801035<br>
	 * Message: I can't do this anymore! You win! I acknowledge you as the best
	 * I've ever met in all my 583 years!
	 */
	...
	/**
	 * ID: 1801041<br>
	 * Message: You wanna play some more? I'm out of presents, but I'll give you
	 * candy!
	 */
	...
	/**
	 * ID: 1801042<br>
	 * Message: Will you play some more? I don't have any more presents, but I
	 * will give you candy if you win.
	 */
	...
	/**
	 * ID: 1801043<br>
	 * Message: You're the best. Out of all the Jack's game players I've ever
	 * met... I give up!
	 */
	...
	/**
	 * ID: 1801044<br>
	 * Message: Wowww. Awesome. Really. I have never met someone as good as you
	 * before. Now... I can't play anymore.
	 */
	...
	/**
	 * ID: 1801048<br>
	 * Message: Hello~! I'm Belldandy. Congratulations on winning 1st place in
	 * Jack's game... If you go and find my sibling Skooldie in the village,
	 * you'll get an amazing gift! Let's play Jack's game again!
	 */
	...
	/**
	 * ID: 1801049<br>
	 * Message: Hmm. You're playing Jack's game for the first time, huh? You
	 * couldn't even take out your card at the right time~! My goodness...
	 */
	...
	/**
	 * ID: 1801050<br>
	 * Message: Oh. You're not very familiar with Jack's game, right? You didn't
	 * take out your card at the right time...
	 */
	...
	/**
	 * ID: 1801051<br>
	 * Message: You have to use the card skill on the mask before the gauge
	 * above my head disappears.
	 */
	public static final NpcStringId YOU_HAVE_TO_USE_THE_CARD_SKILL_ON_THE_MASK_BEFORE_THE_GAUGE_ABOVE_MY_HEAD_DISAPPEARS;

	/**
	 * ID: 1801052<br>
	 * Message: You must use the card skill on the mask before the gauge above
	 * my head disappears.
	 */
	...
	/**
	 * ID: 1801053<br>
	 * Message: If you show the same card as me, you win. If they're different,
	 * I win. Understand? Now, let's go!
	 */
	public static final NpcStringId IF_YOU_SHOW_THE_SAME_CARD_AS_ME_YOU_WIN_IF_THEYRE_DIFFERENT_I_WIN_UNDERSTAND_NOW_LETS_GO;

	/**
	 * ID: 1801054<br>
	 * Message: You will win if you show the same card as me. It's my victory if
	 * the cards are different. Well, let's start again~
	 */
	...
	/**
	 * ID: 1801055<br>
	 * Message: Ack! You didn't show a card? You have to use the card skill
	 * before the gauge disappears. Hmph. Then, I'm going.
	 */
	...
	/**
	 * ID: 1801056<br>
	 * Message: Ahh. You didn't show a card. You must use the card skill at the
	 * right time. It's unfortunate. Then, I will go now~
	 */
	...
	/**
	 * ID: 1801057<br>
	 * Message: Let's learn about the Jack's game together~! You can play with
	 * me 3 times.
	 */
	...
	/**
	 * ID: 1801058<br>
	 * Message: Let's start! Show the card you want! The card skill is attached
	 * to the mask.
	 */
	...
	/**
	 * ID: 1801063<br>
	 * Message: You gotta show the card at the right time. Use the card skill
	 * you want before the gauge above my head disappears!
	 */
	...
	/**
	 * ID: 1801064<br>
	 * Message: The card skills are attached to the Jack O'Lantern mask, right?
	 * That's what you use.
	 */
	...
	/**
	 * ID: 1801065<br>
	 * Message: You win if you show the same card as me, and I win if the cards
	 * are different. OK, let's go~
	 */
	public static final NpcStringId YOU_WIN_IF_YOU_SHOW_THE_SAME_CARD_AS_ME_AND_I_WIN_IF_THE_CARDS_ARE_DIFFERENT_OK_LETS_GO;

	/**
	 * ID: 1801066<br>
	 * Message: You didn't show a card again? We'll try again later. I'm gonna
	 * go now~
	 */
	...
	/**
	 * ID: 1801067<br>
	 * Message: Now, do you understand a little about Jack's game? The real
	 * game's with Uldie and Belldandy. Well, see you later!
	 */
	...
	/**
	 * ID: 1801071<br>
	 * Message: Annoying concentration attacks are disrupting Valakas's
	...
	/**
	 * ID: 1801072<br>
	 * Message: Some warrior's blow has left a huge gash between the great
	...
	/**
	 * ID: 1801073<br>
	 * Message: Annoying concentration attacks overwhelmed Valakas, making it
	 * forget its rage and become distracted!
	 */
	 ...
	 * continue, it may become a dangerous situation!
	 */
	...
	/**
	 * ID: 1801075<br>
	 * Message: Because the cowardly counterattacks continued, Valakas's fury
	...
	/**
	 * ID: 1801076<br>
	 * Message: Valakas has been enraged by the long-range concentration attacks
	 * and is coming toward its target with even greater zeal!
	 */
	...
	/**
	 * ID: 1801077<br>
	 * Message: Listen, oh Tantas! I have returned! The Prophet Yugoros of the
	 * Black Abyss is with me, so do not be afraid!
	 */
	...
	/**
	 * ID: 1801078<br>
	 * Message: Welcome, $s1! Let us see if you have brought a worthy offering
	 * for the Black Abyss!
	 */
	...
	/**
	 * ID: 1801079<br>
	 * Message: What a formidable foe! But I have the Abyss Weed given to me by
	 * the Black Abyss! Let me see...
	 */
	...
	/**
	 * ID: 1801080<br>
	 * Message: Muhahaha! Ah, this burning sensation in my mouth! The power of
	 * the Black Abyss is reviving me!
	 */
	...
	/**
	 * ID: 1801081<br>
	 * Message: No! How dare you stop me from using the Abyss Weed... Do you
	...
	/**
	 * ID: 1801082<br>
	 * Message: A limp creature like this is unworthy to be an offering... You
	 * have no right to sacrifice to the Black Abyss!
	 */
	...
	/**
	 * ID: 1801083<br>
	 * Message: Listen, oh Tantas! The Black Abyss is famished! Find some fresh
	 * offerings!
	 */
	...
	/**
	 * ID: 1801091<br>
	 * Message: The beast ate the feed, but it isn't showing a response, perhaps
	...
	/**
	 * ID: 1801099<br>
	 * Message: I can finally take a breather. By the way, who are you? Hmm... I
	 * think I know who sent you.
	 */
	...
	/**
	 * ID: 1801154<br>
	 * Message: The plasmas have filled the aeroscope but they are ramming into
	 * each other, exploding, and dying.
	 */
	...
	/**
	 * ID: 1801155<br>
	 * Message: Amazing. $s1 took 100 of these soul stone fragments. What a
	 * complete swindler.
	 */
	...
	/**
	 * ID: 1801160<br>
	 * Message: Ah... It's over. What kind of guy is that? Damn... Fine, you
	 * $s1, take it and get outta here.
	 */
	public static final NpcStringId AH_ITS_OVER_WHAT_KIND_OF_GUY_IS_THAT_DAMN_FINE_YOU_S1_TAKE_IT_AND_GET_OUTTA_HERE;

	/**
	 * ID: 1801161<br>
	 * Message: A big piece is made up of little pieces. So here's a little
	 * piece~
	 */
	...
	/**
	 * ID: 1801163<br>
	 * Message: OK~ Who's next? It all depends on your fate and luck, right? At
	 * least come and take a look.
	 */
	...
	/**
	 * ID: 1801165<br>
	 * Message: There was someone who won 10,000 from me. A warrior shouldn't
	 * just be good at fighting, right? You've gotta be good in everything.
	 */
	...
	/**
	 * ID: 1801166<br>
	 * Message: OK~ Master of luck? That's you? Haha~! Well, anyone can come
	 * after all.
	 */
	...
	/**
	 * ID: 1801167<br>
	 * Message: Shedding blood is a given on the battlefield. At least it's safe
	 * here.
	 */
	...
	/**
	 * ID: 1801170<br>
	 * Message: Is Ermian well? Even I can't believe that I survived in a place
	 * like this...
	 */
	...
	/**
	 * ID: 1801171<br>
	 * Message: I don't know how long it's been since I parted company with
	 * you... Time doesn't seem to move... It just feels too long...
	 */
	...
	/**
	 * ID: 1801172<br>
	 * Message: Sorry to say this, but... The place you struck me before now
	 * hurts greatly...
	 */
	...
	/**
	 * ID: 1801173<br>
	 * Message: Ugh... I'm sorry... It looks like this is it for me... I wanted
	 * to live and see my family...
	 */
	...
	/**
	 * ID: 1801189<br>
	 * Message: Magic power so strong that it could make you lose your mind can
	 * be felt from somewhere!!
	 */
	public static final NpcStringId MAGIC_POWER_SO_STRONG_THAT_IT_COULD_MAKE_YOU_LOSE_YOUR_MIND_CAN_BE_FELT_FROM_SOMEWHERE;

	/**
	 * ID: 1801190<br>
	 * Message: Even though you bring something called a gift among your humans,
	 * it would just be problematic for me...
	 */
	...
	/**
	 * ID: 1801191<br>
	 * Message: I just don't know what expression I should have it appeared on
	 * me. Are human's emotions like this feeling?
	 */
	...
	/**
	 * ID: 1801194<br>
	 * Message: I am Ice Queen Freya... This feeling and emotion are nothing but
	 * a part of Melissa'a memories.
	 */
	...
	/**
	 * ID: 1801195<br>
	 * Message: Dear $s1... Think of this as my appreciation for the gift. Take
	...
	/**
	 * ID: 1801196<br>
	 * Message: The kindness of somebody is not a bad feeling... Dear $s1, I
	 * will take this gift out of respect your kindness.
	 */
	...
	/**
	 * ID: 1811137<br>
	 * Message: Who's there? If you disturb the temper of the great Land Dragon
	...
	/**
	 * ID: 1900000<br>
	 * Message: Kehahaha!!! I captured Santa Claus!! There will be no gifts this
	 * year!!!
	 */
	...
	/**
	 * ID: 1900017<br>
	 * Message: Santa can give nice presents only if he's released from the
	 * Turkey...
	 */
	...
	/**
	 * ID: 1900018<br>
	 * Message: Oh ho ho... Oh ho ho... Thank you. Everyone! I will repay you
	 * for sure.
	 */
	...
	/**
	 * ID: 1900024<br>
	 * Message: Take a look at the inventory. Perhaps there will be a big
	 * present~
	 */
	...
	/**
	 * ID: 1900037<br>
	 * Message: It's different from the spirit of fire. It's not the spirit of
	 * fire! Feel my wrath!
	 */
	...
	/**
	 * ID: 1900070<br>
	 * Message: Even pros can't do 14 wins in a row...! Next time, I'll give you
	 * my treasure, the Golden Jack O'Lantern.
	 */
	...
	/**
	 * ID: 1900071<br>
	 * Message: I can't do this anymore! You win! In all my 583 years, you're
	...
	/**
	 * ID: 1900084<br>
	 * Message: Hello~! I'm Belldandy. Congratulations on getting 1st place in
	 * Jack's game. If you go and find my sibling Skooldie in the village,
	 * you'll get an amazing gift! Let's play Jack's game again!
	 */
	...
	/**
	 * ID: 1900105<br>
	 * Message: Ah, I'm hungry. Do you have any baby food? That's what I need to
	 * eat to get bigger.
	 */
	...
	/**
	 * ID: 1900112<br>
	 * Message: Please pet me lovingly. You can use the "Hand of Warmth" skill
	...
	/**
	 * ID: 1900115<br>
	 * Message: Oh, yummy! If I keep eating this, I think I can grow up all the
	 * way.
	 */
	...
	/**
	 * ID: 1900122<br>
	 * Message: %s. Thank you for taking care of me all this time. I enjoyed it
	 * very much.
	 */
	...
	/**
	 * ID: 1900123<br>
	 * Message: %s. It won't be long now until it becomes time to pull the sled.
	 * It's too bad.
	 */
	...
	/**
	 * ID: 1900125<br>
	 * Message: Hello. I'm a girl Rudolph. I was able to find my true self
	 * thanks to you.
	 */
	...
	/**
	 * ID: 1900131<br>
	 * Message: Hahaha!!! I captured Santa Claus!! Huh? Where is this? Who are
	 * you?
	 */
	...
	/**
	 * ID: 1900132<br>
	 * Message: ...I lost at Rock Paper Scissors and was taken captive... I
	 * might as well take out my anger on you! Huh~ What?
	 */
	...
	/**
	 * ID: 1900133<br>
	 * Message: Nothing's working... I'm leaving! I'll definitely capture Santa
	 * again! Just you wait!
	 */
	...
	/**
	 * ID: 1900134<br>
	 * Message: I must raise Rudolph quickly. This year's Christmas gifts have
	 * to be delivered...
	 */
	...
	/**
	 * ID: 1900135<br>
	 * Message: Merry Christmas~ Thanks to your efforts in raising Rudolph, the
	 * gift delivery was a success.
	 */
	...
	/**
	 * ID: 1900137<br>
	 * Message: After 5 minutes, if my Full Feeling and Affection Level reach
	...
	/**
	 * ID: 1900148<br>
	 * Message: Oh! My wings disappeared! Are you gonna hit me? If you hit me,
	 * I'll throw up everything that I ate!
	 */
	...
	/**
	 * ID: 1900149<br>
	 * Message: Oh! My wings... Ack! Are you gonna hit me?! Scary, scary! If you
	 * hit me, something bad will happen!
	 */
	...
	/**
	 * ID: 1900152<br>
	 * Message: To serve him now means you will be able to escape a worse
	 * situation.
	 */
	...
	/**
	 * ID: 1900154<br>
	 * Message: When the sky turns blood red and the earth begins to crumble
	 * from the darkness she will return.
	 */
	...
	/**
	 * ID: 1900172<br>
	 * Message: Show respect to the heroes who defeated the evil dragon and
	 * protected this Aden world!
	 */
	...
	/**
	 * ID: 1900174<br>
	 * Message: Praise the achievement of the heroes and receive Nevit's
	 * blessing!
	 */
	...
	/**
	 * ID: 1911111<br>
	 * Message: You will soon become the sacrifice for us, those full of deceit
	 * and sin whom you despise!
	 */
	public static final NpcStringId YOU_WILL_SOON_BECOME_THE_SACRIFICE_FOR_US_THOSE_FULL_OF_DECEIT_AND_SIN_WHOM_YOU_DESPISE;

	/**
	 * ID: 1911112<br>
	 * Message: My brethren who are stronger than me will punish you. You will
	 * soon be covered in your own blood and crying in anguish!
	 */
	...
	/**
	 * ID: 1911115<br>
	 * Message: No matter how you struggle this place will soon be covered with
	 * your blood.
	 */
	...
	/**
	 * ID: 1911117<br>
	 * Message: Worthless creatures, I will grant you eternal sleep in fire and
	 * brimstone.
	 */
	...
	/**
	 * ID: 10004431<br>
	 * Message: It teleports the guard members of the Aden Imperial Castle to
	...
	/**
	 * ID: 10004432<br>
	 * Message: It teleports the guard members of the Gludio Castle to the
	...
	/**
	 * ID: 10004433<br>
	 * Message: It teleports the guard members of the Dion Castle to the inside
	 * of the castle.
	 */
	...
	/**
	 * ID: 10004434<br>
	 * Message: It teleports the guard members of the Giran Castle to the inside
	 * of the castle.
	 */
	...
	/**
	 * ID: 10004436<br>
	 * Message: It teleports the guard members of the Aden Castle to the inside
	 * of the castle.
	 */
	...
	/**
	 * ID: 10004437<br>
	 * Message: It teleports the guard members of the Innadril Castle to the
	 * inside of the castle.
	 */
	...
	/**
	 * ID: 10004438<br>
	 * Message: It teleports the guard members of the Goddard Castle to the
	 * inside of the castle.
	 */
	...
	/**
	 * ID: 10004439<br>
	 * Message: It teleports the guard members of the Rune Castle to the inside
	 * of the castle.
	 */
	...
	/**
	 * ID: 10004440<br>
	 * Message: It teleports the guard members of the Schuttgart Castle to the
	 * inside of the castle.
	 */
	...
	/**
	 * ID: 10004441<br>
	 * Message: It teleports the guard members of the Elmore Imperial Castle to
	 * the inside of the castle.
	 */
	 ...
	 * Important: Always initialize with a length of the highest NpcStringId +
	 * 1!!!
	 */
	...
	static
	{
		...
		MATCH_BEGINS_IN_S1_MINUTES = new NpcStringId(1800080);
		...
		IM_STILL_HUNGRY_ = new NpcStringId(1800288);
