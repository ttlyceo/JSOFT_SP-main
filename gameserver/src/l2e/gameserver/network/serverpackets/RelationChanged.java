...
public final class RelationChanged extends GameServerPacket
{
	...
	public static GameServerPacket update(Player sendTo, Playable targetPlayable, Player activeChar)
	{
		...
		final Player targetPlayer = targetPlayable.getActingPlayer();
		...
		pkt.add(new RelationChangedData(targetPlayable, targetPlayable.isAutoAttackable(activeChar, false), relation));
		return pkt;
	}
}