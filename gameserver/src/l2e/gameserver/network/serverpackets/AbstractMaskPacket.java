...
import l2e.gameserver.network.serverpackets.updatetype.IUpdateTypeComponent;

public abstract class AbstractMaskPacket<T extends IUpdateTypeComponent> extends GameServerPacket
{
