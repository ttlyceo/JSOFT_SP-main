...
public final class SystemMessageId
{
	 ...
	 * change the time after a siege time has been declared. Do you want to
	 * continue?
	 */
	...
	/**
	 * ID: 730<br>
	 * Message: You have submitted $s1 petition(s). - You may submit $s2 more
	 * petition(s) today.
	 */
	...
	/**
	 * ID: 1291<br>
	 * Message: Although the seal was owned during the previous period, less
	 * than 10% of people have voted.
	 */
	...
	/**
	 * ID: 1519<br>
	 * Message: The pet has been killed. If you don't resurrect it within 24
	 * hours, the pet's body will disappear along with all the pet's items.
	 */
	...
	/**
	 * ID: 1641<br>
	 * Message: Sharpen your swords, tighten the stitching in your armor, and
	...
	/**
	 * ID: 1717<br>
	 * Message: Siege War Zone - A siege is currently in progress in this area.
	 * If a character dies in this zone, their resurrection ability may be
	 * restricted.
	 */
	...
	/**
	 * ID: 1719<br>
	 * Message: Seven Signs Zone - Although a character's level may increase
	 * while in this area, HP and MP will not be regenerated.
	 */
	 ...
	 * your cell phone to get the NCOTP password and enter it within 1 minute.
	 * If you have not requested NCOTP, leave this field blank and click the
	 * Login button.
	 */
	 ...
	 * cell phone payment agreement. Please submit proof of payment by fax
	 ...
	 * don't apply now, it will be applied when you start the game next time.
	 * Will you apply now?
	 */
	...
	/**
	 * ID: 2211<br>
	 * Message: You must learn the Onyx Beast skill before you can acquire
	 * further skills.
	 */
	...
	/**
	 * ID: 2243<br>
	 * Message: During the Bandit Stronghold or Wild Beast Reserve clan hall
	 * war, the previous clan lord rather than the new clan lord participates in
	 * battle.
	 */
	 ...
	 * seconds.
	 */
	public static final SystemMessageId RESURRECTION_WILL_TAKE_PLACE_IN_THE_WAITING_ROOM_AFTER_S1_SECONDS;
	...
	/**
	 * ID: 2372<br>
	 * Message: There is not much time remaining until the hunting helper pet
	 * leaves.
	 */
	...
	/**
	 * ID: 2375<br>
	 * Message: The hunting helper pet cannot be returned ecause there is not
	 * much time remaining until it leaves.
	 */
	...
	/**
	 * ID: 2379<br>
	 * Message: You cannot report a character who has not acquired any Exp.
	 * after connecting
	 */
	 ...
	 */
	public static final SystemMessageId A_PARTY_CANNOT_BE_FORMED_IN_THIS_AREA;
	 ...
	 * the $s3 territory.
	 */
	public static final SystemMessageId CLAN_LORD_C2_WHO_LEADS_CLAN_S1_HAS_BEEN_DECLARED_THE_LORD_OF_THE_S3_TERRITORY;
	...
	/**
	 * ID: 2413<br>
	 * Message: You are registering as a reserve for the Red Team. Do you wish
	 * to continue?
	 */
	public static final SystemMessageId YOU_ARE_REGISTERING_AS_A_RESERVE_FOR_THE_RED_TEAM;
	
	/**
	 * ID: 2414<br>
	 * Message: You are registering as a reserve for the Blue Team. Do you wish
	 * to continue?
	 */
	public static final SystemMessageId YOU_ARE_REGISTERING_AS_A_RESERVE_FOR_THE_BLUE_TEAM;
	
	/**
	 * ID: 2415<br>
	 * Message: You have registered as a reserve for the Red Team. When in
	 * battle, the team can change its composition using the Maintain Team
	 * Balance function.
	 */
	public static final SystemMessageId YOU_HAVE_REGISTERED_AS_A_RESERVE_FOR_THE_RED_TEAM;
	
	/**
	 * ID: 2416<br>
	 * Message: You have registered as a reserve for the Blue Team. When in
	 * battle, the team can change its composition using the Maintain Team
	 * Balance function.
	 */
	public static final SystemMessageId YOU_HAVE_REGISTERED_AS_A_RESERVE_FOR_THE_BLUE_TEAM;
	
	/**
	 * ID: 2417<br>
	 * Message: You are canceling your Aerial Cleft registration. Do you wish to
	 * continue?
	 */
	public static final SystemMessageId YOU_ARE_CANCELING_YOUR_AERIAL_CLEFT_REGISTRATION;
	
	/**
	 * ID: 2418<br>
	 * Message: The Aerial Cleft registration has been canceled.
	 */
	public static final SystemMessageId THE_AERIAL_CLEFT_REGISTRATION_HAS_BEEN_CANCELED;
	
	/**
	 * ID: 2419<br>
	 * Message: The Aerial Cleft has been activated. Flight transformation will
	 * be possible in approximately 40 seconds.
	 */
	public static final SystemMessageId THE_AERIAL_CLEFT_HAS_BEEN_ACTIVATED;
	
	/**
	 * ID: 2420<br>
	 * Message: The battlefield closes in 1 minute.
	 */
	public static final SystemMessageId THE_BATTLEFIELD_CLOSES_IN_1_MINUTE;
	
	/**
	 * ID: 2421<br>
	 * Message: The battlefield closes in 10 seconds.
	 */
	public static final SystemMessageId THE_BATTLEFIELD_CLOSES_IN_10_SECONDS;
	...
	/**
	 * ID: 2468<br>
	 * Message: You have used a report point on $c1. You have $s2 points
	...
	/**
	 * ID: 2470<br>
	 * Message: This character cannot make a report. You cannot make a report
	 * while located inside a peace zone or a battlefield, while you are an
	 * opposing clan member during a clan war, or while participating in the
	 * Olympiad
	 */
	 ...
	 * reported by either your clan or alliance, or has already been reported
	...
	/**
	 * ID: 2472<br>
	 * Message: This character cannot make a report because another character
	...
	/**
	 * ID: 2473<br>
	 * Message: You have been reported as an illegal program user, so your
	 * chatting will be blocked for 10 minutes
	 */
	 ...
	 * ID: 2475<br>
	 * Message: You have been reported as an illegal program user, so your party
	 * participation will be blocked for 120 minutes
	 */
	 ...
	 * ID: 2476<br>
	 * Message: You have been reported as an illegal program user, so your party
	 * participation will be blocked for 180 minutes
	 */
	 ...
	 * ID: 2477<br>
	 * Message: You have been reported as an illegal program user, so your
	 * actions will be restricted for 120 minutes
	 */
	 ...
	 * ID: 2478<br>
	 * Message: You have been reported as an illegal program user, so your
	 * actions will be restricted for 180 minutes
	 */
	...
	/**
	 * ID: 2480<br>
	 * Message: You have been reported as an illegal program user, so movement
	 * is prohibited for 120 minutes
	 */
	public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_120_MIN_MOVEMENT_BLOCKED;

	/**
	 * ID: 2481<br>
	 * Message: $c1 has been reported as an illegal program user and is
	...
	/**
	 * ID: 2482<br>
	 * Message: $c1 has been reported as an illegal program user and cannot join
	 * a party
	 */
	...
	/**
	 * ID: 2483<br>
	 * Message: You have been reported as an illegal program user, so chatting
	 * is not allowed
	 */
	...
	/**
	 * ID: 2484<br>
	 * Message: You have been reported as an illegal program user, so
	 ...
	 * ID: 2485<br>
	 * Message: You have been reported as an illegal program user so your
	 * actions have been restricted
	 */
	public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_SO_ACTIONS_NOT_ALLOWED;

	/**
	 * ID: 2486<br>
	 * Message: You have been blocked due to verification that you are using a
	 * third party program. Subsequent violations may result in termination of
	 * your account rather than a penalty within the game
	 */
	public static final SystemMessageId YOU_HAVE_BEEN_BLOCKED_SUBSEQUENT_VIOLATIONS_RESULT_ACCOUNT_TERMINATION;

	/**
	 * ID: 2487<br>
	 * Message: You have been reported as an illegal program user, and your
	 * connection has been ended. Please contact our CS team to confirm your
	 * identity.
	 */
	...
	/**
	 * ID: 2748<br>
	 * Message: You have been reported as an illegal program user and cannot
	 * report other users
	 */
	 ...
	 */
	public static final SystemMessageId YOU_CANNOT_BE_SIMULTANEOUSLY_REGISTERED_FOR_PVP_MATCHES_SUCH_AS_THE_OLYMPIAD_UNDERGROUND_COLISEUM_AERIAL_CLEFT_KRATEIS_CUBE_AND_HANDYS_BLOCK_CHECKERS;
	...
	/**
	 * ID: 2764<br>
	 * Message: You cannot enter because the corresponding alliance channel's
	...
	/**
	 * ID: 2775<BR>
	 * Console Message: The match cannot take place because a party member is in
	 * the process of boarding.
	 */
	public static final SystemMessageId MATCH_CANT_START_PARTY_MEMBER_BOARDING;

	/**
	 * ID: 2776<BR>
	 * Console Message: The effect of territory ward is disappearing.
	 */
	public static final SystemMessageId WARD_EFFECT_DISSAPPEARING;

	/**
	 * ID: 2774<br>
	 * Message: You can make another report in $s1-minute(s). You have $s2
	...
	/**
	 * ID: 2389<br>
	 * Message: The maximum accumulation allowed of PC cafe points has been
	 ...
	 * 28.
	 */
	public static final SystemMessageId A_CHARACTER_BORN_ON_FEBRUARY_29_WILL_RECEIVE_A_GIFT_ON_FEBRUARY_28;
	...
	/**
	 * ID: 2993<br>
	 * Message: If the Command Channel leader leaves the party matching room,
	 * then the sessions ends. Do you really wish to exit the room?
	 */
	public static final SystemMessageId IF_THE_COMMAND_CHANNEL_LEADER_LEAVES_THE_PARTY_MATCHING_ROOM_THEN_THE_SESSIONS_ENDS_DO_YOU_REALLY_WISH_TO_EXIT_THE_ROOM;

	/**
	 * ID: 2994<br>
	 * Message: The Command Channel matching room was cancelled.
	 */
	public static final SystemMessageId THE_COMMAND_CHANNEL_MATCHING_ROOM_WAS_CANCELLED;

	/**
	 * ID: 2995<br>
	 * Message: This Command Channel matching room is already cancelled.
	 */
	public static final SystemMessageId THIS_COMMAND_CHANNEL_MATCHING_ROOM_IS_ALREADY_CANCELLED;
	 ...
	 */
	public static final SystemMessageId YOU_CANNOT_ENTER_THE_COMMAND_CHANNEL_MATCHING_ROOM_BECAUSE_YOU_DO_NOT_MEET_THE_REQUIREMENTS;

	/**
	 * ID: 2997<br>
	 * Message: You exited from the Command Channel matching room.
	 */
	public static final SystemMessageId YOU_EXITED_FROM_THE_COMMAND_CHANNEL_MATCHING_ROOM;

	/**
	 * ID: 2998<br>
	 * Message: You were expelled from the Command Channel matching room.
	 */
	public static final SystemMessageId YOU_WERE_EXPELLED_FROM_THE_COMMAND_CHANNEL_MATCHING_ROOM;
	 ...
	 * the matching screen.
	 */
	public static final SystemMessageId THE_COMMAND_CHANNEL_AFFILIATED_PARTY_S_PARTY_MEMBER_CANNOT_USE_THE_MATCHING_SCREEN;

	/**
	 * ID: 3000<br>
	 * Message: The Command Channel matching room was created.
	 */
	public static final SystemMessageId THE_COMMAND_CHANNEL_MATCHING_ROOM_WAS_CREATED;

	/**
	 * ID: 3001<br>
	 * Message: The Command Channel matching room information was edited.
	 */
	public static final SystemMessageId THE_COMMAND_CHANNEL_MATCHING_ROOM_INFORMATION_WAS_EDITED;
	 ...
	 */
	public static final SystemMessageId C1_ENTERED_THE_COMMAND_CHANNEL_MATCHING_ROOM;

	/**
	 * ID: 3007<br>
	 * Message: Stakato's nest is filled with crying angered Shyeed.
	 */
	public static final SystemMessageId SHYEED_S_ROAR_FILLED_WITH_WRATH_RINGS_THROUGHOUT_THE_STAKATO_NEST;
	/**
	 * ID: 3008<br>
	...
	/**
	 * ID: 3031<br>
	 * Message: By using the skill of Einhasad's holy sword, defeat the evil
	 * Lilims!
	 */
	...
	/**
	 * ID: 3039<br>
	 * Message: By using the holy water of Einhasad, open the door possessed by
	 * the curse of flames.
	 */
	...
	/**
	 * ID: 3040<br>
	 * Message: By using the Court Magician's Magic Staff, open the door on
	 * which the magician's barrier is placed.
	 */
	...
	/**
	 * ID: 3060<br>
	 * Message: The sealing device glitters and moves. Activation complete
	 * normally!
	 */
	...
	/**
	 * ID: 3122<br>
	 * Message: The size of the uploaded crest or insignia does not meet the
	...
	/**
	 * ID: 3123<br>
	 * Message: $c1 is in Private Shop mode or in a battle and cannot be
	...
	/**
	 * ID: 3128<br>
	 * Message: $c1 is participating in the Olympiad and cannot be requested for
	 * a couple action.
	 */
	...
	/**
	 * ID: 3129<br>
	 * Message: $c1 is participating in a hideout siege and cannot be requested
	 * for a couple action.
	 */
	...
	/**
	 * ID: 3130<br>
	 * Message: $c1 is in a castle siege and cannot be requested for a couple
	 * action.
	 */
	...
	/**
	 * ID: 3131<br>
	 * Message: $c1 is riding a ship, steed, or strider and cannot be requested
	 * for a couple action.
	 */
	...
	/**
	 * ID: 3132<br>
	 * Message: $c1 is currently teleporting and cannot be requested for a
	 * couple action.
	 */
	...
	/**
	 * ID: 3133<br>
	 * Message: $c1 is currently transforming and cannot be requested for a
	 * couple action.
	 */
	...
	/**
	 * ID: 3139<br>
	 * Message: $c1 is currently dead and cannot be requested for a couple
	 * action.
	 */
	...
	/**
	 * ID: 3144<br>
	 * Message: The $s2's attribute was successfully bestowed on $s1, and
	 * resistance to $s3 was increased.
	 */
	public static final SystemMessageId THE_S2_ATTRIBUTE_WAS_SUCCESSFULLY_BESTOWED_ON_S1_RES_TO_S3_INCREASED;

	/**
	 * ID: 3147<br>
	 * Message: If you are not resurrected within $s1 minutes, you will be
	 * expelled from the instant zone.
	 */
	...
	/**
	 * ID: 3152<br>
	 * Message: $s1's $s2 attribute was removed, and resistance to $s3 was
	 * decreased.
	 */
	...
	/**
	 * ID: 3160<br>
	 * Message: +$s1$s2's $s3 attribute was removed, so resistance to $s4 was
	 * decreased.
	 */
	...
	/**
	 * ID: 3163<br>
	 * Message: The $s3's attribute was successfully bestowed on +$s1$s2, and
	 * resistance to $s4 was increased.
	 */
	 ...
	 */
	public static final SystemMessageId WHEN_YOUR_PET_S_HUNGER_GAUGE_IS_AT_0_YOU_CANNOT_USE_YOUR_PET;
	
	/**
	 * ID: 3213<br>
	 * Message: Your pet is starving and will not obey until it gets it's food.
	 * Feed your pet!
	 */
	...
	/**
	 * ID: 3260<br>
	 * Message: You cannot use the skill because the servitor has not been
	 * summoned.
	 */
	...
	/**
	 * ID: 6004<br>
	 * Message: Enchant failed. The enchant level for the corresponding item
	 * will be exactly retained.
	 */
	 ...
	 * met.
	 */
	public static final SystemMessageId THE_SKILL_HAS_BEEN_CANCELED_BECAUSE_YOU_HAVE_INSUFFICIENT_ENERGY;
	 ...
	 * met.
	 */
	public static final SystemMessageId YOUR_ENERGY_CANNOT_BE_REPLENISHED_BECAUSE_CONDITIONS_ARE_NOT_MET;
	
	/**
	 * ID: 6044<br>
	 * Message: Energy $s1 replenished.
	 */
	public static final SystemMessageId ENERGY_S1_REPLENISHED;
	
	/**
	 * ID: 6046<br>
	 * Message: The premium item for this account was aprovied
	 */
	public static final SystemMessageId THE_PREMIUM_ITEM_FOR_THIS_ACCOUNT_WAS_PROVIDED;
	
	/**
	 * ID: 6047<br>
	 * Message: The premium item cannot be received because the inventory
	 * weightquality mit has been exceeded
	 */
	public static final SystemMessageId THE_PREMIUM_ITEM_CANNOT_BE_RECEIVED_BECAUSE_THE_INVENTORY_WEIGHTQUANTITY_LIMIT_HAS_BEEN_EXCEEDED;
	
	/**
	 * ID: 6048<br>
	 * Message: The premium account has been terminated
	 */
	public static final SystemMessageId THE_PREMIUM_ACCOUNT_HAS_BEEN_TERMINATED;
	...
	static
	{
		...
		RESURRECTION_WILL_TAKE_PLACE_IN_THE_WAITING_ROOM_AFTER_S1_SECONDS = new SystemMessageId(2370);
		...
		A_PARTY_CANNOT_BE_FORMED_IN_THIS_AREA = new SystemMessageId(2388);
		...
		CLAN_LORD_C2_WHO_LEADS_CLAN_S1_HAS_BEEN_DECLARED_THE_LORD_OF_THE_S3_TERRITORY = new SystemMessageId(2401);
		...
		YOU_ARE_REGISTERING_AS_A_RESERVE_FOR_THE_RED_TEAM = new SystemMessageId(2413);
		YOU_ARE_REGISTERING_AS_A_RESERVE_FOR_THE_BLUE_TEAM = new SystemMessageId(2414);
		YOU_HAVE_REGISTERED_AS_A_RESERVE_FOR_THE_RED_TEAM = new SystemMessageId(2415);
		YOU_HAVE_REGISTERED_AS_A_RESERVE_FOR_THE_BLUE_TEAM = new SystemMessageId(2416);
		YOU_ARE_CANCELING_YOUR_AERIAL_CLEFT_REGISTRATION = new SystemMessageId(2417);
		THE_AERIAL_CLEFT_REGISTRATION_HAS_BEEN_CANCELED = new SystemMessageId(2418);
		THE_AERIAL_CLEFT_HAS_BEEN_ACTIVATED = new SystemMessageId(2419);
		THE_BATTLEFIELD_CLOSES_IN_1_MINUTE = new SystemMessageId(2420);
		THE_BATTLEFIELD_CLOSES_IN_10_SECONDS = new SystemMessageId(2421);
		...
		YOU_CANNOT_BE_SIMULTANEOUSLY_REGISTERED_FOR_PVP_MATCHES_SUCH_AS_THE_OLYMPIAD_UNDERGROUND_COLISEUM_AERIAL_CLEFT_KRATEIS_CUBE_AND_HANDYS_BLOCK_CHECKERS = new SystemMessageId(2754);
		...
		MATCH_CANT_START_PARTY_MEMBER_BOARDING = new SystemMessageId(2775);
		WARD_EFFECT_DISSAPPEARING = new SystemMessageId(2776);
		...
		A_CHARACTER_BORN_ON_FEBRUARY_29_WILL_RECEIVE_A_GIFT_ON_FEBRUARY_28 = new SystemMessageId(2957);
		...
		IF_THE_COMMAND_CHANNEL_LEADER_LEAVES_THE_PARTY_MATCHING_ROOM_THEN_THE_SESSIONS_ENDS_DO_YOU_REALLY_WISH_TO_EXIT_THE_ROOM = new SystemMessageId(2993);
		THE_COMMAND_CHANNEL_MATCHING_ROOM_WAS_CANCELLED = new SystemMessageId(2994);
		THIS_COMMAND_CHANNEL_MATCHING_ROOM_IS_ALREADY_CANCELLED = new SystemMessageId(2995);
		YOU_CANNOT_ENTER_THE_COMMAND_CHANNEL_MATCHING_ROOM_BECAUSE_YOU_DO_NOT_MEET_THE_REQUIREMENTS = new SystemMessageId(2996);
		YOU_EXITED_FROM_THE_COMMAND_CHANNEL_MATCHING_ROOM = new SystemMessageId(2997);
		YOU_WERE_EXPELLED_FROM_THE_COMMAND_CHANNEL_MATCHING_ROOM = new SystemMessageId(2998);
		THE_COMMAND_CHANNEL_AFFILIATED_PARTY_S_PARTY_MEMBER_CANNOT_USE_THE_MATCHING_SCREEN = new SystemMessageId(2999);
		THE_COMMAND_CHANNEL_MATCHING_ROOM_WAS_CREATED = new SystemMessageId(3000);
		THE_COMMAND_CHANNEL_MATCHING_ROOM_INFORMATION_WAS_EDITED = new SystemMessageId(3001);
		RECIPIENT_NOT_EXIST = new SystemMessageId(3002);
		C1_ENTERED_THE_COMMAND_CHANNEL_MATCHING_ROOM = new SystemMessageId(3003);
		SHYEED_S_ROAR_FILLED_WITH_WRATH_RINGS_THROUGHOUT_THE_STAKATO_NEST = new SystemMessageId(3007);
		...
		WHEN_YOUR_PET_S_HUNGER_GAUGE_IS_AT_0_YOU_CANNOT_USE_YOUR_PET = new SystemMessageId(3212);
		...
		THE_SKILL_HAS_BEEN_CANCELED_BECAUSE_YOU_HAVE_INSUFFICIENT_ENERGY = new SystemMessageId(6042);
		YOUR_ENERGY_CANNOT_BE_REPLENISHED_BECAUSE_CONDITIONS_ARE_NOT_MET = new SystemMessageId(6043);
		ENERGY_S1_REPLENISHED = new SystemMessageId(6044);
		THE_PREMIUM_ITEM_FOR_THIS_ACCOUNT_WAS_PROVIDED = new SystemMessageId(6046);
		THE_PREMIUM_ITEM_CANNOT_BE_RECEIVED_BECAUSE_THE_INVENTORY_WEIGHTQUANTITY_LIMIT_HAS_BEEN_EXCEEDED = new SystemMessageId(6047);
		THE_PREMIUM_ACCOUNT_HAS_BEEN_TERMINATED = new SystemMessageId(6048);
