...
public final class HitConditionBonusParser extends DocumentParser
{
	...
	public void load()
	{
		parseDatapackFile("data/stats/chars/hitConditionBonus.xml");
		info("Loaded hit condition bonuses.");
		if (Config.DEBUG)
		{
			info("Front bonus: " + frontBonus);
			info("Side bonus: " + sideBonus);
			info("Back bonus: " + backBonus);
			info("High bonus: " + highBonus);
			info("Low bonus: " + lowBonus);
			info("Dark bonus: " + darkBonus);
			info("Rain bonus: " + rainBonus);
		}
	}
